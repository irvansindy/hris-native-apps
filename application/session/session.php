...
{
  echo "<script type='text/javascript'>
  alert('User Session Expired. You will be Redirected to Login Pages');
...
if (!empty($_SESSION['nama_user']) && $_SESSION['login'] < 1){
	echo"<script type='text/javascript'>
		 window.location.replace('../../hrm/hrs{sys=reset-password}/');   
	    </script>";
}
