    ...
    Plugin.prototype = {
                    ...
                    '<div class="dtp-content">' +
                        '<div class="dtp-date-view">' +
                            '<header class="dtp-header">' +
                                ...
                                '<div class="dtp-close"><a href="javascript:void(0);"><i class="fa fa-close" aria-hidden="true"></i></a></div>' +
                            '</header>' +
        ...
        constructHTMLCalendar: function (date, calendar) {
            ...
            for (var i = 0; i < calendar.week.length; i++) {
                if(moment(parseInt(calendar.week[i]), "d").locale(this.params.lang).format("ddd").substring(0, 1) == 'S'){
                    _template += '<td class="workday" style="background: #f07f7f;color: white;font-family: verdana;font-size: 10px;vertical-align: middle;">' + moment(parseInt(calendar.week[i]), "d").locale(this.params.lang).format("ddd").substring(0, 1) + '</td>';
                } else {
                    _template += '<td class="holiday" style="background: lightgrey;color: white;font-family: verdana;font-size: 10px;vertical-align: middle;">' + moment(parseInt(calendar.week[i]), "d").locale(this.params.lang).format("ddd").substring(0, 1) + '</td>';
                }
                ...
                if (calendar.days[i] != 0) {
                    if (this.isBeforeMaxDate(moment(calendar.days[i]), false, false) === false ||
                        ...
                        if (moment(calendar.days[i]).locale(this.params.lang).format("DD") === moment(this.currentDate).locale(this.params.lang).format("DD")) {
                            _template += '<a href="javascript:void(0);" class="dtp-select-day selected cuk">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</a>';
                        } else {

                           
                
                                if(moment(parseInt(calendar.week[i]), "d").locale(this.params.lang).format("ddd").substring(0, 1) == 'S') {
                                    _template += '<a href="javascript:void(0);" class="dtp-select-day namnamngap">' + moment(calendar.days[i]).locale(this.params.lang).format("DD") + '</a>';
                                } else {
