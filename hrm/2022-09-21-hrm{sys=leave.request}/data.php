                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               ...
                                                               <input class="input--style-6" autocomplete="off" autofocus="on" id="src_leave_request" name="src_leave_request" id="src_leave_request" type="Text" value="<?php echo $src_leave_request; ?>" onfocus="hlentry(this)" size="30" maxlength="50" validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
                                                        </div>
                                                 </div>
                                          </div>
                                          ...
                                          <div class="form-row" style="display:none;">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               ...
                                                               <input class="input--style-6" autocomplete="off" autofocus="on" name="src_leave_request_cancel" id="src_leave_request_cancel" type="Text" value="<?php echo $src_leave_request_cancel; ?>" onfocus="hlentry(this)" size="30" maxlength="50" validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
                                                        </div>
                                                 </div>
                                          </div>
...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     ...
                     <div class="card-body table-responsive p-0" style="width: 90vw;height: 78vh; margin: 5px;overflow: scroll;border: 1px solid white;">
                            ...
                            <div class="card-body table-responsive p-0" style="width: 100vw;height: 50vh; width: 98%; margin: 5px;overflow: scroll;overflow-x: hidden;">
                                   ...
                                   <fieldset id="fset_1">
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               ...
                                                               <select class="input--style-6 modal_leave" name="modal_leave" style="width: 50%;height: 30px;" id="modal_leave" onchange="isi_otomatis_leave()">
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               ...
                                                               <input type="text" id="modal_leave_start" class="input--style-6" onchange="isi_otomatis_leave()" name="modal_leave_start" style="
                                                 ...
                                                 <div class="col-sm-3">
                                                        <div class="input-group">
                                                               <select class="input--style-6" style='display:none;height: 30px;width:150px' id="inp_hdtype_starttime" name="inp_hdtype_starttime" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3" style="display: none;">Full Day</option>
                                                                      <option value="3">Full Day</option>
                                                                      <option value="1">First Half</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               <select class="input--style-6" style='display:none;height: 30px;width:150px' id="inp_hdtype_starttime_formmodified" name="inp_hdtype_starttime_formmodified" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3" style="display: none;">Full Day</option>
                                                                      <option value="3">Full Day</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               ...
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <input class="input--style-6" style="display:none; margin-bottom: 2px; width: 90px;" id="inp_pdtype_starttime" name="inp_pdtype_starttime" placeholder="HH:ii" value="00:00" pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        </div>
                                                 </div>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               ...
                                                               <input class="input--style-6" maxlength="10" type="text" onchange="isi_otomatis_leave()" style="
                                                                             background-image:url(../../asset/dist/img/icons/calendar_icon.gif);  
                                                                             background-size: 17px;
                                                                             background-position:right;   
                                                                             background-repeat:no-repeat; 
                                                                             padding-right:10px;  
                                                                             " id="modal_leave_end" name="modal_leave_end" autocomplete="off" />
                                                        </div>
                                                 </div>

                                                 <div class="col-sm-3">
                                                        <div class="input-group">
                                                               <select class="input--style-6" style='display:none;height: 30px;width:150px' id="inp_hdtype_endtime" name="inp_hdtype_endtime" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3">Full Day</option>
                                                                      <option value="1">First Half</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               <input id="inp_hdtype_endtime_formmodified" name="inp_hdtype_endtime_formmodified" type="hidden" value="noselect">
                                                               <!--FROM SESSION -->

                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <input class="input--style-6" style="display:none; margin-bottom: 2px; width: 90px;" id="inp_pdtype_endtime" name="inp_pdtype_endtime" placeholder="HH:ii" value="00:00" pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        </div>
                                                 </div>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               <textarea class="textarea--style-6" id="inp_remark" name="inp_remark" placeholder="Remark of Leave"></textarea>
                                                        </div>
                                                 </div>
                                          </div>
                                          ...
                                          <div class="form-row" id="tr_inp_leaveisurgent" style='display:none;'>
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group" id="tr_inp_urgent_on">
                                                               <div class="vc-toggle-container">
                                                                      <label class="vc-switch">
                                                                             <input type="checkbox" name="inp_urgents" id="inp_urgent_on" value='1' class="vc-switch-input" onchange="isi_otomatis_leave()" />
                                                                             <input type="hidden" checked="checked" name="inp_urgent_decl" id="inp_urgent_on_back" value='0' class="vc-switch-input hidden" onchange="isi_otomatis_leave()" />
                                                        ...
                                                        <div class="input-group" id="tr_inp_urgent_off" style='display:none;'>
                                                               <div class="vc-toggle-container">
                                                                      <label class="vc-switch">
                                                                             <input type="checkbox" checked="checked" name="inp_urgent" id="inp_urgent_off" value='1' class="vc-switch-input" onchange="isi_otomatis_leave()" />
...
<div class="modal  fade fade-custom" tabindex="-1" role="dialog" id="RevisedForm">
       <div class="modal-dialog modal-belakang modal-bg" role="document">
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataRevised.php<?php echo $getPackage; ?>" method="POST" id="FormDisplayRevised">
                            ...
                            <div class="card-body table-responsive p-0" style="width: 100vw;height: 50vh; width: 98%; margin: 5px;overflow: scroll;overflow-x: hidden;">
                                   ...
                                   <fieldset id="fset_1">
                                          ...
                                          <mark style="margin-left: 6px;"><code id="revised_remark">Revised Remark : </code></mark>
                                          ...
                                          <div class="form-row" style="display:none;">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               ...
                                                               <input class="input--style-6 search-input" onkeyup="isi_otomatis(), isi_otomatis_leave_revised()" onfocus="this.value=''" autocomplete="off" autofocus="on" id="modal_emp" name="modal_emp" type="Text" value=" <?php echo $username; ?> [ <?php echo $emp['full_name']; ?> ] <?php echo $emp['pos_name_en']; ?>" size="30" maxlength="50" validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
                                                               <div id="employeeList"></div>
                                                        </div>
                                                 </div>
                                          </div>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               ...
                                                               <select class="input--style-6 modal_leave_revised" name="modal_leave_revised" style="width: 50%;height: 30px;" id="modal_leave_revised" onchange="isi_otomatis_leave_revised()">
                                                                      <option value="">--Select One--</option>
                                                                      <?php
                                                                      $sql = mysqli_query($connect, "SELECT 
                                                                                           a.leave_code,
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               ...
                                                               <input type="text" id="modal_revised_leave_start" class="input--style-6" onchange="isi_otomatis_leave_revised()" name="modal_revised_leave_start" style="
                                                                             background-image:url(../../asset/dist/img/icons/calendar_icon.gif);  
                                                                             background-size: 17px;
                                                                             background-position:right;   
                                                                             background-repeat:no-repeat; 
                                                 ...
                                                 <div class="col-sm-3">
                                                        <div class="input-group">
                                                               <select class="input--style-6" style='display:none;height: 30px;width:150px' id="inp_revised_hdtype_starttime" name="inp_revised_hdtype_starttime" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3" style="display: none;">Full Day</option>
                                                                      <option value="3">Full Day</option>
                                                                      <option value="1">First Half</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               <select class="input--style-6" style='display:none;height: 30px;width:150px' id="inp_revised_hdtype_starttime_formmodified" name="inp_revised_hdtype_starttime_formmodified" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3" style="display: none;">Full Day</option>
                                                                      <option value="3">Full Day</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               ...
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <input class="input--style-6" style="display:none; margin-bottom: 2px; width: 90px;" id="inp_revised_pdtype_starttime" name="inp_revised_pdtype_starttime" placeholder="HH:ii" value="00:00" pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        </div>
                                                 </div>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               ...
                                                               <input class="input--style-6" maxlength="10" type="text" onchange="isi_otomatis_leave_revised()" style="
                                                                             background-image:url(../../asset/dist/img/icons/calendar_icon.gif);  
                                                                             background-size: 17px;
                                                                             background-position:right;   
                                                                             background-repeat:no-repeat; 
                                                                             padding-right:10px;  
                                                                             " id="modal_revised_leave_end" name="modal_revised_leave_end" autocomplete="off" />
                                                        </div>
                                                 </div>

                                                 <div class="col-sm-3">
                                                        <div class="input-group">
                                                               <select class="input--style-6" style='display:nonea;height: 30px;width:150px' id="inp_revised_hdtype_endtime" name="inp_revised_hdtype_endtime" onfocus="hlentry(this)" onchange="formodified(this);">
                                                                      <option value="3">Full Day</option>
                                                                      <option value="1">First Half</option>
                                                                      <option value="2">Second Half</option>
                                                               </select>
                                                               <input id="inp_revised_hdtype_endtime_formmodified" name="inp_revised_hdtype_endtime_formmodified" type="hiddena" value="noselect">
                                                               <!--FROM SESSION -->

                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <input class="input--style-6" style="display:none; margin-bottom: 2px; width: 90px;" id="inp_revised_pdtype_endtime" name="inp_revised_pdtype_endtime" placeholder="HH:ii" value="00:00" pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                               <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        </div>
                                                 </div>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group">
                                                               <textarea class="textarea--style-6" id="inp_revised_remark" name="inp_revised_remark" placeholder="Remark of Leave"></textarea>
                                                        </div>
                                                 </div>
                                          </div>
                                          ...
                                          <div class="form-row" id="tr_inp_revised_leaveisurgent" style='display:none;'>
                                                 ...
                                                 <div class="col-sm-8">
                                                        <div class="input-group" id="tr_inp_revised_urgent_on">
                                                               <div class="vc-toggle-container">
                                                                      <label class="vc-switch">
                                                                             <input type="checkbox" name="inp_revised_urgents" id="inp_revised_urgent_on" value='1' class="vc-switch-input" onchange="isi_otomatis_leave_revised()" />
                                                                             <input type="hidden" checked="checked" name="inp_revised_urgent_decl" id="inp_revised_urgent_on_back" value='0' class="vc-switch-input hidden" onchange="isi_otomatis_leave_revised()" />
                                                                             <span class="vc-switch-label" data-on="Yes" data-off="No"></span>
                                                                             <span class="vc-handle"></span>
                                                                      </label>
                                                               </div>
                                                        ...
                                                        <div class="input-group" id="tr_inp_revised_urgent_off" style='display:none;'>
                                                               <div class="vc-toggle-container">
                                                                      <label class="vc-switch">
                                                                             <input type="checkbox" checked="checked" name="inp_revised_urgent" id="inp_revised_urgent_off" value='1' class="vc-switch-input" onchange="isi_otomatis_leave_revised()" />
                            ...
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
                            <input id="inp_revised_emp_no" name="inp_revised_emp_no" type="hidden" value="<?php echo $username; ?>">
                            <!--FROM SESSION -->
                            <input id="inp_revised_request_no" name="inp_revised_request_no" type="hidden">
                            <!--FROM SESSION -->
                            <input id="inp_revised_token" name="inp_revised_token" type="hidden" value="<?php echo $get_token; ?>">
                            <!--FROM CONFIGURATION -->
                            ...
                            <!--FROM CONFIGURATION -->
                            <input id="inp_revised_summaryleavebalance" name="inp_revised_summaryleavebalance" type="hidden">
                            <!--FROM CONFIGURATION -->
              ...
              <div class="modal-content">
                     ...
                     <form id="form-data">
                            ...
                            <div class="modal-footer-sdk">
                                   ...
                                   <a class="btn-sdk btn-primary-right" style="padding-top: 7px;" type="submit" name="submit_update" name="upload" id="upload">
                                          Upload file
                                   </a>
                            </div>
                            ...
                            <!--FROM SESSION -->
                            <input id="inp_Attachment_token" name="inp_Attachment_token" type="hidden" value="<?php echo $get_token; ?>">
                            <!--FROM CONFIGURATION -->
                            <input id="inp_Attachment_emp_no" name="inp_Attachment_emp_no" type="hidden" value="<?php echo $username; ?>">
                            <!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
       ...
       $(document).ready(function() {
              $("#CreateButton").on('click', function() {
                     ...
                     $("#FormDisplayCreate").unbind('submit').bind('submit', function() {
                            ...
                            if (from > to) {
                            ...
                            } else if (inp_daytype == "PD" && (inp_pdtype_starttime == '00:00' || inp_pdtype_endtime == '00:00')) {
                                   mymodalss.style.display = "none";
                                   modals.style.display = "block";
                                   ...
                                   mymodalss.style.display = "none";
                                   modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Partial Day Permit just allowing max 5 Hours";
                                   return false;
              ...
              if (id) {
                     $.ajax({
                            ...
                            success: function(response) {
                                   ...
                                   document.getElementById("revised_title").innerHTML = "Revised for : " + response.request_no;
                                   document.getElementById("revised_remark").innerHTML = "Revised Remark : " + response.remarkfromrevised;
                                   ...
                                   $("#box_leavebalances_revised").load("pages_relation/_pages_leavebalances.php<?php echo $getPackage; ?>rfid=" + response.emp_no + "&sfid=" + response.leave_code,
                                   ...
                                   //IF CONDITION #2 SHOWING DAYTYPE AFTER DATE FILL
                                   if (response.leave_startdates_print < response.leave_enddates_print && response.daytype == 'HD') {
                                          ...
                                          document.getElementById("inp_revised_hdtype_starttime").setAttribute("name", "inp_revised_hdtype_starttime_formmodified");
                                          document.getElementById("inp_revised_hdtype_starttime_formmodified").setAttribute("name", "inp_revised_hdtype_starttime");
                                          document.getElementById("inp_revised_hdtype_endtime").setAttribute("name", "inp_revised_hdtype_endtime");
                                          document.getElementById("inp_revised_hdtype_endtime_formmodified").setAttribute("name", "inp_revised_hdtype_endtime_formmodified");
                                   } else if (response.leave_startdates_print == response.leave_enddates_print && response.daytype == 'HD') {

                                          $("#inp_revised_hdtype_starttime").show();
                                          $("#inp_revised_hdtype_endtime").hide();
                                          $("#inp_revised_hdtype_starttime_formmodified").hide();
                                          document.getElementById("inp_revised_hdtype_starttime").setAttribute("name", "inp_revised_hdtype_starttime");
                                          document.getElementById("inp_revised_hdtype_starttime_formmodified").setAttribute("name", "inp_revised_hdtype_starttime_formmodified");
                                          document.getElementById("inp_revised_hdtype_endtime_formmodified").setAttribute("name", "inp_revised_hdtype_endtime");
                                          document.getElementById("inp_revised_hdtype_endtime").setAttribute("name", "inp_revised_hdtype_endtime_formmodified");
                                   ...
                                   $("#FormDisplayRevised").unbind('submit').bind('submit', function() {
                                          ...
                                          } else if (inp_revised_daytype == "PD" && (inp_revised_pdtype_starttime == '00:00' || inp_revised_pdtype_endtime == '00:00')) {
                                                 mymodalss.style.display = "none";
                                                 modals.style.display = "block";
                                                 document.getElementById("msg").innerHTML = "Please insert time";
                                                 return false;
                                          ...
                                          if (inp_revised_requestfor && inp_revised_leaverequestv && inp_revised_remark && modal_leave_start && modal_leave_end) {
                                          ...
                                          if (nama_file != "" && fileupload != "") {
                                                 ...
                                                 $.ajax({
                                                        ...
                                                        success: function(msg) {
                                                               ...
                                                               mymodalss.style.display = "none";
                                                               modals.style.display = "block";
                                                               document.getElementById("msg").innerHTML = msg.messages;
       ...
       function isi_otomatis_leave() {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            ...
                            $("#box_leavebalances").load("pages_relation/_pages_leavebalances.php<?php echo $getPackage; ?>rfid=" + modal_emps + "&sfid=" + modal_leave,
                                   function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up) {
                                          if (statusTxt_spv_up == "success") {
                            ...
                            if (from < to && response.daytype == 'HD') {
                                   ...
                                   document.getElementById("inp_hdtype_starttime").setAttribute("name", "inp_hdtype_starttime_formmodified");
                                   document.getElementById("inp_hdtype_starttime_formmodified").setAttribute("name", "inp_hdtype_starttime");
                                   document.getElementById("inp_hdtype_endtime").setAttribute("name", "inp_hdtype_endtime");
                                   document.getElementById("inp_hdtype_endtime_formmodified").setAttribute("name", "inp_hdtype_endtime_formmodified");
                            } else if (from == to && response.daytype == 'HD') {
                                   $("#inp_hdtype_starttime").show();
                                   $("#inp_hdtype_endtime").hide();
                                   $("#inp_hdtype_starttime_formmodified").hide();
                                   document.getElementById("inp_hdtype_starttime").setAttribute("name", "inp_hdtype_starttime");
                                   document.getElementById("inp_hdtype_starttime_formmodified").setAttribute("name", "inp_hdtype_starttime_formmodified");
                                   document.getElementById("inp_hdtype_endtime_formmodified").setAttribute("name", "inp_hdtype_endtime");
                                   document.getElementById("inp_hdtype_endtime").setAttribute("name", "inp_hdtype_endtime_formmodified");
                            }
                     }
              }); // /ajax
       }
       ...
       function isi_otomatis_leave_revised() {
              ...
              $(document).ready(function() {
                     $("#inp_revised_urgent_on").click(function() {
                            ...
                            if (inp_revised_urgent_on == '1') {
                                   ...
                                   document.getElementById("inp_revised_urgent_off").setAttribute("name", "inp_revised_urgent_decl");
                            }
                     });
              });
              $(document).ready(function() {
                     $("#inp_revised_urgent_off").click(function() {
                            ...
                            if (inp_revised_urgent_off == '1') {
                                   ...
                                   document.getElementById("inp_revised_urgent_on_back").setAttribute("name", "inp_revised_urgent_decl");
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            ...
                            $("#box_leavebalances_revised").load("pages_relation/_pages_leavebalances.php<?php echo $getPackage; ?>rfid=" + modal_emps + "&sfid=" + modal_leave,
                                   function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up) {
                                          if (statusTxt_spv_up == "success") {
                                                 $("#inp_revised_leavebalances_amount").show();
                                                 $("#box_leavebalances_revised").show();
