...
if($_POST) {	
	...
	$delete_attendance    = "DELETE FROM hrdattendance WHERE dateforcheck >= '$inp_shiftstartdate' and emp_id = '$inp_emp_id'";
	...
	$sql_1 = "INSERT INTO hrdattendance (
					...
					SELECT 
						'$inp_emp_id',
						a.shiftgroupcode,
						CONCAT('ATD-$inp_emp_id', DATE_FORMAT(a.dateshift, '%d%m%Y') , $SFnumber) as attend_id,
						a.dateshift,
						'$inp_emp_no',
						'$inp_emp_no',
						'$SFdatetime',
	...
	if($query_0 == TRUE) {				
		...
		$validator['messages'] = "Failed saved datas"  . $sql_1;	
	}
	// condition ends
