...
<div class="modal  fade fade-custom" tabindex="-1" role="dialog" id="CreateForm">
       <div class="modal-dialog modal-belakang modal-bs" style="width: 60%;" role="document">
              <div class="modal-content">
...
$(document).ready(function() {
       $("#CreateButton").on('click', function() {
              ...
              $("#FormDisplayCreate").unbind('submit').bind('submit', function() {
                     ...
                     } else if (inp_otachieved == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Overtime achieved";

                     } else if (lbl_inp_otdeucted == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Overtime achieved";
                     ...
                     if (inp_overtime_code && inp_overtime_minimum && inp_ovtcalctype && inp_otrounding && inp_otroundlimit && inp_otachieved && lbl_inp_otdeucted) {
       ...
       if (id) {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            ...
                            $("#sel_otachieved").val(response.otachieved);
			...
			success:function(response) {
				...
				$("#updatedelMemberForm").unbind('submit').bind('submit', function() {
					...
					if(sel_overtime_codes == "") {
						...
						$("#sel_overtime_codes").closest('.form-group').removeClass('has-error');
						$("#sel_overtime_codes").closest('.form-group').addClass('has-success');				
					}
