                                   ...
                                   <form>
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        ...
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
                                                                      <select class="input--style-6 modal_leave" name="src_active" style="width: 100%;height: 30px;" id="src_active" onchange="isi_otomatis_leave()">
...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">Generate Leave Balance </h4>
              ...
              <div class="card-body table-responsive p-0"
                     ...
                     <form name="myForm" id="myForm" enctype="multipart/form-data" action="php_action/FuncDataUpload.php" method="post" target="popupwindow" onsubmit=" return validateForm(), window.open('php_action/FuncDataUpload.php', 'popupwindow', 'scrollbars=yes,toolbar=no,width=800,height=400');">
                            <fieldset id="fset_1">
                                   <legend>Employee Generate Leave Balance</legend>
...
$(document).ready(function() {
       ...
       //For empty multiselect
       $("#box_with").hide();
       $("#box").load("pages_relation/_pages_setting.php?rfid=" + leave_status + "&rfid1=" + list_ofleave + "&token=" + '0' + "&rfid2=" + src_cost_code + "&rfid3=" + src_active,
       ...
       $("#box").hide();
              mymodalss.style.display = "block";
                     ...
                     $("#box_with").load("pages_relation/_pages_setting.php?rfid=" + leave_status + "&rfid1=" + list_ofleave + "&token=" + '1' + "&rfid2=" + src_cost_code + "&rfid3=" + src_active,
                     function(responseTxt, statusTxt, jqXHR){
                            if(statusTxt == "success"){
                                   $("#show_employee").show();
                                   $("#show_employees").show();
