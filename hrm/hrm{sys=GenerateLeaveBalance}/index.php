...
<?php
$page   = '95'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '21'
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                ...
                <ol class="breadcrumb mb-0 p-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="../hrm{sys=emp.dashboard}/">Leave&nbsp;&nbsp;</a></li>
                    <li><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Generate Leave Balance</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
