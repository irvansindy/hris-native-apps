...
<?php
$page   = '547'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '21'
    ...
    <div class="page-wrapper" style="display: block;">
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Salary Increase Matrix</h3>
                <ol class="breadcrumb mb-0 p-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="../hrm{sys=emp.dashboard}/">Home&nbsp;&nbsp;</a></li>
                    <li class="breadcrumb"><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Performance Management</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
