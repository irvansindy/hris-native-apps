                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <!-- <form method="#" id="myform"> -->
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">KPI No.</div>
                                                        <div class="col-sm-8">
...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0"> Performance Plan Approval</h4>
              ...
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataCreate.php" method="POST" id="FormDisplayCreate">
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="card-body table-responsive p-0" style="width: 99%; height: 300px; margin: 1px;overflow: scroll;">
       ...
       <div class="modal-dialog modal-belakang modal-onmodals" role="document"  style="margin-top: 50px;">
              <div class="modal-content" style="border: 1px solid #b3b2b2;background: #f9f9f9">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataRevisionRequest.php" method="POST" id="updaterevisionMemberFormspvdown">
                            ...
                            <fieldset id="fset_1" style="height: 257px;">
...
<div class="modal fade" tabindex="-1" role="dialog" id="FormDisplayrevisionspvup">
       <div class="modal-dialog modal-belakang modal-onmodals" role="document"  style="margin-top: 50px;">
              <div class="modal-content" style="border: 1px solid #b3b2b2;background: #f9f9f9">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDatarevisionRequestsSPVUP.php" method="POST" id="updaterevisionMemberFormspvup">
				...
				$("#sel_ipp_reqno_spv_downS").val(response.pa_reqno);
                            ...
                            $.ajax({
                                   ...
                                   success:function(response) {
                                                 ...
                                                 if(fill_is_approved_spvdown == 1){ //jika sudah approve request
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#sel_ipp_reqno_spv_upS").val(response.ipp_reqno); 
                            ...
                            $("#sel_remark_from_approver_spv_up").val(response.remark_approver);
