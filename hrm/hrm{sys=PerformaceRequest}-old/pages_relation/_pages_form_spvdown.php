...
?>
              ...
              <div class="input-group">
                     <tr id="recs-1">
                            <td><?php echo $no++; ?>.</td>
                            <td align="center"><select id="sel_currency_code" class="form-control"
                            ...
                            <td align="center"><input type="text" class="form-control kpi_spv_down" autocomplete="off"
                            ...
                            <td align="center"><textarea type="text" class="form-control"
                                          name="inp_attitude_spvdown_approver2[]"
                                          style="border: 1px solid #d7d7d7;"><?php echo $row_attitude['kpi_target']; ?></textarea>
                            </td>
                            <td align="center"><input type="text" class="form-control kpitrgmidyear_spv_down" autocomplete="off"
                                          value="<?php echo $row_attitude['kpi_midyear_trg']; ?>"
                                          name="inp_attitude_spvdown_approver3[]"
                                          style="border: 1px solid #d7d7d7;text-align: right;"></td>
                            <td align="center"><input type="text" class="form-control kpitrgfullyear_spv_down" autocomplete="off"
