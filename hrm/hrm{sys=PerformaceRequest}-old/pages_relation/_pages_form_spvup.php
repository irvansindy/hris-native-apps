...
<table class="table table-bordered table-striped table-hover table-head-fixed" id="tbl_posts">
       ...
       <tbody id="tbl_posts_body">
              <tr id="rec-1">
                     ...
                     <td><select id="inp_performance0" name="inp_performance_spvup_approver0[]" onfocus="hlentry(this)"
                     ...
                     <td><textarea class="form-control" type="text" value="" name="inp_performance_spvup_approver1[]"
                                   style="border: 1px solid #d7d7d7;width: 200px;"><?php echo $row_performance['kpi_name']; ?></textarea>
                     </td>
                     <td><select id="inp_performance2" name="inp_performance_spvup_approver2[]" onfocus="hlentry(this)"
                                   onchange="formodified(this);"
                                   style="width:undefined;width: 160px;border: 1px solid #cac2c2;text-align: left;color: #484545;">
                     ...
                     <td><input type="text" class="form-control" value="<?php echo $row_performance['kpi_bobot']; ?>"
                                   name="inp_performance_spvup_approver3[]"
                                   style="border: 1px solid #d7d7d7;text-align: right;"></td>
                     <td><select id="inp_performance4" name="inp_performance_spvup_approver4[]" onfocus="hlentry(this)"
                                   onchange="formodified(this);"
                                   style="width:undefined;width: 160px;border: 1px solid #cac2c2;text-align: left;color: #484545;">
                     ...
                     <td><input class="form-control" type="text"
                                   ...
                                   style="border: 1px solid #d7d7d7;text-align: right;"></td>
                     <td><select class="form-control" id="inp_performance_spvup_approver7"
                     ...
                     <td><textarea class="form-control" type="text" value="" name="inp_performance_spvup_approver8[]"
                                   style="border: 1px solid #d7d7d7;width: 200px;"><?php echo $row_performance['remark']; ?></textarea></td>

                     <td><select class="form-control" id="inp_performance_spvup_approver9" name="inp_performance_spvup_approver9[]"
