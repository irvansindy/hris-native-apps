       ...
       <div class="card-body table-responsive p-0" style="width: 100%; height:400px; margin: 1px;overflow: scroll;">
              ...
              ?>
                            ...
                            <tr id="recs-1">
                                   ...
                                   <td align="center"><select readonly class="form-control" id="sel_currency_code"
                                   ...
                                   <td align="center"><input readonly class="form-control kpi_spv_down" type="text"
                                   ...
                                   <td align="center"><textarea class="form-control" type="text" 
                                                 name="inp_attitude2[]" style="border: 1px solid #d7d7d7;"></textarea>
                                   </td>
                                   <td align="center"><input class="form-control kpitrgmidyear_spv_down"
                                                 type="text" autocomplete="off" value="" name="inp_attitude3[]"
                                                 style="border: 1px solid #d7d7d7;text-align: right;"></td>
                                   <td align="center"><input class="form-control kpitrgfullyear_spv_down" type="text"
