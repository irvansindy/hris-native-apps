...
$(document).ready(function() {
       var sum = 0;
       $(".kpi_approvalform_spv_down").each(function() {
              sum += +$(this).val();
       });
       $(".subTotal1_approvalform_spv_down").val(sum);
       document.getElementById("total_approval_spv_down_print").innerHTML = sum;
});
$(document).ready(function() {
       var sum = 0;
...
$(document).on("change", ".kpi_approvalform_spv_down", function() {
       var sum = 0;
       $(".kpi_approvalform_spv_down").each(function() {
              sum += +$(this).val();
       });
...
?>
              ...
              <div class="input-group">
                     <tr id="recs-1">
                            <td><?php echo $no++; ?>.</td>
                            <td align="center"><select readonly id="sel_currency_code" class="form-control"
                                          name="inp_attitude_spvdown_approver0[]" onfocus="hlentry(this)"
                            ...
                            <td align="center"><input readonly type="text" class="form-control kpi_approvalform_spv_down" autocomplete="off"
                                          id="spv_down<?php echo $row_no; ?>" onchange="addspv_down()"
                                          value="<?php echo $row_attitude['kpi_bobot']; ?>"
                                          name="inp_attitude_spvdown_approver1[]"
                                          style="border: 1px solid #d7d7d7;text-align: right;"></td>
                            <td align="center"><textarea readonly type="text" class="form-control"
                                          name="inp_attitude_spvdown_approver2[]"
                                          style="border: 1px solid #d7d7d7;"><?php echo $row_attitude['kpi_target']; ?></textarea>
                            </td>
                            <td align="center"><input readonly type="text" class="form-control kpitrgmidyear_spv_down" autocomplete="off"
                                          value="<?php echo $row_attitude['kpi_midyear_trg']; ?>"
                                          name="inp_attitude_spvdown_approver3[]"
                                          style="border: 1px solid #d7d7d7;text-align: right;"></td>
                            <td align="center"><input readonly type="text" class="form-control kpitrgfullyear_spv_down" autocomplete="off"
       ...
       <tr id="recs-1" style="background: #eee;border: 1px solid #0869bd;">
              ...
              <td align="center">
                     <div id="total_approval_spv_down_print" style="font-weight: bold;text-align: right;color: #056805;">0</div>
                     <input type="hidden" name="total_request_spv_down" id="total_request_spv_down"
                            class="form-control subTotal1_approvalform_spv_down subTotal"
              ...
              <td align="center">
                     ...
                     <input type="hidden" name="total_trgmidyear_request_spv_down" class="form-control subTotal2 subTotal"
                            style="border: 1px solid #d7d7d7;text-align: right;">
              </td>
              <td align="center">
