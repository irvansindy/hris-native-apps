...
$(document).ready(function() {
       var sum = 0;
       var sum1 = 0;
       $(".kpi_approvalform_spv_up").each(function() {
              sum += +$(this).val();
       });
       $(".kpi_approvalform_spv_up_plus").each(function() {
              sum1 += +$(this).val();
       });

       
       $(".subTotal1_approvalform_spv_up").val(sum);
       $(".subTotal1_approvalform_spv_up").val(sum1);
       document.getElementById("total_approvalform_spv_up_print").innerHTML = sum+sum1;
});
$(document).ready(function() {
       var sum = 0;
...
$(document).on("change", ".kpi_approvalform_spv_up", function() {
       var sum = 0;
       var sum1 = 0;
       $(".kpi_approvalform_spv_up").each(function() {
              sum += +$(this).val();
...
$(document).on("change", ".kpi_approvalform_spv_up_plus", function() {
       var sum = 0;
       var sum1 = 0;
       $(".kpi_approvalform_spv_up").each(function() {
              sum += +$(this).val();
...
</script><link rel="stylesheet" href="../../asset/gt_developer/developer_hris_form.css" />
...
<table class="table table-bordered table-striped table-hover table-head-fixed" id="tbl_posts">
       ...
       <tbody id="tbl_posts_body">
              <tr id="rec-1">
                     ...
                     <td><select readonly id="inp_performance0" name="inp_performance_spvup_approver0[]" onfocus="hlentry(this)"
                     ...
                     <td><textarea readonly class="form-control" type="text" value="" name="inp_performance_spvup_approver1[]"
                                   style="border: 1px solid #d7d7d7;width: 200px;"><?php echo $row_performance['kpi_name']; ?></textarea>
                     </td>
                     <td><select readonly id="inp_performance2" name="inp_performance_spvup_approver2[]" onfocus="hlentry(this)"
                                   onchange="formodified(this);"
                                   style="width:undefined;width: 160px;border: 1px solid #cac2c2;text-align: left;color: #484545;">
                     ...
                     <td><input readonly type="text" class="form-control kpi_approvalform_spv_up" value="<?php echo $row_performance['kpi_bobot']; ?>"
                                   name="inp_performance_spvup_approver3[]"
                                   style="border: 1px solid #d7d7d7;text-align: right;"></td>
                     <td><select readonly id="inp_performance4" name="inp_performance_spvup_approver4[]" onfocus="hlentry(this)"
                                   onchange="formodified(this);"
                                   style="width:undefined;width: 160px;border: 1px solid #cac2c2;text-align: left;color: #484545;">
                     ...
                     <td><textarea readonly class="form-control" type="text" value="" name="inp_performance_spvup_approver8[]"
                                   style="border: 1px solid #d7d7d7;width: 200px;"><?php echo $row_performance['remark']; ?></textarea></td>

                     <td><select readonly class="form-control" id="inp_performance_spvup_approver9" name="inp_performance_spvup_approver9[]"
       ...
       <table class="table table-bordered table-striped table-hover table-head-fixed" id="">
              <tr id="">
                     ...
                     <td nowrap="nowrap" align="center">
                            <div id="total_approvalform_spv_up_print" style="font-weight: bold;text-align: right;color: #056805;">0
                            </div>
                            <input type="hidden" name="total_request_spv_up" id="total_request_spv_up"
                                   class="form-control subTotal1_approvalform_spv_up subTotal"
