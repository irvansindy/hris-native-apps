...
<?php 
$page   = '98'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '21'
        ...
        <div class="page-wrapper" style="display: block;">
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Performance Final Result Upload</h3>
                    <ol class="breadcrumb mb-0 p-0 bg-transparent">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Performance&nbsp;&nbsp;</a></li>
                        <li ><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Final Result Upload</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
