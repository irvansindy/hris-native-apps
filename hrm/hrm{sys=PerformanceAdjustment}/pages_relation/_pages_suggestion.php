...
$total_Fra = mysqli_fetch_array(mysqli_query($connect , "SELECT COUNT(*) AS total_value FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'A'"));
$total_Frb = mysqli_fetch_array(mysqli_query($connect , "SELECT COUNT(*) AS total_value FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'B'"));
$total_Frc = mysqli_fetch_array(mysqli_query($connect , "SELECT COUNT(*) AS total_value FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'C'"));
$total_Frd = mysqli_fetch_array(mysqli_query($connect , "SELECT COUNT(*) AS total_value FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'D'"));
$total_Fre = mysqli_fetch_array(mysqli_query($connect , "SELECT COUNT(*) AS total_value FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'E'"));
$total_Pra = mysqli_fetch_array(mysqli_query($connect , "SELECT ROUND(COUNT(*)/$total_Ida[total_value]*100) AS percent FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'A'"));
$total_Prb = mysqli_fetch_array(mysqli_query($connect , "SELECT ROUND(COUNT(*)/$total_Idb[total_value]*100) AS percent FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'B'"));
$total_Prc = mysqli_fetch_array(mysqli_query($connect , "SELECT ROUND(COUNT(*)/$total_Idc[total_value]*100) AS percent FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'C'"));
$total_Prd = mysqli_fetch_array(mysqli_query($connect , "SELECT ROUND(COUNT(*)/$total_Idd[total_value]*100) AS percent FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'D'"));
$total_Pre = mysqli_fetch_array(mysqli_query($connect , "SELECT ROUND(COUNT(*)/$total_Ide[total_value]*100) AS percent FROM hrmperf_finalresult a LEFT JOIN view_employee b on a.request_for=b.emp_no WHERE b.cost_code LIKE '%HHA_350504_8001000000%' AND a.pa_grade_adjust = 'E'"));
?>
