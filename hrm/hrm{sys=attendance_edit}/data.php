...
<div class="col-md-12">
	<div class="card">
		<div class="card-header d-flex align-items-center"
			style="background: linear-gradient(229deg, #4e595e54, #fff);">
				...
				<div class="form-row" style="width: 100%;margin-top: 14px;">
					...
					<div class="col-sm-5">
						<div class="card-body table-responsive p-0" style="margin-bottom: 7px;margin-left: 2px;">
							<td>
								<a><img width="15px" src="../../asset/img/icon_user.png"
										style="margin-left: 5px;"></a>&nbsp;&nbsp;
								<input type="text" autocomplete="off" onfocus="this.value=''" value=""
									style="font-size: 11px;border: 1px solid #aaa6a6;border-radius: 8px;height: 20px;padding-left: 10px;background: #1e88e521;"
									name="employee" id="employee" class="search-input">
					...
					<div class="form-row" style="width: 100%;">
						...
						<div class="col-sm-2">
							<td>
								...
								style="width: 97px;margin-top: -5px;background: grey;border: 1px solid;"
								value="Upload"
								class="btn btn-rounded btn-warning btn-sm text-white d-inline-block">Search</button>
							</td>
						</div>
					</div>
				</div>
		...
		<fieldset id="fset_1_attendance_edit" style="display:none">
			...
			<div class="card-body table-responsive p-0"
				style="height: 50vh; width: 100%; overflow-y: scroll;overflow-x: hidden;border: 1px solid white;">
				<div class="form-row">
					<div class="col-sm-12">
