...
<?php 
$page   = '21'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '21'
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    ...
                    <ol class="breadcrumb mb-0 p-0 bg-transparent">
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Time & Attendance Setting&nbsp;&nbsp;</li>
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Shift Daily</li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <?php
                                $hrmmenu = mysqli_query($connect, "SELECT * FROM hrmmenu a WHERE ($qSequence_r) and a.menu_id = $page");
...
include "../template/sys.footer.php";
?>

<!-- ============================================================== -->
<!-- ============================================================== -->
<!-- jquery.redirect Must on Bottom Area  -->
<!-- ============================================================== -->
