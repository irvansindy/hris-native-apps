			...
			<div class="modal-content">
				<div class="modal-body">
                  ...
                  <div class="col-md-6">
                            ...
                            <div class="form-row">
                                <div class="col-1 name">Type * :</div>
                                <div class="col-sm-11" style="padding-left:15px">
                                    <div class="input-group">
                                        <select class="input--style-6" name="type_report" id="type_report" style="width: ;height: 30px;">
                                            <option value="">Not Specify</option>
                                            
                                            <option value="1">General Dashboard</option>
                                            <!-- <option value="2">Request Dashboard</option>
                                            <option value="3">Attendance Dashboard</option>
                                            <option value="4">Recruitment Dashboard</option> -->
...
$(document).ready(function(){
        ...
        $(document).on('click', '#view_information', function(){
            ...
            if(type_report == ''){
                   alert('Please select type dashboard filter!');
                   return;
            }

            $.post('view_report.php',{type_report:type_report}, function (data) {
