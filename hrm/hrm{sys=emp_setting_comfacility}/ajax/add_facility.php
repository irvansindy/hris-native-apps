    ...
    <!-- <div class="card-body table-responsive p-0" style="width: 100vw;height: 87vh; width: 98.8%; margin: 5px;overflow: scroll;"> -->
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <input class="input--style-6"
                                                               ...
                                                               name="tambah_fc" id="tambah_fc" type="Text" value=""
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="tambah_fm" id="tambah_fm" type="Text" value=""
                                                               onfocus="hlentry(this)" size="30" maxlength="" style="font-weight:bold"
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                                                               ...
                                                               <textarea class="textarea--style-6" id="tambah_fd" name="tambah_fd" placeholder=""></textarea>
                        </div>
            ...
            <div class="modal-footer">
                                                                      ...
                                                                      <button type="button"
                                                                             ...
                                                                             <button type="submit" id="tambah_facility" id1=""
