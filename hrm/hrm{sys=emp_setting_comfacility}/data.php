...
<?php  
       ...
       if (!empty($_POST['search_fc'])) {
              $search_fc             = $_POST['search_fc'];
       // AgusPrass 04/03/2021 menambahkan kondisi saat memfilter
       }
       if(!empty($_POST['search_fm'])){
           $search_fm                = $_POST['search_fm'];
       }
?>
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Facility Code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_fc"
                                                                             name="search_fc" type="Text" value=""
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Facility Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="search_fm" id="search_fm" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Facility</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Facility Code</th>
                                                               <th class="fontCustom" style="z-index: 1;">Facility Name</th>
                                                               <th class="fontCustom" style="z-index: 1;">Facility Description</th>
       ...
       <div class="modal fade" id="modal-view-facility">
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_fc ?>&data2=<?php echo $search_fm ?>"
       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_facility', function(){
            ...
            $('#title_modal').html('Edit Facility');

            var fc    = $(this).attr('id1');

            // alert(fc);  
            $.ajax({
                url: "ajax/edit_facility.php",
                type: "POST",
                        data: {
                                fc: fc,
                        },
        ...
        $(document).on('click', '#edit_facility', function(){
            ...
            if(fd == ''){
                   alert('Facility description is required!');
                   return;
            }
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $('#modal-view-facility').modal('hide');  
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Facility');
            ...
            // Save Edit
        $(document).on('click', '#tambah_facility', function(){

            var fc          = $('#tambah_fc').val();
            var fm          = $('#tambah_fm').val();
            var fd          = $('#tambah_fd').val(); 
