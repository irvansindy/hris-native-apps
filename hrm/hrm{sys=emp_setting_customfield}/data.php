...
<?php  
       ...
       if (!empty($_POST['search_cfn'])) {
              $search_cfn             = $_POST['search_cfn'];
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Custom Field Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_cfn"
                                                                             name="search_cfn" type="Text" value=""
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Custom Field</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Custom Field Name</th>
                                                               <th class="fontCustom" style="z-index: 1;">Configuration Setting</th>
       ...
       <div class="modal fade" id="modal-view-customfield">
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_cfn ?>"
       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_customfield', function(){
            ...
            $('#title_modal').html('Edit Custom Field');

            var eic    = $(this).attr('id1');

            // alert(eic);  
            $.ajax({
                url: "ajax/edit_customfield.php",
                type: "POST",
                        data: {
                                id: eic,
                        },
        ...
        // Save Edit
        $(document).on('click', '#edit_cfield', function(){

            var id                 = $(this).attr('id1');
            var cf_name_en         = $('#cf_name_en').val();
            var cf_name_id         = $('#cf_name_id').val();   
            var cf_string          = $('#cf_string').val();   


            if(cf_name_en == ''){
                   alert('Custom Field name en is required!');
                   return;
            }
            if(cf_name_id == ''){
                   alert('Custom Field name id is required!');
                   return;
            }
            if(cf_string == ''){
                   alert('Configuration String is required!');
                   return;
            }

            let formData = new FormData();
            formData.append('id', id);
            formData.append('cf_name_en', cf_name_en);
            formData.append('cf_name_id', cf_name_id);
            formData.append('cf_string', cf_string);
        ...
        // Delete
        $(document).on('click', '#delete_cfield', function(){
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Custom Field');

            // alert(nc);  
            $.ajax({
                url: "ajax/add_cfield.php",
                type: "POST",
                        data: {
            ...
            // Save Edit
        $(document).on('click', '#add_cfield', function(){

            var cf_name_en         = $('#tambah_cf_name_en').val();
            var cf_name_id         = $('#tambah_cf_name_id').val();   
            var cf_string          = $('#tambah_cf_string').val();   
