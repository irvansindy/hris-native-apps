...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Disease Type</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Disease Code</th>
                                                               <th class="fontCustom" style="z-index: 1;">Disease Name</th>
...
$(document).ready(function(){
       ...
       $(document).on('click', '#modal_view_disease', function(){
        ...
        // Save Edit
        $(document).on('click', '#edit_disease', function(){
