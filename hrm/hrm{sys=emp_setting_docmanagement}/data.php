                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Document Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_dm"
                                                                             name="search_dm" type="Text" value=""
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Reminder</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Document Management</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Document Name</th>
                                                               <th class="fontCustom" style="z-index: 1;">Reminder</th>
       ...
       <div class="modal fade" id="modal-view-docmanagement">
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_dm ?>&data2=<?php echo $search_rm ?>"
       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_docmanagement', function(){
            ...
            $('#title_modal').html('Edit Document Management');

            var dc    = $(this).attr('id1');

            // alert(fc);  
            $.ajax({
                url: "ajax/edit_docman.php",
                type: "POST",
                        data: {
                                dc: dc,
                        },
        ...
        // Save Edit
        $(document).on('click', '#edit_docman', function(){

            var dc          = $(this).attr('id1');
            var dm          = $('#edit_dm').val();
            var day         = $('#edit_day').val(); 
            var daytype     = $('#edit_daytpe').val(); 
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $('#modal-view-docmanagement').modal('hide');  
        ...
        // Delete
        $(document).on('click', '#delete_docman', function(){
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Document Management');

            // alert(nc);  
            $.ajax({
                url: "ajax/add_docman.php",
                type: "POST",
                        data: {
            ...
            // Save Edit
        $(document).on('click', '#tambah_docman', function(){

            var dm          = $('#add_dm').val();
            var day         = $('#add_day').val(); 
            var daytype     = $('#add_daytpe').val(); 
