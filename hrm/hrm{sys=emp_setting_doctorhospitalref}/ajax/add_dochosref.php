    ...
    <!-- <div class="card-body table-responsive p-0" style="width: 100vw;height: 87vh; width: 98.8%; margin: 5px;overflow: scroll;"> -->
            <fieldset id="fset_1">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <select class="input--style-6" name="type" id="type" style="width: ;height: 30px;">
                ...
                <div class="form-row">
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <textarea class="textarea--style-6" id="address" name="address" placeholder=""></textarea>
            ...
            <div class="modal-footer">
                                                                      ...
                                                                      <button type="button"
                                                                             ...
                                                                             <button type="submit" id="tambah_dochos" id1=""
