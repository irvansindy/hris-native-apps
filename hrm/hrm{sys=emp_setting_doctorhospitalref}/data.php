                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_code"
                                                                             name="search_code" type="Text" value=""
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Phone</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="search_phone" id="search_phone" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Doctor or Hospital Reference</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Address</th>
       ...
       <div class="modal fade" id="modal-view-doctorhospital">
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_code ?>&data2=<?php echo $search_name ?>&data3=<?php echo $search_phone ?>"
       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_doctorhospital', function(){
            ...
            $('#title_modal').html('Edit Doctor or Hospital Reference');

            var dc    = $(this).attr('id1');

            // alert(fc);  
            $.ajax({
                url: "ajax/edit_dochos.php",
                type: "POST",
                        data: {
                                dc: dc,
                        },
        ...
        // Save Edit
        $(document).on('click', '#edit_dochos', function(){
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $('#modal-view-doctorhospital').modal('hide');  
        ...
        // Delete
        $(document).on('click', '#delete_dochos', function(){
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Doctor or Hospital Reference');

            // alert(nc);  
            $.ajax({
                url: "ajax/add_dochosref.php",
                type: "POST",
                        data: {
            ...
            // Save Edit
        $(document).on('click', '#tambah_dochos', function(){
