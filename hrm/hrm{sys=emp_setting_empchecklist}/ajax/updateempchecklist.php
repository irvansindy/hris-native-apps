...
$delete_tgemchecklist = mysqli_query($connect, "DELETE FROM `tgemchecklist` WHERE checklistheader_code = '$cgc'");
$delete_tgemchecklistheader = mysqli_query($connect, "DELETE FROM `hrmchecklistheader` WHERE checklistheader_code = '$cgc'");
$delete_tgemchecklistorgunit = mysqli_query($connect, "DELETE FROM `tgemchecklistorgunit` WHERE checklistheader_code = '$cgc'");
$delete_tgemchecklistpic = mysqli_query($connect, "DELETE FROM `tgemchecklistpic` WHERE checklistheader_code = '$cgc'");
