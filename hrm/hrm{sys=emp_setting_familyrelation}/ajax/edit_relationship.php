...
a.relationship_name_id 
FROM hrmfamilyrelation a
WHERE a.relationship_code = '$rc'");
...
<div class="modal-body">
    <!-- <div class="card-body table-responsive p-0" style="width: 100vw;height: 87vh; width: 98.8%; margin: 5px;overflow: scroll;"> -->
            <fieldset id="fset_1">
                <div class="form-row">
                    <div class="col-3 name">Relationship Code *</div>
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="rc" id="rc" type="Text" value="<?php echo $data_rc['relationship_code']; ?>"
                ...
                <div class="form-row">
                    <div class="col-3 name">Relationship Name *</div>
                        <div class="col-sm-9">
                            <div class="from-row">
                                    ...
                                    <div class="from-row">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="rm_en" id="rm_en" type="Text" value="<?php echo $data_rc['relationship_name_en']; ?>"
                                    ...
                                    <div class="from-row" style="margin-top:40px">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="rm_id" id="rm_id" type="Text" value="<?php echo $data_rc['relationship_name_id']; ?>"
                                                                onfocus="hlentry(this)" size="30" maxlength="" 
                                                                validate="NotNull:Invalid Form Entry"
                                                                onchange="formodified(this);" title="">
                                            </div>
            ...
            <div class="modal-footer">
                                                                      ...
                                                                      <button type="button"
                                                                             ...
                                                                             <button type="button" id1=""
                                                                                    class="btn btn-danger btn-sm" id="delete_relationship"
                                                                                    data-dismiss="modal">Delete</button>

                                                                             
                                                                             <button type="submit" id="edit_relationship" id1=""
