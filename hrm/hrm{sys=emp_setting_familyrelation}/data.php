...
<?php  
       ...
       if (!empty($_POST['search_rc'])) {
              $search_rc             = $_POST['search_rc'];
       // AgusPrass 04/03/2021 menambahkan kondisi saat memfilter
       }
       if(!empty($_POST['search_rm'])){
           $search_rm                = $_POST['search_rm'];
       }
?>
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Relationship Code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_rc"
                                                                             name="search_rc" type="Text" value=""
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Relationship Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="search_rm" id="search_rm" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Family Relationship</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Relationship Code</th>
                                                               <th class="fontCustom" style="z-index: 1;">Relationship Name</th>
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_rc ?>&data2=<?php echo $search_rm ?>"
       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_relationship', function(){
            ...
            $('#title_modal').html('Edit Relationship');

            var rc    = $(this).attr('id1');

            // alert(rc);  
            $.ajax({
                url: "ajax/edit_relationship.php",
                type: "POST",
                        data: {
                                rc: rc,
                        },
        ...
        $(document).on('click', '#edit_relationship', function(){
            ...
            if(rm_en == ''){
                alert('Relationship name en is required!');
                return;
            }
            if(rm_id == ''){
                alert('Relationship name id is required!');
                return;
            } 

            let formData = new FormData();
            formData.append('rc', rc);
            formData.append('rm_en', rm_en);
        ...
        // Delete
        $(document).on('click', '#delete_relationship', function(){
            ...
            $.ajax({
                type: 'POST',
                url: "ajax/deleterelationship.php",
                data: formData,
                cache: false,
                processData: false,
                contentType: false,
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Relationship');

            // alert(nc);  
            $.ajax({
                url: "ajax/add_relationship.php",
                type: "POST",
                        data: {
            ...
            // Save Edit
        $(document).on('click', '#tambah_relationship', function(){

            var rc          = $('#tambah_rc').val();
            var rm_en       = $('#tambah_rm_en').val();   
            var rm_id       = $('#tambah_rm_id').val();

            if(rc == ''){
                alert('Relationship code is required!');
                return;
            }
            if(rm_en == ''){
                alert('Relationship name en is required!');
