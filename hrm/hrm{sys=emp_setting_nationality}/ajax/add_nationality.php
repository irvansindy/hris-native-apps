...
<div class="modal-body">
    <!-- <div class="card-body table-responsive p-0" style="width: 100vw;height: 87vh; width: 98.8%; margin: 5px;overflow: scroll;"> -->
            <fieldset id="fset_1">
                <div class="form-row">
                    <div class="col-3 name">Nationality Code *</div>
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="tambah_nc" id="tambah_nc" type="Text" value=""
                ...
                <div class="form-row">
                    <div class="col-3 name">Nationality Name *</div>
                        <div class="col-sm-9">
                            <div class="from-row">
                                    ...
                                    <div class="from-row">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="tambah_nm_en" id="tambah_nm_en" type="Text" value=""
                                    ...
                                    <div class="from-row" style="margin-top:40px">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="tambah_nm_id" id="tambah_nm_id" type="Text" value=""
                                                                onfocus="hlentry(this)" size="30" maxlength="" 
                                                                validate="NotNull:Invalid Form Entry"
                                                                onchange="formodified(this);" title="">
                                            </div>
            ...
            <div class="modal-footer">
                                                                      ...
                                                                      <button type="button"
                                                                             ...
                                                                             <button type="submit" id="tambah_nationality" id1=""
