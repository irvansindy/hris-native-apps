...
$sql_nc         = mysqli_query($connect, "SELECT 
a.nationality_code,
a.nationality_name_en,
a.nationality_name_id
FROM hrmnationality a
WHERE a.nationality_code = '$nc'");

$data_nc        = mysqli_fetch_assoc($sql_nc);
                    ...
                    <div class="col-sm-9" style="padding-left:20px">
                        <div class="input-group">
                            <input class="input--style-6"
                                                               ...
                                                               name="nc" id="nc" type="Text" value="<?php echo $data_nc['nationality_code']; ?>"
                                    ...
                                    <div class="from-row">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="nm_en" id="nm_en" type="Text" value="<?php echo $data_nc['nationality_name_en']; ?>"
                                    ...
                                    <div class="from-row" style="margin-top:40px">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input class="input--style-6"
                                                                autocomplete="off" autofocus="on" 
                                                                name="nm_id" id="nm_id" type="Text" value="<?php echo $data_nc['nationality_name_id']; ?>"
                                                                onfocus="hlentry(this)" size="30" maxlength="" 
                                                                validate="NotNull:Invalid Form Entry"
                                                                onchange="formodified(this);" title="">
                                            </div>
            ...
            <div class="modal-footer">
                                                                      ...
                                                                      <button type="button"
                                                                             ...
                                                                             <button type="button" id1=""
                                                                                    class="btn btn-danger btn-sm" id="delete_nationality"
                                                                                    >Delete</button>

                                                                             
                                                                             <button type="submit" id="edit_nationality" id1=""
