...
<?php  
       ...
       if (!empty($_POST['search_nc'])) {
              $search_nc             = $_POST['search_nc'];
       // AgusPrass 04/03/2021 menambahkan kondisi saat memfilter
       }
       if(!empty($_POST['search_nm'])){
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Nationality Code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_nc"
                                                                             name="search_nc" type="Text" value=""
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Nationality Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="search_nm" id="search_nm" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Nationality</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Nationality Code</th>
                                                               <th class="fontCustom" style="z-index: 1;">Nationality Name</th>
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_nc ?>&data2=<?php echo $search_nm ?>"
       });
        //    Load data
