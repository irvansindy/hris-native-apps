...
<?php  
       ...
       if (!empty($_POST['search_dn'])) {
              $search_dn             = $_POST['search_dn'];
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Description Name</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="search_dn"
                                                                             name="search_dn" type="Text" value=""
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Management Description</h4>
                                        ...
                                        <table id="datatable" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Description Name</th>
       ...
       <div class="modal fade" id="modal-view-desc">
...
$(document).ready(function(){
       ...
       dataTable = $("#datatable").DataTable({
              ...
              "ajax": "ajax/data.php?data1=<?php echo $search_dn ?>&data2=<?php echo $search_gi ?>"       });
        //    Load data
       ...
       // Refresh Page
        ...
        //    Edit
       $(document).on('click', '#modal_view_desc', function(){
            ...
            $('#title_modal').html('Edit Description');

            var eic    = $(this).attr('id1');

            // alert(eic);  
            $.ajax({
                url: "ajax/edit_desc.php",
                type: "POST",
                        data: {
                                eic: eic,
                        },
        ...
        $(document).on('click', '#edit_desc', function(){
            ...
            if(gpertanyaan == ''){
                   alert('Group pertanyaan is required!');
                   return;
            }
            ...
            formData.append('gpertanyaan', gpertanyaan);
       ...
       $(document).on('click', '#modal_tambah', function(){
            ...
            $('#title_tambah').html('Add Description');

            // alert(nc);  
            $.ajax({
                url: "ajax/add_desc.php",
                type: "POST",
                        data: {
