...
if ($_POST) {
	...
	$sql_0 					= "UPDATE mgtools_teodempfamily SET name = '$family_name' WHERE empfamily_id = '$family_empfamily_id' AND request_no = '$SFnumbercon'";
	...
	if ($query_0 == TRUE) {
		...
		$validator['messages'] = "Successfully saved data" . $sql_0;
