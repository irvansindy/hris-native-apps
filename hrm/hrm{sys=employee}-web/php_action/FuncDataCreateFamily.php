...
if ($_POST) {
	...
	$count_existing			= mysqli_num_rows(mysqli_query($connect, "SELECT * FROM `mgtools_teodempfamily` WHERE `emp_id` = '$get_empid_r1' AND `relationship` = '$family_relationship' AND `request_no` = '$SFnumbercon'"));

	$sql_0 					= "INSERT INTO `mgtools_teodempfamily` 
												(
													`request_no`,
													`empfamily_id`, 
													`emp_id`, 
