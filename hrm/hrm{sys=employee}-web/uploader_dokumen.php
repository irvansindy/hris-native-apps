...
if($_GET['code'] == '1' && $_FILES["file"]["name"] != '')
{
 ...
 if(mysqli_num_rows($before) < 1){
    ...
    echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox1a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">KTP</code></p>
                            <img src="'.$img.'" style="height: 100px;" alt="gthris">
                            <p>
                            <input type="hidden" value="'.$before_attachment_r.'" name="nama1a">
                            <a href="#" type="submit" class="ws-btn w3-block open_modal_search" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
                                <a style="color: white;margin-bottom: 10px;font-size: 14px;width: 100%;background: #b5b2b2;" class="btn btn-submit  tombol-simpan1a" onclick="removeElement1()">Remove
    ...
    if(move_uploaded_file($_FILES["file"]["tmp_name"], $location)){ 
        ...
        if($process_request)
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox1a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">KTP</code></p>
                        <img src="uploaded_files/pngs.png" style="height: 100px;" alt="gthris">
                        <p>
                ...
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox1a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">KTP</code></p>
                        <img src="../../asset/list_document/'.$name.'" style="height: 100px;" alt="gthris">
                        <p>
                        <input type="hidden" value="'.$name.'" name="nama1a">
                        <a href="#" type="submit" class="ws-btn w3-block open_modal_search" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
            ...
            echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox1a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">KTP</code></p>
                    <img src="../../asset/list_document/'.$before_attachment_r.'" style="height: 100px;" alt="gthris">
                    <p>
                    <input type="hidden" value="'.$before_attachment_r.'" name="nama1a">
                    <a href="#" type="submit" class="ws-btn w3-block open_modal_search" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
...
if($_GET['code'] == '2' && $_FILES["file2"]["name"] != '')
{
 ...
 if(mysqli_num_rows($before) < 1){
    ...
    echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox2a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">Kartu tanda penduduk</code></p>
                            <img src="'.$img.'" style="height: 100px;" alt="gthris">
                            <p>
                            <input type="hidden" value="'.$before_attachment_r.'" name="nama2a">
                            <a href="#" type="submit" class="ws-btn w3-block open_modal_search2" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
                                <a style="color: white;margin-bottom: 10px;font-size: 14px;width: 100%;background: #b5b2b2;" class="btn btn-submit  tombol-simpan2a" onclick="removeElement2a()">Remove
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus-square feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                                </a></p>
                            </div>';
    ...
    if(move_uploaded_file($_FILES["file2"]["tmp_name"], $location)){ 
        ...
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox2a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">Kartu Keluarga</code></p>
                        <img src="uploaded_files/pngs.png" style="height: 100px;" alt="gthris">
                        <p>
...
if($_GET['code'] == '3' && $_FILES["file3"]["name"] != '')
{
 ...
 $location = '../../asset/list_document/' . $name; 
    ...
    if(move_uploaded_file($_FILES["file3"]["tmp_name"], $location)){ 
        ...
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox3a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">Ijazah</code></p>
                        <img src="uploaded_files/pngs.png" style="height: 100px;" alt="gthris">
                        <p>
                        <input type="hidden" value="'.$name.'" name="nama3a">
                        <a href="#" type="submit" class="ws-btn w3-block open_modal_search3" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
                            <a style="color: white;margin-bottom: 10px;font-size: 14px;width: 100%;background: #b5b2b2;" class="btn btn-submit  tombol-simpan3a" onclick="removeElement3a()">Remove
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus-square feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                            </a></p>
                        </div>';
            } else {
...
if($_GET['code'] == '4' && $_FILES["file4"]["name"] != '')
{
 ...
 $location = '../../asset/list_document/' . $name; 
    ...
    if(move_uploaded_file($_FILES["file4"]["tmp_name"], $location)){ 
        ...
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox4a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">NPWP</code></p>
                        <img src="uploaded_files/pngs.png" style="height: 100px;" alt="gthris">
                        <p>
                        <input type="hidden" value="'.$name.'" name="nama4a">
                        <a href="#" type="submit" class="ws-btn w3-block open_modal_search4" style="background: darkcyan;font-weight: 500;font-size: 14px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
                            <a style="color: white;margin-bottom: 10px;font-size: 14px;width: 100%;background: #b5b2b2;" class="btn btn-submit  tombol-simpan4a" onclick="removeElement4a()">Remove
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus-square feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                            </a></p>
                        </div>';
            } else {
...
if($_GET['code'] == '5' && $_FILES["file5"]["name"] != '')
{
 ...
 $location = '../../asset/list_document/' . $name; 
    ...
    if(move_uploaded_file($_FILES["file5"]["tmp_name"], $location)){ 
        ...
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;margin-top: -10px;" id="imgbox5a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">BUKU NIKAH</code></p>
                        <img src="uploaded_files/pngs.png" style="height: 100px;" alt="gthris">
                        <p>
                        <input type="hidden" value="'.$name.'" name="nama5a">
                        <a href="#" type="submit" class="ws-btn w3-block open_modal_search5" style="background: darkcyan;font-weight: 500;font-size: 15px;margin: 5px 0px 5px 0px;width: 100%;color: white;">Preview
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 25 25" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image feather-sm"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></a>
                            <a style="color: white;margin-bottom: 10px;font-size: 14px;width: 100%;background: #b5b2b2;" class="btn btn-submit tombol-simpan5a" onclick="removeElement5a()">Remove
