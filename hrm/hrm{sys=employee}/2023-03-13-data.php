                     ...
                     <table id="datatable" width="100%" border="1" align="left"
                            ...
                            <thead>
                                   <tr>
                                          ...
                                          <th class="fontCustom" style="z-index: 1;">Position</th>
                                          <th class="fontCustom" style="z-index: 1;">Join Date</th>
                                          <th class="fontCustom" style="z-index: 1;">Worklocation Code</th>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4">
                                                        <div class="input-group">
                                                               ...
                                                               <select class="input--style-6" autocomplete="off" autofocus="on" id="sel_customfield5" name="sel_customfield5" style="height: 33px;">
                                                                      <option value="" selected> --Select one --</option>
                                                                      <?php
              ...
              if (id) {
                     ...
                     $.ajax({
                            ...
                            success: function(response) {
                                   ...
                                   $("#sel_customfield5").val(response.customfield5);
