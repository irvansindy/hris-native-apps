...
<div class="modal right fade" id="modalSettlement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" data-backdrop="false">
       <div class="modal-dialog" role="document" style="top: 0px;width: 100%;">
              <div class="modal-content" style="overflow: hidden;">
                     <div class="modal-body" style="background: url('../../asset/img/bgcol.png') no-repeat fixed center; background-size: cover;">
                                                 ...
                                                 <div class="multisteps-form">
                                                        ...
                                                        <div class="row">
                                                               <div class="col-12" style="top: 20px;">
                                                                      ...
                                                                      <form class="multisteps-form__form form-horizontal" action="php_action/FuncDataUpdateEmployee.php" method="POST" id="FormSettlement" onkeydown="return event.key != 'Enter';">
                                                                             ...
                                                                             <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active">
                                                                                    ...
                                                                                    <div class="card-body table-responsive p-0" style="height: 60vh; width: 98.8%; margin: 5px;overflow-y: auto;overflow-x: hidden;border: 1px solid white;">
                                                                                           ...
                                                                                           <div class="form-row">
                                                                                                  ...
                                                                                                  <div class="col-lg-6" style="margin-top: 5px;">
                                                                                                         <div class="input-group">
                                                                                                                ...
                                                                                                                <select name="settlement_gender" id="settlement_gender" placeholder="Gender" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                                           ...
                                                                                           <div class="form-row">
                                                                                                  ...
                                                                                                  <div class="col-lg-4" style="margin-top: 5px;">
                                                                                                         <div class="input-group">
                                                                                                                ...
                                                                                                                <select name="settlement_bloodtype" id="settlement_bloodtype" placeholder="Silahkan pilih golongan darah" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                                                                       <option value="">-select one-</option>
                                                                                           ...
                                                                                           <div class="form-row">
                                                                                                  ...
                                                                                                  <div class="col-lg-4" style="margin-top: 5px;">
                                                                                                         <div class="input-group">
                                                                                                                <select name="settlement_religion" id="settlement_religion" placeholder="Silahkan pilih agama" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                                                                       <option value="">-select one-</option>
                                                                                           ...
                                                                                           <div class="form-row">
                                                                                                  ...
                                                                                                  <div class="col-lg-4" style="margin-top: 5px;">
                                                                                                         <div class="input-group">
                                                                                                                <select name="settlement_maritalstatus" id="settlement_maritalstatus" placeholder="Marital Status" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                                                                       <option value="">-select one-</option>
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-9 name">
                                                        <div class="input-group">
                                                               ...
                                                               <select name="family_relationship" id="family_relationship" placeholder="Marital Status" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                      <option value="">-select one-</option>
                                                                      <?php
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-6">
                                                        <div class="input-group">
                                                               ...
                                                               <select name="family_gender" id="family_gender" placeholder="Gender" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                      <option value="">-select one-</option>
                                                                      <?php
                                                                      $sql = mysqli_query($connect, "SELECT * FROM ttamgender GROUP BY gender_name");
                                                                      while ($data = mysqli_fetch_array($sql)) {
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-6">
                                                        <div class="input-group">
                                                               ...
                                                               <select name="family_alivestatus" id="family_alivestatus" placeholder="Marital Status" class="input--style-6" style="text-transform:uppercase;height: 33px;">
                                                                      <option value="">-select one-</option>
...
<div class="modal fade" tabindex="-1" role="dialog" id="FormDisplayDelete">
       ...
       <div class="modal-dialog modal-vsm" style="margin-top: 120px;">
              <div class="modal-content" style="border-radius: 5px;">
                     <form class="form-horizontal" action="php_action/FuncDataFamilyDelete.php" method="POST" id="DeleteFormDisplay">
...
<script type="text/javascript">
              ...
              if (id) {
                     ...
                     $.ajax({
                            ...
                            success: function(response) {
                                   ...
                                   $("#settlement_place_ofbirth").val(response.birthplace);
                                   $("#settlement_birth_date").val(response.birthdate);
       ...
       function ListRequest(id = null) {
              ...
              if (id) {
                     ...
                     // fetch the member data
                     $.ajax({
                            url: 'php_action/getSelectedRequestList.php',
                            type: 'post',
                            data: {
                                   member_id: id
                            },
       ...
       // global the manage memeber table
       $(document).ready(function() {
              $("#FamilyAddForms").on('click', function() {
                     ...
                     $("#FormFamily").unbind('submit').bind('submit', function() {
                            ...
                            if (family_name && family_relationship && family_birth_date && family_gender && family_alivestatus) {
                                   //submi the form to server
                                   $.ajax({
                                          url: 'php_action/FuncDataCreateFamily.php',
                                          type: form.attr('method'),
                                          // data: form.serialize(),
