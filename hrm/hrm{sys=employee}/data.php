		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<form method="post" id="myform">
					...
					<button type="submit" name="submit_search" id="submit_search" type="button"
...
?> -->
			...
			<div class="card-body table-responsive p-0"
				style="width: 90vw;min-height: 150vh; margin: 5px;overflow: hidden;border: 1px solid white;">
						...
						<div class="form-row">
							...
							<div class="col-sm-10">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_emp_id"
										name="inp_emp_id" type="Text" value="" onfocus="hlentry(this)" size="30"
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_identity_no"
										name="inp_identity_no" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_taxno"
										name="inp_taxno" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_email"
										name="inp_email" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_phone"
										name="inp_phone" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_birthdate"
										name="inp_birthdate" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_position_id"
										name="inp_position_id" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_joindate"
										name="inp_joindate" type="text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_pin"
										name="inp_pin" type="text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="col-sm-4">
									<div class="input-group">
										...
										<input class="input--style-6" autocomplete="off" autofocus="on"
											id="sel_position_id" name="sel_position_id" type="Text" value=""
											onfocus="hlentry(this)" size="30" maxlength="50"
											validate="NotNull:Invalid Form Entry" onchange="formodified(this);"
											title="">
									</div>
						...
						<fieldset id="fset_1" style="min-height: 100%;">
							...
							<div class="form-row">
								...
								<div class="col-sm-4">
									<div class="input-group">
										<select class="input--style-6" autocomplete="off" autofocus="on"
											id="sel_bpjspensiun" name="sel_bpjspensiun" style="height: 33px;">
											<option value="" selected> --Select one --</option>
											<?php
                                                                      $sql = mysqli_query($connect, "SELECT * FROM db_config_str WHERE id IN ('17','18')");
                                                                      while ($data = mysqli_fetch_array($sql)) {
							...
							<div class="form-row">
								<div class="col-sm-2 name">Bpjs Jaminan Ketenagakerjaan <span class="required">*</span>
								</div>
								<div class="col-sm-4">
									<div class="input-group">
										<select class="input--style-6" autocomplete="off" autofocus="on"
											id="sel_bpjsket" name="sel_bpjsket" style="height: 33px;">
											<option value="" selected> --Select one --</option>
											<?php
                                                                      $sql = mysqli_query($connect, "SELECT * FROM db_config_str WHERE id IN ('17','18')");
                                                                      while ($data = mysqli_fetch_array($sql)) {
...
<!-- Modal -->
<div class="modal right fade" id="modalSettlement" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
	data-backdrop="false">
	<div class="modal-dialog" role="document" style="top: 0px;width: 100%;">
		<div class="modal-content" style="overflow: scroll;">
			<div class="modal-body"
				style="background: url('../../asset/img/bgcol.png?v=1') no-repeat fixed center; background-size: cover;border-bottom-right-radius: 100px;border-bottom-left-radius: 100px;height:10px">
							...
							<div class="multisteps-form">
								...
								<div class="row">
									<div class="col-12">
										<div class="multisteps-form__progress">
											<button class="multisteps-form__progress-btn js-active" type="button"><b
													style="font-weight: bold;">Employee Information</b><br>Informasi
												Karyawan</button>
											...
											<button class="multisteps-form__progress-btn" type="button"><b
													style="font-weight: bold;">Family & Dependent</b><br>Keluarga &
												Tanggungan</button>
											<button class="multisteps-form__progress-btn" type="button"><b
													style="font-weight: bold;">Supporting Document</b><br>Dokumen
												Pendukung </button>
										</div>
									</div>
								</div>
								...
								<div class="row" style="margin-right: -45px;margin-left: -45px;">
									<div class="col-12" style="top: 20px;padding-right: 0;padding-left: 0px;">
										...
										<form class="multisteps-form__form form-horizontal"
											action="php_action/FuncDataUpdateEmployee.php<?php echo $getPackage; ?>"
											method="POST" id="FormSettlement" onkeydown="return event.key != 'Enter';">

											<!--single form panel-->
											<div class="multisteps-form__panel shadow p-4 bg-white js-active"
												style="border: 1px solid #d7d7d7; border-top-left-radius: 30px;border-top-right-radius: 30px;box-shadow: 0 .5rem 1rem rgba(255, 255, 255, 0.15) !important;background-color: #f5f5f5 !important;">
												...
												<table width="100%">
													<tr>
														...
														<td>
															<button class="btn btn-primary ml-auto" data-toggle="modal"
																data-target="#ListRequest"
																onclick="ListRequest(`<?php echo $username; ?>`)"
																data-keyboard="false" data-backdrop="static"
																style="width: 100%;border-radius: 103px;font-size: 10px;background: grey;"
																type="button">List Request</button>
														</td>
													</tr>
												...
												<div class="card-body table-responsive p-0"
													style="height: 50vh; width: 98.8%; margin: 5px;overflow-y: auto;overflow-x: hidden;border: 1px solid transparent;">

													<div class="form-row" style="display:none;">
														<div class="col-lg-3 name"> <label>Employee No. </label><span
																class="required">*</span></div>
														<div class="col-lg-9" style="margin-top: 5px;">
															<div class="input-group">
																<input id="inp_emp_no" name="inp_emp_no" type="hidden"
																	value="<?php echo $username; ?>">
																<input class="input--style-6" id="settlement_emp_id"
																	name="settlement_emp_id" id="settlement_emp_id"
																	type="hidden" onfocus="hlentry(this)" size="30"
																	maxlength="50">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_emp_no"
																	name="settlement_emp_no" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="Employee Number" readonly>
															</div>
														</div>
													</div>
													<div class="form-row">
														<div class="col-lg-3 name"> <label>Employee Name </label><br>
															Nama Karyawan<span class="required">*</span></div>
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_first_name"
																	name="settlement_first_name" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_middle_name"
																	name="settlement_middle_name" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_last_name"
																	name="settlement_last_name" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
													...
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_join_date"
																	name="settlement_join_date" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
													...
													<div class="form-row">
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_place_ofbirth"
																	name="settlement_place_ofbirth" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																...
																<input type="text" id="settlement_birth_date"
																	class="input--style-6" name="settlement_birth_date"
													...
													<div class="form-row">
														...
														<div class="col-lg-6" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_id_number"
																	name="settlement_id_number" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
													...
													<div class="form-row">
														...
														<div class="col-lg-6" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_idfamily"
																	name="settlement_idfamily" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="ID Family Number">
															</div>
														</div>
													</div>
													<div class="form-row">
														...
														<div class="col-lg-6" style="margin-top: 5px;">
															<div class="input-group">
																...
																<select name="settlement_gender" id="settlement_gender"
																	placeholder="Gender" class="input--style-6"
																	style="height: 33px;">
													...
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																...
																<select name="settlement_bloodtype"
																	id="settlement_bloodtype"
																	placeholder="Silahkan pilih golongan darah"
																	class="input--style-6" style="height: 33px;">
																	<option value="">-select one-</option>
													...
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<select name="settlement_religion"
																	id="settlement_religion"
													...
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<select name="settlement_maritalstatus"
																	id="settlement_maritalstatus"
																	placeholder="Marital Status" class="input--style-6"
																	style="height: 33px;">
																	<option value="">-select one-</option>
													...
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_nationality"
																	name="settlement_nationality" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
													...
													<div class="form-row">
														...
														<div class="col-lg-6" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_mobilephone"
																	name="settlement_mobilephone" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="Employee Contact [Phone Number]">
															</div>
														</div>
													</div>
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_personalmail"
																	name="settlement_personalmail" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="Employee Contact [Personal Email]">
															</div>
														</div>
													</div>
													<div class="form-row">
														...
														<div class="col-lg-4" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_officemail"
																	name="settlement_officemail" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="Employee Contact [Office Email]">
															</div>
														</div>
													</div>
													...
													<div class="form-row">
														<div class="col-lg-3 name">
															<label>Current Address <span
																	class='badge badge-Partially-Approved'
																	style="color: white;font-weight: bold;font-size: 12px;margin-bottom: 5px;width: auto;">
																	( Base on Identity ) </span></label> Alamat Domisili
															(Sesuai KTP)
														</div>
														<div class="col-lg-9" style="margin-top: 5px;">
															<div class="input-group">
																<textarea style="height: 100px;" rows="4"
																	name="settlement_current_address"
																	id="settlement_current_address"
																	placeholder="Full Current Address"
																	class="input--style-6"></textarea>
															</div>
														</div>
													</div>
													...
													<div class="form-row">
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																...
																<?php
                                                                                                                ...
                                                                                                                ?>
																<select name="settlement_curcountry"
																	id="settlement_curcountry" placeholder="Country"
																	class="input--style-6 action_domisili"
																	style="height: 33px;">
																	<option
																		value="<?php !empty($r['domisili_country_id']) ? $domisili_country_id = $r['domisili_country_id'] : $domisili_country_id = '';
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																...
																<select name="settlement_curprovince"
																	id="settlement_curprovince" placeholder="Country"
																	class="input--style-6 action_domisili"
																	style="height: 33px;">
																	<option
																		value="<?php !empty($r['settlement_curprovince_id']) ? $settlement_curprovince_id = $r['settlement_curprovince_id'] : $settlement_curprovince_id = '';
																		...
																		<?php !empty($r['settlement_curprovince_name']) ? $settlement_curprovince_name = $r['settlement_curprovince_name'] : $settlement_curprovince_name = 'Select State/City';
                                                                                                                              echo $settlement_curprovince_name; ?>
																	</option>
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																...
																<select name="settlement_curcity"
																	id="settlement_curcity"
																	class="input--style-6 action_domisili"
																	style="height: 33px;">
																	<option
																		value="<?php !empty($r['settlement_curcity_id']) ? $settlement_curcity_id = $r['settlement_curcity_id'] : $settlement_curcity_id = '';
													...
													<div class="form-row">
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<select name="settlement_curdistrict"
																	id="settlement_curdistrict"
																	class="input--style-6 action_domisili"
																	style="height: 33px;">
																	<option
																		value="<?php !empty($r['settlement_curdistrict_id']) ? $settlement_curdistrict_id = $r['settlement_curdistrict_id'] : $settlement_curdistrict_id = '';
																		...
																		<?php !empty($r['settlement_curdistrict_name']) ? $settlement_curdistrict_name = $r['settlement_curdistrict_name'] : $settlement_curdistrict_name = 'Select District';
                                                                                                                              echo $settlement_curdistrict_name; ?>
																	</option>
														...
														<div class="col-lg-3" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_curpostalcode"
																	name="settlement_curpostalcode" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="RT">
															</div>
														</div>
														<div class="col-lg-1" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_currt"
																	name="settlement_currt" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="RT">
															</div>
														</div>
														<div class="col-lg-1" style="margin-top: 5px;">
															<div class="input-group">
																<input class="input--style-6" autocomplete="off"
																	autofocus="on" id="settlement_currw"
																	name="settlement_currw" type="Text" value=""
																	onfocus="hlentry(this)" size="30" maxlength="50"
																	placeholder="RW">
															</div>
														</div>
												...
												<div class="modal-footer-sdk">
													<button class="btn-sdk btn-primary-center-only js-btn-next"
														type="button" onclick="topFunction()" id="myBtn"
											...
											<!--single form panel-->
											<div class="multisteps-form__panel shadow p-4 bg-white"
												...
												<table width="100%">
													...
													<td>
														<button class="btn btn-primary ml-auto" data-toggle="modal"
															data-target="#FamilyForm" id="FamilyAddFormsMember"
															data-keyboard="false" data-backdrop="static"
															style="width: 100%;border-radius: 103px;font-size: 10px;background: grey;"
															type="button">Add Family</button>
													</td>
												...
												<div class="modal-footer-sdk">
													<button class="btn-sdk btn-primary-left js-btn-prev" type="button"
														id="myBtn" title="Prev">Prev</button>
													<button class="btn-sdk btn-primary-right ml-auto js-btn-next"
											...
											<div class="multisteps-form__panel shadow p-4 bg-white"
												...
												<div class="modal-footer-sdk">
													<button class="btn-sdk btn-primary-left js-btn-prev" type="button"
														id="myBtn" title="Prev">Prev</button>
													<button class="btn-sdk btn-primary-right ml-auto" type="submit"
	...
	<div class="modal-dialog modal-belakang modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="card-body table-responsive p-0"
				...
				<form class="form-horizontal" action="php_action/FuncDataUpdateFamily.php" method="POST"
					id="FormFamily">
					...
					<fieldset id="fset_1">
							...
							<div class="col-sm-9 name">
								<div class="input-group">
									<input id="inp_emp_no" name="inp_emp_no" type="hidden"
										value="<?php echo $username; ?>">
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="family_empfamily_id" name="family_empfamily_id" type="hidden" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">

									<select name="family_relationship" id="family_relationship"
										placeholder="Marital Status" class="input--style-6" style="height: 33px;">
										<option value="">-select one-</option>
										<?php
						...
						<div class="form-row">
							...
							<div class="col-sm-9 name">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on" id="family_name"
										name="family_name" placeholder="Family Name" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-9 name">
								<div class="input-group">
									<input type="text" id="family_birth_date" class="input--style-6"
										name="family_birth_date" placeholder="Birth Date" style="
                                                                      background-image:url(../../asset/dist/img/icons/calendar_icon.gif);  
                                                                      background-size: 17px;
                                                                      background-position:right;   
                                                                      background-repeat:no-repeat; 
						...
						<div class="form-row">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select name="family_gender" id="family_gender" placeholder="Gender"
										class="input--style-6" style="height: 33px;">
										<option value="">-select one-</option>
										<?php
                                                                      $sql = mysqli_query($connect, "SELECT * FROM ttamgender GROUP BY gender_name");
						...
						<div class="form-row">
							...
							<div class="col-sm-6">
								<div class="input-group">
									...
									<select name="family_alivestatus" id="family_alivestatus"
										placeholder="Marital Status" class="input--style-6" style="height: 33px;">
										<option value="">-select one-</option>
	...
	<div class="modal-dialog modal-belakang modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="card-body table-responsive p-0"
				...
				<form class="form-horizontal" action="php_action/FuncDataUpdateFamily.php<?php echo $getPackage; ?>"
					method="POST" id="FormEmployeeDataChanges">
			...
			<div class="modal-footer-sdk">
				<button type="reset" class="btn-sdk btn-primary-center-only" data-dismiss="modal"
					onclick="ResetTable();" aria-hidden="true">
					&nbsp;Close&nbsp;
				</button>
			</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="FormDisplayDelete">
	...
	<div class="modal-dialog modal-vsm" style="margin-top: 120px;">
		<div class="modal-content" style="border-radius: 5px;">
			<form class="form-horizontal" action="php_action/FuncDataFamilyDelete.php<?php echo $getPackage; ?>"
				method="POST" id="DeleteFormDisplay">
			...
			$.ajax({
				...
				success: function (response) {
					...
					$("#family_personal_list").load(
						"pages_relation/_pages_family.php<?php echo $getPackage; ?>rfid=" + response
						.emp_id,
							...
							$.ajax({
								...
								success: function (response) {
									...
									if (response.code == 'success_message_update') {
										...
										$("#family_list").load(
											"pages_relation/_pages_family.php<?php echo $getPackage; ?>rfid=" +
											response.employee,
											function (responseTxt, statusTxt, jqXHR) {
												if (statusTxt == "success") {
													$("#family_list").show();
