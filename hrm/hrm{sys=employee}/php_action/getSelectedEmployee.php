...
$sql = "SELECT 
		...
		LEFT JOIN pay_insurance sub1 ON a.emp_id=sub1.emp_id AND sub1.component_id = 'BPJSJP'
        LEFT JOIN pay_insurance sub2 ON a.emp_id=sub2.emp_id AND sub2.component_id = 'BPJSKES'
        LEFT JOIN pay_insurance sub3 ON a.emp_id=sub3.emp_id AND sub3.component_id = 'BPJSJKK'
