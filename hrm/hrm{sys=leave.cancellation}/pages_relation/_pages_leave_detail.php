...
<fieldset id="fset_1">
	...
	<div class="form-row">
		...
		<div class="col-sm-8 name">
			...
			<input id="inp_reqleavenumber" name="inp_reqleavenumber" type="Hidden" value="<?php echo $xfid; ?>"
				onfocus="hlentry(this)" size="30" maxlength="50" onchange="formodified(this);" title="">
		</div>
	</div>
						...
						<table width="" align="center" cellpadding="2" cellspacing="1" bordercolor="" id="tblDetail">
							<tbody>
								<tr class="colheaderrel">
									...
									<td class="header" style="background-color: lightgrey;" align="center">Leave Date
									</td>
									<td class="header" style="background-color: lightgrey;" align="center">Total Days
									</td>
								</tr>
								<?php
								...
								<tr class="list-con odd">
									<td><?php echo $no++; ?></td>
									<input class="input--style-7" type="hidden" name="pilih0[]"
										value="<?php echo $d['leave_code']; ?>">


									<input class="input--style-7" type="hidden" name="pilih1[]"
										value="<?php echo $d['request_no']; ?>">


									<td><input class="input--style-7" type="checkbox" class="tanggal" name="pilih[]"
											value="<?php echo $d['total_days']; ?>~<?php echo $d['leave_date']; ?>">
									</td>
									<td><?php echo $d['leave_starttime']; ?></td>
									<td style='text-align:center' align="center style='align:center'">
