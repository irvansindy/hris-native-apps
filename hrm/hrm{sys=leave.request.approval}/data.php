                                   ...
                                   <thead>
                                          <tr>
                                                 ...
                                                 <th class="fontCustom" style="z-index: 1; vertical-align: middle; width: 100px;">
                                                        Request For&nbsp;&nbsp;&nbsp;</th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Type of Leave&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Start Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">End Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Total Days&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Remark&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Urgent&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Request status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Attachment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                                 <th class="fontCustom" style="z-index:1;vertical-align: ce;vertical-align: middle;">Approval status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 </th>
                                          </tr>
                                   </thead>
                            </table>
       ...
       <div class="modal-dialog modal-belakang modal-bs modal-med" role="document">
              <div class="modal-content">
                     ...
                     <div class="modal-footer-sdk" id="config-form1" style="display:none">
                            ...
                            <a style="<?php echo $button_status_hide_or_no; ?>; color: white;padding-top: 8px;" class="btn-sdk btn-primary-center-not-only" name="submit_revision_spvdown" id="submit_revision_spvdown" data-toggle="modal" data-target="#FormDisplayRevisionRequest">
                                   &nbsp;Revision&nbsp;
                            </a>
              ...
              <form class="form-horizontal" action="php_action/FuncDataRejectRequest.php<?php echo $getPackage; ?>" method="POST" id="updaterejectMemberFormspvdown">
                     ...
                     <div class="modal-body">
                            ...
                            <div class="form-group">
                                   <div class="col-sm-12">
                                          <table width="100%">
                                                 <td align="center"><label id="isi_sel_reject_request">Are you sure to reject datas ?</label></td>
                                          </table>
                            ...
                            <div class="modal-footer-delete FormDisplayRejectRequest" style="text-align: center;padding-top: 20px;">
                                   ...
                                   <button class="btn btn-warning" type="button" name="submit_reject_spvdown2" id="submit_reject_spvdown2" style='display:none;' disabled>
              ...
              <div class="modal-content" style="border: 1px solid #b3b2b2;background: #f9f9f9">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataRevisionRequest.php<?php echo $getPackage; ?>" method="POST" id="updaterevisionMemberFormspvdown">
                                   ...
                                   <div class="form-row" style="display:none;">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on" id="sel_revision_spvdown" name="sel_revision_spvdown" type="Text" value="" onfocus="hlentry(this)" size="30" maxlength="50" style="text-transform:uppercase;" validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
                                                 </div>
                                          </div>
                                   </div>
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <textarea class="input--style-6" autocomplete="off" autofocus="on" id="sel_revision_remark_spvdown" name="sel_revision_remark_spvdown" type="Text" value="" onfocus="hlentry(this)" size="30" maxlength="50" style="text-transform:uppercase;" validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title=""></textarea>
                                                 </div>
                                          </div>
                                   </div>
                            ...
                            <div class="modal-footer">
                                   ...
                                   <button class="btn btn-warning" type="button" name="submit_revision_spvdown2" id="submit_revision_spvdown2" style='display:none;' disabled>
                                          <span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>
                                          &nbsp;&nbsp;Processing..
                                   </button>
                            </div>
...
<div class="modal fade fade-custom" tabindex="-1" role="dialog" id="FormDisplayAttachmentRequest">
       <div class="modal-dialog modal-belakang modal-bs modal-med" role="document">
              <div class="modal-content">
                     ...
                     <!-- //LOAD BUTTON APPROVER STATUS -->
                     <div class="modal-footer">
                            <button type="reset" class="btn btn-primary1" style="background: #e1e1e1;" data-dismiss="modal" aria-hidden="true" data-backdrop="false">
                                   &nbsp;Cancel&nbsp;
                            </button>
                     </div>
                     <!-- //LOAD BUTTON APPROVER STATUS -->
