...
<fieldset id="fset_1">
       ...
       <div class="card-body table-responsive p-0" style="width: 100vw;height: 50vh; width: 100%; margin: 5px;overflow: scroll;overflow-x: scroll;">
              ...
              <thead>
                     ...
                     ?>
                      <tr>
                        ...
                        <td href="#" nowrap="nowrap" name='show_preview_leave_request_detail<?php echo $r['request_no']; ?>' onclick='return startload()' ide='<?php echo $r['emp_no']; ?>' idr='<?php echo $r['request_no']; ?>' class="open_modal_leave_open">
                       

                        


                        <a href='#' id="show_preview_leave_request_detail<?php echo $r['request_no']; ?>" ide='<?php echo $r['emp_no']; ?>' idr='<?php echo $r['request_no']; ?>' onclick='return startload()'>
                        ...
                        <script>
                            $(document).ready(function(){
                                          $("#show_preview_leave_request_detail<?php echo $r['request_no']; ?>").click(function(){
                                                 ...
                                                 $("#box").load("pages_relation/_pages_leave_detail.php?rfid=" + m + "&xfid=" + m2, function(responseTxt, statusTxt, jqXHR){
...
<div id="ModalEdits1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="margin-left: -5px;" aria-hidden="true"></div>