              ...
              <div class="row">
                                          ...
                                          <div class="card">
                                                 ...
                                                 <div class="card-body table-responsive p-0"
                                                        ...
                                                        <body>
                                                               ...
                                                               <form action="process_member" method="post" target="popupwindow"
                                                                      onsubmit="window.open('process_member', 'popupwindow', 'location=no, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=no, width=800,height=800'); return true">
                     ...
                     <fieldset id="fset_1">
                            ...
                            -->
                                   ...
                                   <div class="form-group" id="process_member" style="display:none;">
                                          <div class="progress">
                                   ...
                                   ?>
                                                                      ...
                                                                      CASE WHEN a.company_id = '13576' THEN 'PT. Gajah Tunggal Tbk.'
                                                                      ELSE a.company_id
                                                                      END AS company_id,
                                                                      (SELECT 'selected' FROM users_menu_access x WHERE x.is_acccessgroup_use = '$emp_no' and x.emp_no=a.emp_no) as selected
                                                                      ...
                                                                      <input type="hidden" name="formula" value="<?php echo $conversion_formula; ?>">
                                                                      ...
                                                                      <select id="test-select-4" multiple="multiple" class="framework" id="framework" name="framework[]" >
                                                                             <?php if (mysqli_num_rows($modal) > 0) { ?>
                                                                                    <?php while ($row = mysqli_fetch_array($modal)) { ?>
                                                                                           <option value="<?php echo $row['emp_no'] ?>,<?php echo $row['emp_no'] ?>"
                                                                                           data-section="<?php echo $row['company_id'] ?>"
                                                                                           data-index="1" <?php echo $row['selected'] ?>><?php echo $row['emp_no'] ?> <?php echo $row['full_name'] ?></option>
                                                                                    <?php } ?>
                                                                             <?php } ?>
                                                                      </select>
