...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        ...
                                        <td>
                                          <form action="../rfid=repository/cli_Template_Download/ta/TaDownloadGTTGRAttExport.php" method="POST">
                                          
                                          <input type="hidden" name="inp_emp" value="<?php echo $inp_emp; ?>">
                                          <input type="hidden" name="inp_name" value="<?php echo $inp_name; ?>">
                                    ...
                                    <div class="card-body table-responsive p-0"
                                        ...
                                        <table id="tableOTSetting" width="100%"
                                                ...
                                                <td rowspan="3" class="header-data" nowrap="nowrap" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Employee No.</td>
                                                <td rowspan="3" class="header-data" nowrap="nowrap" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Employee Name</td>
                                                        <td rowspan="3" class="header-data" nowrap="nowrap" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Date</td>
                                                        <td rowspan="3" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Shift</td>
                                                        <td rowspan="3" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Day Type</td>
                                                        <td rowspan="2" colspan="2" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Shift Daily</td>
                                                        <td colspan="4" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Actual Time</td>
                                                       
                                                        <td rowspan="3" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Status</td>
                                                        <!-- <td rowspan="3" class="header-data" align="center">Other Status</td> -->
                                                        <td rowspan="3" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Remark</td>
                                                 </tr>
                                                 <tr bordercolor="#000000">
                                                        <td colspan="2" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;"> in </td>
                                                        <td colspan="2" class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;"> Out</td>
                                                 </tr>
                                                 <tr bordercolor="#000000">
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;"> in </td>
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;"> Out</td>
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Time</td>
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">+/-Minute(s)</td>
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">Time</td>
                                                        <td class="header-data" align="center" style="background: #ccc;font-weight: bold;color: white;border: 1px solid white;">+/-Minute(s)</td>
