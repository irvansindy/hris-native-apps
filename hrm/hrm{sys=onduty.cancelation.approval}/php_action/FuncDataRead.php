...
// include "../../../model/ta/GMLeaveCancellationApprovalSearchGen.php"; 
// include "../../../model/ta/GMLeaveCancellationApprovalList.php";
include "../../../model/ta/GMOnDutyCancellationApprovalSearchGen.php"; 
include "../../../model/ta/GMOnDutyCancellationApprovalList.php";
...
$prn = '<a type="button" nowrap="nowrap" data-toggle="modal" data-target="#FormDisplayOnDutyCancelApproval" data-backdrop="static" style="color: blue; border: 5px; cursor:pointer" onclick="detailApproval(`'.$row['request_no'].'`)"> <input type="image" src="../../asset/dist/img/icons/icon-addinfo.png" title="delete" width="22px"/></a>';
