...
?>
       ...
       <fieldset id="fset_1">
              ...
              <div class="form-row">
                     ...
                     <div class="col-sm-8 name">
                            <textarea class="input--style-6" maxlength="255" id="inp_remark" name="inp_remark" rows="3" cols="40"></textarea>
                     </div>
              </div>
									...
									and a.cancelsts = 'N'
                                                               ...
                                                               ?>
                                                                      ...
                                                                      <tr class="list-con odd">
                                                                             <td><?php echo $no++; ?></td>
                                                                             <input class="input--style-7" type="hidden" name="pilih0[]" value="<?php echo $d['leave_code']; ?>">


                                                                             <input class="input--style-7" type="hidden" name="pilih1[]" value="<?php echo $d['request_no']; ?>">


                                                                             <td><input class="input--style-7" type="checkbox" class="tanggal" name="pilih[]" value="<?php echo $d['total_days']; ?>~<?php echo $d['leave_date']; ?>">
                                                                             </td>
