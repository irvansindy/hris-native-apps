        ...
        <div class="row page-titles" style="margin-top: -16px;">
            <div class="col-md-5 col-12 align-self-center">
                <ol class="breadcrumb mb-0 p-0 bg-transparent">
                    ...
                    <li class="digital" style="font-size: 12px;"><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Time & Attendance&nbsp;&nbsp;</li>
                    <li class="digital" style="font-size: 12px;"><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Shiftdaily Setting</li>
                </ol>
            </div>
