...
<div class="card-body table-responsive p-0" style="width: 100vw; width: 99.1%; margin: 5px;overflow-y: scroll;overflow-x: scroll;">

              <input type="hidden" name="employeee" value="<?php echo $src_emp_no; ?>">

              <label><?php echo $src_emp_no_ori; ?></label>
              <table id="datatable" width="60%" class="table table-bordered table-striped table-hover table-head-fixed" style="width: 90px;">
                     <thead>
                            <tr>
                                   <td rowspan="2" style="vertical-align: inherit;background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Date</td>
                                   <td rowspan="2" style="vertical-align: inherit;background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Shift</td>
                                   <td colspan="2" rowspan="1" style="vertical-align: inherit;background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Shift Daily</td>
                                   <td colspan="2" style="vertical-align: inherit;background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Actual Time</td>
                                   <td rowspan="2" style="vertical-align: inherit;background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Update <input id="checkAll" name="checkAll" type="checkbox" /></td>
                            </tr>
                            <tr>
                                   <td style="background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">in</td>
                                   <td style="background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Out</td>
                                   <td style="background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Time</td>
                                   <td style="background: #74614a;font-weight: bold;color: white;border: 1px solid white;;text-align: center;">Time</td>
                            </tr>
                     </thead>
                     ...
                     <button class="btn btn-primary" type="submit" name="button_setattendance" id="button_setattendance" style="background: #cdcdcd;border: 1px solid transparent;font-size: 10px;border-radius: 33px;width: 103px;padding: 7px;margin-bottom: 6px;">
                            Confirm
                     </button>
