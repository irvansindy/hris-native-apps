...
if($number == '0'){
    if($view == '1'){
        $name = "peleburan_cost_center[]";
        $id = "peleburan_cost_center";
    }else{
        $name = "peleburan_cost_center_view[]";
        $id = "peleburan_cost_center_view";
    }
}else{
    if($view == '1'){
        $name = "peleburan_cost_center[]";
        $id = "peleburan_cost_center".$number;
    }else{
        $name = "peleburan_cost_center_view[]";
        $id = "peleburan_cost_center_view".$number;
    }
}
