...
if($number == '0'){
    if($view == '1'){
        $name = "peleburan_job_status[]";
        $id = "peleburan_job_status";
    }else{
        $name = "peleburan_job_status_view[]";
        $id = "peleburan_job_status_view";
    }
}else{
    if($view == '1'){
        $name = "peleburan_job_status[]";
        $id = "peleburan_job_status".$number;
    }else{
        $name = "peleburan_job_status_view[]";
        $id = "peleburan_job_status_view".$number;
    }
}
