...
<style>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="view_pemisahan_reqno" value="<?php echo $id; ?>">
            <input type="hidden" id="req_no_pemisahan" value="<?php echo $id; ?>">
            ...
            <!-- Save otorisasi position -->
                                                 ...
                                                 <tr id="rowab<?php echo $no; ?>" class="dynamic-added">
                                                        <td width="15%">
                                                            <input class="input--style-6"
                                                               ...
                                                               name="pemisahan_leader_pos_view[]" id="pemisahan_leader_pos_view<?php echo $no; ?>" type="Text" value="<?php echo $data_position['leader_pos_name'] ?>"
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="pemisahan_pos_name_view[]" id="pemisahan_pos_name_view<?php echo $no; ?>" type="Text" value="<?php echo $data_position['position_name'] ?>"
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="pemisahan_pos_code_view[]" id="pemisahan_pos_code_view<?php echo $no; ?>" type="Text" value="<?php echo $data_position['pos_code_name'] ?>" id1="<?php echo $data_position['pos_code'] ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                                                        </td>
                                                        ...
                                                        ?>
                                                        <select class='input--style-6' name='pemisahan_cost_center_view[]' id='pemisahan_cost_center_view' style='width: ;height: 30px;'>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <select class='input--style-6' name='pemisahan_work_location_view[]' id='pemisahan_work_location_view' style='width: ;height: 30px;'>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <select class='input--style-6' name='pemisahan_job_status_view[]' id='pemisahan_job_status_view' style='width: ;height: 30px;'>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <select class='input--style-6' name='pemisahan_job_title_view[]' id='pemisahan_job_title_view' style='width: ;height: 30px;'>
                                                        <?php
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="pemisahan_reason_view[]" id="pemisahan_reason_view" type="Text" value="<?php echo $data_position['request_reason'] ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                                                        </td>
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="pemisahan_remarks_view[]" id="pemisahan_remarks_view" type="Text" value="<?php echo $data_position['request_remark'] ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                                                        </td>
                            ...
                            <div class="modal-footer">
                                                                      <div class="form-group">
                                                                             ...
                                                                             <button type="submit" id="submit_pemisahan_view" id1="1"
...
<script type="text/javascript">
            $(document).ready(function() {
                var h = '<?php echo $h ?>';
                var view = '2';
                $( "#pemisahan_leader_pos_view"+h+"" ).autocomplete({
                    serviceUrl: "ajax/leader_pos.php?aus="+$("#parsing").val(),   // Kode php untuk prosesing data.
                    dataType: "JSON",           // Tipe data JSON.
                    onSelect: function (suggestion) {
                        $( "#pemisahan_leader_pos_view"+h+"" ).val("" + suggestion.value);
                        $( "#pemisahan_leader_pos_view"+h+"" ).attr('id1', suggestion.parent);
                    }
                });


                $( "#pemisahan_pos_code_view"+h+"" ).autocomplete({
                    serviceUrl: "ajax/get_poscode.php?aus="+$("#parsing").val(),   // Kode php untuk prosesing data.
                    dataType: "JSON",           // Tipe data JSON.
                    onSelect: function (suggestion) {
                        $( "#pemisahan_pos_code_view"+h+"" ).val("" + suggestion.value);
                        $( "#pemisahan_pos_code_view"+h+"" ).attr('id1', suggestion.pos_code);
                        ...
                        $.ajax({
                            ...
                            contentType: false,  
                                success: function (msg) {
                                    $("#pemisahan_leader_pos_view"+h+"").attr("id1", msg.leader_pos_code);
                                    $("#pemisahan_leader_pos_view"+h+"").val("" + msg.leader_position);
                                    $("#pemisahan_pos_name_view"+h+"").val("" + msg.position_name);
                                    $("#pemisahan_leader_pos_view"+h+"").prop("disabled", false);
                                    $("#pemisahan_pos_name_view"+h+"").prop("disabled", false);
...
var parsing = $("#parsing").val();
 $('#add').click(function(){  
    ...
    if(i == 0){
        var validasi =  $( "#pemisahan_pos_code_view" ).val();
    }else{
        var validasi =  $( "#pemisahan_pos_code_view"+i+"" ).val();
    }
...
$.ajax({
    url: "ajax/append_pemisahan_view.php",
    type: "POST",
            data: {
                    i: i, parsing: parsing,
            },
