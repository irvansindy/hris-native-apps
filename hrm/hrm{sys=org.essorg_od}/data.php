...
$(document).ready(function(){
       ...
       $(document).on('click', '#od_approve', function(){
              ...
              var req_id           = $(this).attr('id1');
              var div_id           = $('#view_div_req').val();
              var dept_id          = $('#view_dept_req').val();
              var cc               = $('#view_cc').val();
              var worklocation     = $('#view_worklocation').val();
              var jobstatus        = $('#view_jobstatus').val();
              var jobtitle         = $('#view_jobtitle').val();
              var req_position     = $('#view_req_position').val();
              ...
              formData.append('req_position', req_position);
