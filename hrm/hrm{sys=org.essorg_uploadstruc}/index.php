        ...
        <div class="page-wrapper" style="display: block;">
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Organization</h3>
                    <ol class="breadcrumb mb-0 p-0 bg-transparent">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home&nbsp;&nbsp;</a></li>
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i>
                                &nbsp;Upload Structure OD</li>
                    </ol>
                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-2" style="margin-top:10px">
                                        <div class="input-group">
                                            <p>Apa yang akan diupload?</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-2" style="margin-top:10px">
                                        <div class="input-group">
                                            <select class="input--style-6" name="tipe_data" id="tipe_data" style="width: ;height: 30px;" >
...
<option value="3">Master Employee</option>
                                ...
                                <div style="background-color:orange; width:100%; padding-left:5px; padding-bottom:5px; display:none" id="pos_emp">
                                    ...
                                    <table>
                                        <tr>
                                            <td>1.</td>
                                            <td>&nbsp</td>
                                            <td>Download template upload Master Employee <a href="./asset/Template migrateemployee.csv" target="_blank"><u>disini</u></a>.</td>
                                        </tr>
                                        <tr>
                                            <td>2.</td>
                                            <td>&nbsp</td>
	    ...
	    if (isset($_POST['upload_mig'])) {
            ...
            $delete_tempmigrateorgunit  = mysqli_query($connect, "TRUNCATE od_tempmigrateorgunit");
            // DELETE TABLE tempmigrateorgunit
            ...
            foreach ($Reader as $Key => $Row)
            {
                ...
                if ($Key < 1) continue;			
                $query=mysqli_query($connect, "INSERT INTO od_tempmigrateorgunit(Departemen_id,Departemen_Name,Division_id,Division_name,Direktorat_id,Direktorat_name) 
                VALUES('".$department_id."','".$department_name."','".$division_id."','".$division_name."','".$direktorat_id."','".$direktorat_name."')");
            }
            if ($query) {
                    echo"<script type='text/javascript'>
                    window.alert('Berhasil!'); 
                    window.redirect('../hrm{sys=org.essorg_uploadstruc}');
                    </script>"; 
                }else{
                    echo"<script type='text/javascript'>
                    window.alert('Gagal!'); 
            ...
            // DELETE TABLE tempmigrateorgunit
            $delete_posemp  = mysqli_query($connect, "TRUNCATE od_tempmigrateemp");
            // DELETE TABLE tempmigrateorgunit
            ...
            foreach ($Reader as $Key => $Row)
            {
                ...
                if ($Key < 1) continue;			
                $query=mysqli_query($connect, "INSERT INTO od_tempmigrateemp(emp_no,posisi_id) 
            ...
            $sql_verif  = mysqli_query($connect, "SELECT * FROM od_tempmigrateorgunit");
            ...
            $delete_tempmigrateposition  = mysqli_query($connect, "TRUNCATE od_tempmigrateposition");
            // DELETE TABLE tempmigrateposition
            ...
            foreach ($Reader as $Key => $Row)
            {
                ...
                if ($Key < 1) continue;			
                $query=mysqli_query($connect, "INSERT INTO od_tempmigrateposition(posisi_id,kode_posisi,nama_posisi,parent,Direktorat_id,Division_id,Departemen_id,people_id,Jobtitle_code,Parent_path) 
            ...
            if ($query) {
                ...
                $delete_tempmigratepositionpath     = mysqli_query($connect, "TRUNCATE od_tempmigratepositionpath");
                // DELETE TABLE tempmigratepositionpath

                $insert_tempmigratepositionpath     = mysqli_query($connect, "INSERT INTO od_tempmigratepositionpath (position_id,kode_posisi,nama_posisi,parent_path,parent)
                ...
                ORDER BY pathpos.posisi_id");
                    ...
                    if($insert_tempmigratepositionpath){
                        ...
                        // Verfi data error
                        $verif_error_tempmigratefinaldata   = mysqli_query($connect, "SELECT a.posisi_id,a.kode_posisi,a.nama_posisi,a.Direktorat_id,a.Division_id,a.Departemen_id,'pos id sama poscode beda' AS type
                        ...
                        // Verfi data error
                            ...
                            $delete_tempmigratefinaldata    = mysqli_query($connect, "TRUNCATE od_tempmigratefinaldata");
                            // DELETE TABLE tempmigratefinaldata

                            $insert_tempmigratefinaldata    = mysqli_query($connect, "INSERT INTO od_tempmigratefinaldata
                            select 
