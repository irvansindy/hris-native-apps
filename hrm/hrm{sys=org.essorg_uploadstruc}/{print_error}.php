...
$sql_tampil_error   = mysqli_query($connect, "SELECT a.posisi_id,a.kode_posisi,a.nama_posisi,a.Direktorat_id,a.Division_id,a.Departemen_id,'pos id sama poscode beda' AS type
