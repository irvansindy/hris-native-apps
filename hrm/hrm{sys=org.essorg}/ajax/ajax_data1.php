...
while ($row = mysqli_fetch_assoc($query)) {
	...
	if($row['request_status'] != '0'){
		...
		$prn = "<a href='#' id1='{$row["request_no"]}' id2='{$row["request_type"]}' class='' data-toggle='modal' id='modal_view_requester' data-target='#modal-view-requester'><img src='../../asset/img/icons/glasses.png'></a>";
	}
	$output['data'][] = array(
		$row['request_no'],
		$row['fullname'],
