                            ...
                            <fieldset id="fset_1" class="penambahan" style="display:">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" id1="<?php echo $data_reqstruc['parent_id']; ?>"
                                                               ...
                                                               name="view_peleburan_leader_pos" id="view_peleburan_leader_pos" type="Text" value="<?php echo $data_reqstruc['leader_pos']; ?>"
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="view_peleburan_pos_name" id="view_peleburan_pos_name" type="Text" value="<?php echo $data_request['position_name']; ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                                                 </div>
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="view_peleburan_pos_code" id="view_peleburan_pos_code" type="Text" value="<?php echo $data_reqstruc['pos_code']; ?>" id1="<?php echo $data_reqstruc['pos_code']; ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="" >
                                                 </div>
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                    ...
                                                    <select class="input--style-6" name="view_peleburan_cost_center" id="view_peleburan_cost_center" style="width: ;height: 30px;">
                                                        <option value="0">-- Select one --</option>
                                                        <?php 
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 ...
                                                 <select class="input--style-6" name="view_peleburan_work_location" id="view_peleburan_work_location" style="width: ;height: 30px;">
                                                        <option value="0">-- Select one --</option>
                                                        <?php 
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                    ...
                                                    <select class="input--style-6" name="view_peleburan_job_status" id="view_peleburan_job_status" style="width: ;height: 30px;">
                                                        <option value="0">-- Select one --</option>
                                                        <?php 
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 ...
                                                 <select class="input--style-6" name="view_peleburan_jobtitle_code" id="view_peleburan_jobtitle_code" style="width: ;height: 30px;">
                                                        <option value="0">-- Select one --</option>
                                                        <?php 
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6"
                                                               autocomplete="off" autofocus="on" 
                                                               name="view_peleburan_reason" id="view_peleburan_reason" type="Text" value="<?php echo $data_request['request_reason']; ?>"
                                                               onfocus="hlentry(this)" size="30" maxlength="" 
                                                               validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title="">
                                                 </div>
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 ...
                                                 <textarea class="textarea--style-6" id="view_peleburan_remark" name="view_peleburan_remark" placeholder="Remarks"><?php echo $data_request['request_remark']; ?></textarea>
                                                 </div>
                                          </div>
                                   </div>
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-9">
                                                 <div class="input-group">
                                                 <input class="input--style-6" type="file" id="view_peleburan_file" name="view_peleburan_file">
...
<?php } ?>
  ...
  <script type="text/javascript">
            $(document).ready(function() {
                ...
                $( "#view_peleburan_pos_code" ).autocomplete({
                    serviceUrl: "ajax_pos_code.php",   // Kode php untuk prosesing data.
                    dataType: "JSON",           // Tipe data JSON.
                    onSelect: function (suggestion) {
                       
                        $( "#view_peleburan_pos_code" ).val("" + suggestion.value);
                        $( "#view_peleburan_pos_code" ).attr('id1', suggestion.pos_code);
                        ...
                        $.ajax({
                                ...
                                success: function (msg) {
                                    $('#view_peleburan_leader_pos').attr('id1', msg.leader_pos_code);
                                    $('#view_peleburan_leader_pos').val("" + msg.leader_position);
                                    $('#view_peleburan_pos_name').val("" + msg.position_name);
 ...
 <!-- Mengambil Position -->
   ...
   <script type="text/javascript">
            $(document).ready(function() {
                ...
                // Selector input yang akan menampilkan autocomplete.
                $( "#view_peleburan_leader_pos" ).autocomplete({
                    serviceUrl: "ajax_leader_pos.php",   // Kode php untuk prosesing data.
                    dataType: "JSON",           // Tipe data JSON.
                    onSelect: function (suggestion) {
                        $( "#view_peleburan_leader_pos" ).val("" + suggestion.value);
                        $( "#view_peleburan_leader_pos" ).attr('id1', suggestion.parent);
                    }
                });
            })
        </script>
