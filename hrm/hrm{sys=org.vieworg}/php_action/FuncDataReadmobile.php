...
while ($row = mysqli_fetch_assoc($query)) {
       ...
       <div class="toolbar sprite-toolbar-mandatoryTraining" style="position: unset;text-align: right;margin-left: 90%;margin-top: -24px;" data-toggle="modal"  data-toggle="modal" data-target="#AttachmentForm" data-backdrop="static" style="color: blue; border: 5px; cursor:pointer" onclick="urgent_attachment(`' . $row['request_no'] . '`)"></div>
