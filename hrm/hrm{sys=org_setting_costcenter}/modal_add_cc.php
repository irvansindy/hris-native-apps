                            ...
                            <fieldset id="fset_1">
                                          ...
                                          <div class="col-sm-8">
                                                <div class="input-group">
                                                    <select class="input--style-6" name="parent_code" id="parent_code" style="width: ;height: 30px;">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $data_drop_company['parent_id'] ?>" ><?php echo $data_drop_company['company_name'] ?></option>
                                                        <?php } ?>
                                                        <?php 
                                                            while($data_drop_cc = mysqli_fetch_assoc($sql_parent_code_cc)){
                                                        ?>
                                                        <option value="<?php echo $data_drop_cc['costcenter_code'] ?>" ><?php echo $data_drop_cc['costcenter_name_en'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                          </div>
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6"
                                                               ...
                                                               name="cc_code" id="cc_code" type="Text" value=""
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" 
                                                                             name="cc_name_en" id="cc_name_en" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" 
                                                                             name="cc_name_id" id="cc_name_id" type="Text" value=""
								...
								<div class="form-row" >
                                          ...
                                          <div class="col-sm-1">
                                                 ...
                                                 <input class="form-check-input" type="checkbox" value="" id1="0" id="cc_status">
...
$(document).ready(function(){  
       ...
       $(document).on('click', '#submit_cc', function(){
            ...
            if(parent_code == ''){
                ...
                alert('Cost center code required!');
                return;
            }else if(cc_name_en == ''){
