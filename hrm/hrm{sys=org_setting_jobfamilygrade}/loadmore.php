...
<?php	
    ...
    $jf_grade   = "<td class='fontCustom'><a href='#' id='{$row["jfgrade_code"]}' onclick='' class='open_modaljf_grade'>{$row["jfgrade_code"]}</a></td>";    
	...
	$output.="<tr>
            ...
            $jf_grade	
			<td class='fontCustom'>{$row["jfgrade_name_en"]}</td>
	     </tr>";
	}
...
$(document).ready(function() {
       $(".open_modaljf_grade").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_setting_jfgrade.php",
                     type: "POST",
                     data: {
                            id: m,
                     },
