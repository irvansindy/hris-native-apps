      ...
      .loader {
            ...
            opacity: 1;
              ...
              <div class="card-header">
                     <h4 class="modal-title">Job Family Level Relation</h4>
                                        ...
                                        <table id="example3LOAD" width="99%" border="1"
                                                ...
                                                <thead>
                                                    <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;" >Job Title</th>
                                                ...
                                                <tbody>
                                                    <?php 
                                                        while($data_jobtitle = mysqli_fetch_assoc($sql_jobtitle)){
                                                    ?>
                                                    <tr>
                                                        <td class='fontCustom'><?php echo $data_jobtitle['jfl_name_en']; ?></td>
                                                        <td class='fontCustom'><?php echo $data_jobtitle['jobtitle_name_en']; ?></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
