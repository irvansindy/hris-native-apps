...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Setting Job Grade Category</h4>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div id="show_search" style="margin-right:5px">
                                            <input class="input--style-6"
                                                                autocomplete="off" autofocus=""
                                                                name="search" id="search" type="Text" value=""
                                                                onfocus="" size="20" maxlength="" 
                                                                validate="NotNull:Invalid Form Entry"
                                                                onchange="" title="">
                                                                </div>
                                        </form>
                                        </td>
                                        <td><a href='#' onclick='' class='open_modal_add'>
                                                               <div class="toolbar sprite-toolbar-add" id="add"
                                                                      title="Add"></div>
                                                        </a></td>

                                                        <!-- <td><a href='#' class='open_modal_excel'>
                                                               <div class="toolbar sprite-toolbar-excel" id="export"
                                                                      title="Export"></div>
                                          </a></td> -->
                                        <!-- <td>
