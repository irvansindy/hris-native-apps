                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6"
                                                               ...
                                                               name="jt_code" id="jt_code" type="Text" value=""
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" 
                                                                             name="jt_name_en" id="jt_name_en" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" 
                                                                             name="jt_name_id" id="jt_name_id" type="Text" value=""
                                                                             onfocus="hlentry(this)" size="30" maxlength="" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                    ...
                                                    <select class="input--style-6" name="jfl_code" id="jfl_code" style="width: ;height: 30px;">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $data_jfl['jfl_code'] ?>" ><?php echo $data_jfl['jfl_name'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                 </div>
                                          </div>
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                    ...
                                                                    <textarea class="textarea--style-6" id="jt_desc_en" name="jt_desc_en" placeholder="Description"></textarea>        
                                                 ...
                                                 <div class="form-row" style="padding-left:0px">
                                                        <div class="col-sm-10">
                                                               <div class="input-group">
                                                                ...
                                                                <textarea class="textarea--style-6" id="jt_desc_id" name="jt_desc_id" placeholder="Deskripsi"></textarea>        
       ...
       $(document).on('click', '#submit_jt', function(){
              ...
              $.ajax({
	            ...
	            success: function (msg) {
	                alert(msg);
                       window.location.href = '../hrm{sys=org_setting_jobtitle}';	            
                     },
	            error: function () {
