                                                 ...
                                                 if($get_GT_JMGR) {
                                                        {
                                                                      ...
                                                                      if($process_INS_SIMPOSISI){
                                                                             ...
                                                                             while($r_simposisi=mysqli_fetch_array($process_DELETE_SIMPOSISI)){
                                                                                    $process_One = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi[posisi_id]'");
                                                                                    // echo "1.-"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi[posisi_id]'"."<br><br>";

                                                                                    if($process_One){
                                                                                           $process_DELETE_SIMPOSISI_TWO = mysqli_query($connect, "SELECT
                                                                                                                              a.posisi_id
                                                                                                                              FROM
                                                                                                                              od_simposisi a
                                                                                                                              LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                              WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                              b.parent IS NULL");
                                                                                           while($r_simposisi_two=mysqli_fetch_array($process_DELETE_SIMPOSISI_TWO)){
                                                                                                  $process_two = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_two[posisi_id]'");
                                                                                                  // echo "2.--"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_two[posisi_id]'"."<br><br>";
                                                                                                  
                                                                                                  if($process_two){
                                                                                                         $process_DELETE_SIMPOSISI_THREE = mysqli_query($connect, "SELECT
                                                                                                                                            a.posisi_id
                                                                                                                                            FROM
                                                                                                                                            od_simposisi a
                                                                                                                                            LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                            WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                            b.parent IS NULL");
                                                                                                         while($r_simposisi_three=mysqli_fetch_array($process_DELETE_SIMPOSISI_THREE)){
                                                                                                                $process_three = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_three[posisi_id]'");
                                                                                                                // echo "3.---"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_three[posisi_id]'"."<br><br>";
                            
                                                                                                                if($process_three){
                                                                                                                       $process_DELETE_SIMPOSISI_FOUR = mysqli_query($connect, "SELECT
                                                                                                                                                          a.posisi_id
                                                                                                                                                          FROM
                                                                                                                                                          od_simposisi a
                                                                                                                                                          LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                          WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                          b.parent IS NULL");
                                                                                                                       while($r_simposisi_four=mysqli_fetch_array($process_DELETE_SIMPOSISI_FOUR)){
                                                                                                                              $process_four = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_four[posisi_id]'");
                                                                                                                              // echo "4.----"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_four[posisi_id]'"."<br><br>";
                                          
                                                                                                                              if($process_four){
                                                                                                                                     $process_DELETE_SIMPOSISI_FIVE = mysqli_query($connect, "SELECT
                                                                                                                                                                        a.posisi_id
                                                                                                                                                                        FROM
                                                                                                                                                                        od_simposisi a
                                                                                                                                                                        LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                        WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                        b.parent IS NULL");
                                                                                                                                     while($r_simposisi_five=mysqli_fetch_array($process_DELETE_SIMPOSISI_FIVE)){
                                                                                                                                            $process_five = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_five[posisi_id]'");
                                                                                                                                            // echo "5.-----"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_five[posisi_id]'"."<br><br>";
                                                        
                                                                                                                                            if($process_five){
                                                                                                                                                   $process_DELETE_SIMPOSISI_SIX = mysqli_query($connect, "SELECT
                                                                                                                                                                                      a.posisi_id
                                                                                                                                                                                      FROM
                                                                                                                                                                                      od_simposisi a
                                                                                                                                                                                      LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                      WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                      b.parent IS NULL");
                                                                                                                                                   while($r_simposisi_six=mysqli_fetch_array($process_DELETE_SIMPOSISI_SIX)){
                                                                                                                                                          $process_six = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_six[posisi_id]'");
                                                                                                                                                          // echo "6.------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_six[posisi_id]'"."<br><br>";
                                                                                                                                                          ...
                                                                                                                                                          if($process_five){
                                                                                                                                                                 ...
                                                                                                                                                                 while($r_simposisi_six=mysqli_fetch_array($process_DELETE_SIMPOSISI_SIX)){
                                                                                                                                                                        ...
                                                                                                                                                                        if($process_six){
                                                                                                                                                                               $process_DELETE_SIMPOSISI_SEVEN = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                  a.posisi_id
                                                                                                                                                                                                                  FROM
                                                                                                                                                                                                                  od_simposisi a
                                                                                                                                                                                                                  LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                  WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                  b.parent IS NULL");
                                                                                                                                                                               while($r_simposisi_seven=mysqli_fetch_array($process_DELETE_SIMPOSISI_SEVEN)){
                                                                                                                                                                                      $process_seven = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_seven[posisi_id]'");
                                                                                                                                                                                      // echo "7.-------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_seven[posisi_id]'"."<br><br>";
                                                                                                  
                                                                                                                                                                                      if($process_seven){
                                                                                                                                                                                             $process_DELETE_SIMPOSISI_EIGHT = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                                a.posisi_id
                                                                                                                                                                                                                                FROM
                                                                                                                                                                                                                                od_simposisi a
                                                                                                                                                                                                                                LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                                WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                                b.parent IS NULL");
                                                                                                                                                                                             while($r_simposisi_eight=mysqli_fetch_array($process_DELETE_SIMPOSISI_EIGHT)){
                                                                                                                                                                                                    $process_eight = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_eight[posisi_id]'");
                                                                                                                                                                                                    // echo "8.--------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_eight[posisi_id]'"."<br><br>";
                                                                                                                
                                                                                                                                                                                                    if($process_eight){
                                                                                                                                                                                                           $process_DELETE_SIMPOSISI_NINE = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                                              a.posisi_id
                                                                                                                                                                                                                                              FROM
                                                                                                                                                                                                                                              od_simposisi a
                                                                                                                                                                                                                                              LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                                              WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                                              b.parent IS NULL");
                                                                                                                                                                                                           while($r_simposisi_nine=mysqli_fetch_array($process_DELETE_SIMPOSISI_NINE)){
                                                                                                                                                                                                                  $process_nine = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_nine[posisi_id]'");
                                                                                                                                                                                                                  // echo "9.---------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_nine[posisi_id]'"."<br><br>";
                                                                                                                              
                                                                                                                                                                                                                  if($process_nine){
                                                                                                                                                                                                                         $process_DELETE_SIMPOSISI_TEN = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                                                            a.posisi_id
                                                                                                                                                                                                                                                            FROM
                                                                                                                                                                                                                                                            od_simposisi a
                                                                                                                                                                                                                                                            LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                                                            WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                                                            b.parent IS NULL");
                                                                                                                                                                                                                         while($r_simposisi_ten=mysqli_fetch_array($process_DELETE_SIMPOSISI_TEN)){
                                                                                                                                                                                                                                $process_ten = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_ten[posisi_id]'");
                                                                                                                                                                                                                                // echo "10.----------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_ten[posisi_id]'"."<br><br>";
                                                                                                                                            
                                                                                                                                                                                                                                if($process_ten){
                                                                                                                                                                                                                                       $process_DELETE_SIMPOSISI_ELEVEN = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                                                                          a.posisi_id
                                                                                                                                                                                                                                                                          FROM
                                                                                                                                                                                                                                                                          od_simposisi a
                                                                                                                                                                                                                                                                          LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                                                                          WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                                                                          b.parent IS NULL");
                                                                                                                                                                                                                                       while($r_simposisi_eleven=mysqli_fetch_array($process_DELETE_SIMPOSISI_ELEVEN)){
                                                                                                                                                                                                                                              $process_eleven = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_eleven[posisi_id]'");
                                                                                                                                                                                                                                              // echo "11.-----------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_eleven[posisi_id]'"."<br><br>";
                                                                                                                                                          
                                                                                                                                                                                                                                              if($process_eleven){
                                                                                                                                                                                                                                                     $process_DELETE_SIMPOSISI_TWELVE = mysqli_query($connect, "SELECT
                                                                                                                                                                                                                                                                                        a.posisi_id
                                                                                                                                                                                                                                                                                        FROM
                                                                                                                                                                                                                                                                                        od_simposisi a
                                                                                                                                                                                                                                                                                        LEFT JOIN od_simposisi b ON a.posisi_id=b.parent
                                                                                                                                                                                                                                                                                        WHERE a.kode_posisi LIKE '%insert%' AND
                                                                                                                                                                                                                                                                                        b.parent IS NULL");
                                                                                                                                                                                                                                                     while($r_simposisi_twelve=mysqli_fetch_array($process_DELETE_SIMPOSISI_TWELVE)){
                                                                                                                                                                                                                                                            $process_twelve = mysqli_query($connect, "DELETE FROM od_simposisi WHERE posisi_id = '$r_simposisi_twelve[posisi_id]'");
                                                                                                                                                                                                                                                            // echo "12.------------"."DELETE FROM simposisi WHERE posisi_id = '$r_simposisi_twelve[posisi_id]'"."<br><br>";
                                                                      ...
                                                                      // Step OJI
                                                                      echo '<script>
                                                                                    window.alert("Selesai Hapus garis simposisi");
                                                                             </script>';

                                                                      // Step Make Simposisi All Direktorat OJI
                                                                                           ...
                                                                                           if($delete_garis_5){
                                                                                                  ...
                                                                                                  if($delete_garis_4){
                                                                                                         ...
                                                                                                         if($delete_garis_3){
                                                                                                                ...
                                                                                                                window.location.href = 'https://od.dev.gthris.com/interface_od/';
                                                                                                                </script>"; 
                                                                                                         }
                                                                                                  }
                                                                                           }
