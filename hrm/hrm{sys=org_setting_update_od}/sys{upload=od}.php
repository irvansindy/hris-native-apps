...
<html>
    ...
    <body style="padding-top:10px;padding-left:10px; padding-right:10px">
        ...
        <div style="background-color:orange; width:100%; padding-left:5px; padding-bottom:5px; display:none" id="tipe_migrateorgunit">
            <p style="text-align:center; font-weight:bold">Organisasi</p>
            <br>
            <table>
                <tr>
                    <td>1.</td>
                    <td>&nbsp</td>
                    <td>Download template upload organisasi <a href="./asset/Template migrateorgunit.csv" target="_blank"><u>disini</u></a>.</td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td>&nbsp</td>
                ...
                <tr>
                    <td>3.</td>
                    <td>&nbsp</td>
                    <td>Upload data anda dengan menekan tombol upload dibawah dan setelah itu tekan tombol upload.</td>
                </tr>
            </table>
            <br>
            <table>
        ...
        <div style="background-color:orange; width:100%; padding-left:5px; padding-bottom:5px; display:none" id="tipe_tempmigrateposition">
            <p style="text-align:center; font-weight:bold">Posisi</p>
            <br>
            <table>
                <tr>
                    <td>1.</td>
                    <td>&nbsp</td>
                    <td>Download template upload posisi <a href="./asset/Template tempmigrateposition.csv" target="_blank"><u>disini</u></a>.</td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td>&nbsp</td>
        ...
        <div style="background-color:orange; width:100%; padding-left:5px; padding-bottom:5px; display:none" id="pos_emp">
            <p style="text-align:center; font-weight:bold">Employee</p>
            <br>
            <table>
                <tr>
                    <td>1.</td>
                    <td>&nbsp</td>
                    <td>Download template upload employee <a href="./asset/Template pos_emp.csv" target="_blank"><u>disini</u></a>.</td>
                </tr>
                <tr>
                    <td>2.</td>
                    <td>&nbsp</td>
                    ...
                    if($insert_tempmigratepositionpath){
                        ...
                        // Verfi data error
                            ...
                            if($insert_tempmigratefinaldata){
                                ...
                                echo"<script type='text/javascript'>
                                window.alert('Masuk ke rekayasa data!'); 
                                </script>"; 
            ...
            image.css('display', 'block');
             ...
             // STEP 4
                            ...
                            if($insert_tempmigratefinaldata){
                                ...
                                // Verifikasi GAP
                                // $sql_max_gap    = mysqli_query($masuk, "SELECT 
                                // a.gap
                                // FROM tempmigratefinaldata a 
                                // WHERE a.gap > '1'
                                // ORDER BY a.child_parent_path
                                // DESC LIMIT 1");

                                // $data_gap       = mysqli_fetch_assoc($sql_max_gap);
                                // $gap            = $data_gap['gap'];
