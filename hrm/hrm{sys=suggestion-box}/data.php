					...
					<div class="card-body table-responsive p-0"
						...
						<fieldset id="fset_1">
							...
							<div class="mt-3">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" href="#detail_problem_identification" role="tab" data-toggle="tab">Problem Identification</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#detail_problem_background" role="tab" data-toggle="tab">Problem Background</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#detail_target_specity" role="tab" data-toggle="tab">Target Specify</a>
									</li>
									<li class="nav-item">
								...
								<!-- Tab panes -->
								<div class="tab-content mt-4">
									<div role="tabpanel" class="tab-pane fade in active" id="detail_problem_identification">
										<div class="form-row">
											<div class="col">
												<div class="input-group">
													<textarea class="input--style-6 suggestion_summernote" name="input_problem_identification" id="input_problem_identification"></textarea>
									...
									<div role="tabpanel" class="tab-pane fade" id="detail_problem_background">
										<div class="form-row">
											<div class="col">
												<div class="input-group">
													<textarea class="input--style-6 suggestion_summernote" name="input_problem_background" id="input_problem_background"></textarea>
									...
									<div role="tabpanel" class="tab-pane fade" id="detail_target_specity">
										<div class="form-row">
											<div class="col">
												<div class="input-group">
													<textarea class="input--style-6 suggestion_summernote" name="input_target_specify" id="input_target_specify"></textarea>
