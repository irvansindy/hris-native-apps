...
?>
                            ...
                            $(document).ready(function() {
                                   ...
                                   if (action == 'inactive') {
                                          action = 'active';
                                          window.document.getElementById("msg").innerHTML = "<img src='../../asset/dist/img/indexa.gif' width='90px'>";
                                    ...
                                    <div class="card-body table-responsive p-0"
                                        ...
                                        <table id="example3LOAD" width="99%" border="1"
                                                ...
                                                <thead>
                                                 ...
                                                 <tr id="loader-datatable" name="loader-datatable" class="loader-datatable">
                                                        <td style="border: 1px solid #ececec;background: #fbfbfb;text-align: center;" colspan="12"><p id="msg" name="msg" class="loader-datatable"></p></td>
                                                 </tr>
                                                 </thead>
