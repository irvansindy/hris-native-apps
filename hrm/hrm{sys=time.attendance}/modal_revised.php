...
?>
              ...
              $(document).ready(function() {
                     $('#modal_leave_start, #modal_leave_end').on('change', function() {
                            var modal_leave_starts = document.getElementById("modal_leave_start").value;
                            var modal_leave_ends = document.getElementById("modal_leave_end").value;
...
<?php
       ...
       $remarkadv = mysqli_query($connect,"SELECT revised_remark 
                            ...
                            WHERE request_no LIKE '$req_no' and (`revised_remark` IS NOT NULL or `revised_remark` <> '') ORDER BY `revised_remark` ASC LIMIT 1");
...
<div class="modal-dialog modal-med">
       <div class="modal-content">
              ...
              <div class="modal-header">
                     <h4 class="modal-title">Revised Leave Request</h4>
              ...
              <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <div class="form-row">
                                   <div class="col-4 name">Remark from approver</div>
                                   <div class="col-sm-8">
                                          <div class="input-group">

                                                 <input class="input--style-6" style="background-color: #fff3b4;"
                                                        id="inp_remark_advisor" name="inp_remark_advisor" type="Text"
                                                        value="<?php echo $revisiremark; ?>" onfocus="hlentry(this)" size="500"
                            ...
                            <td colspan="3" align="right" width="100%">
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button type="submit" name="submit_revised_X5" id="submit_revised_X5"
