              ...
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataCreate.php" method="POST"
                            ...
                            <script type="text/javascript">
                                   ...
                                   uploadUrl: "imageUpload.php?id_whitle=" + inp_whistle_requestno + "&username=<?php echo $username; ?>",
                            ...
                            <script>
                                   ...
                                   var sel_whistle_requestno = $('#sel_whistle_requestno').val();
                                                 ...
                                                 if (file_update!="") {
                                                        ...
                                                        $.ajax({
                                                        type: 'POST',
                                                        url: "imageUploadUpdate.php?id_whistle_upload=" + sel_whistle_requestno + "&username=<?php echo $username; ?>",
                                                        data: formData,
                                                        cache: false,
                                                        processData: false,
                                                        contentType: false,
                                                        success: function () {
                                                               ...
                                                               $("#box").hide();
                                                               $("#box_update").load("pages_relation/_pages_photo.php?rfid=" + sel_whistle_requestno + "&username=<?php echo $username; ?>", 
       ...
       if (id) {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            ...
                            $("#box").load("pages_relation/_pages_photo.php?rfid=" + response._id_whistle + "&username=<?php echo $username; ?>", 
                                          function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up){
                                                 if(statusTxt_spv_up == "success"){
                                                        $("#box").show();
                                                        mymodalss.style.display = "none";
