...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">Workflow Upload Setting </h4>
              ...
              <div class="card-actions ml-auto">
                            ...
                            <input type="file" id="filepegawaiall" name="filepegawaiall" /><br/>
                            <label>File allowed: Excel 97-2003 file (*.xls) Maximum file size: 4 MB</label><br>
                                   <input type="submit" name="submit" value="Import" class="btnreport btn-report"/><br/>
                            ...
                            <thead>
                                   <tr>
                                          ...
                                          <th class="fontCustom"
                                                 ...
                                                 Emp no</th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Full Name
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Cost Code
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Request Code
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Approval Step 1
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Approval Step 2
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Approval Step 3
                                          </th>
...
$(document).ready(function() {
       $("#CreateButton").on('click', function() {
              ...
              $("#FormDisplayCreate").unbind('submit').bind('submit', function() {
                     ...
                     if (inp_reason_code && inp_reason_name_en && inp_reason_name_id) {
