...
<?php include "../../../../model/ta/GMLeaveCancellationApprovalSearchGen.php";?>
<?php include "../../../../model/ta/GMLeaveCancellationApprovalList.php";?>
...
<tr>
			...
			<td class='fontCustom'><?php echo $r["requestdate"]; ?></td>
