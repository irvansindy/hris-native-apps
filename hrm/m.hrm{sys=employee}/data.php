                                          ...
                                          <div class="col-sm-4">
                                                 <div class="input-group">
                                                        ...
                                                        <select class="form-control input--style-6" 
                                                                      autocomplete="off" 
                                                                      autofocus="on"
                                                                      id="inp_shiftgroup_code" 
                                                                      name="inp_shiftgroup_code"
                                                                      style="height: 33px;">
                                                                             <option value="" selected> --Select one --</option>
                                                                             <?php 
                                          ...
                                          <div class="col-sm-4">
                                                 <div class="input-group">
                                                               ...
                                                               <input class="input--style-6" autocomplete="off"
                                                                      autofocus="on" id="inp_account_name"
                                                                      name="inp_account_name" type="Text" value=""
                                                                      onfocus="hlentry(this)" size="30" maxlength="50"
                                                                       validate="NotNull:Invalid Form Entry"
                                                                      onchange="formodified(this);" title=""
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               <input class="input--style-6" autocomplete="off"
                                                                      autofocus="on" id="inp_branch" name="inp_branch"
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4" style="padding-bottom:5px">
                                                        <div class="input-group">
                                                               <input class="input--style-6" autocomplete="off"
                                                                      autofocus="on" id="inp_account_number"
                                                                      name="inp_account_number" type="Text" value=""
                                                                      onfocus="hlentry(this)" size="30" maxlength="50"
                                                                       validate="NotNull:Invalid Form Entry"
                                                                      onchange="formodified(this);" title=""
