...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">Attendance Correction </h4>
                            ...
                            <thead>
                                   <tr>
                                          <th class="fontCustom"
                                                 ...
                                                 Attend<br>Date</th>
                                          <th class="fontCustom"
                                                 style="z-index:1;vertical-align: ce;vertical-align: middle;">Day<br>Type&nbsp;&nbsp;&nbsp;
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index:1;vertical-align: ce;vertical-align: middle;">Status&nbsp;&nbsp;&nbsp;<br>In
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index:1;vertical-align: ce;vertical-align: middle;">Status&nbsp;&nbsp;&nbsp;<br>Out
                                          </th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">
                                                 Action&nbsp;&nbsp;&nbsp;
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group" id="sel_identity">
                                                  ...
                                                  <input type="hidden" id="sel_emp" name="sel_emp" value="<?php echo $username; ?>">       
                                          </div>
                                   </div>
