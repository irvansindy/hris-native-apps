...
<div class="col-md-12">
       <div class="card">
              ...
              <div class="card-body table-responsive p-0"
                     ...
                     <table id="datatable" width="70%" border="1" align="left"
                                          ...
                                          <div class="form-row" style="display:nones">
                                                 <div class="col-sm-12">
                                                        <div class="input-group">
                                                               ...
                                                               <select id="inp_process_order" class="input--style-6"
                                                                             name="inp_process_order" onfocus="hlentry(this)"
                                          ...
                                          <div class="form-row">
                                                 <div class="col-sm-12">
                                                        <div class="input-group">
                                                               ...
                                                               <img onclick="SelectNameCreate()" src="../../asset/dist/img/suggest.png" style="cursor: pointer;">
                                                               <script type="text/javascript">
                                                                      var popup;
                                                                      function SelectNameCreate() {
                                                                             var x = document.getElementById("inp_formula").value;
                                                                             popup = window.open("Popup_create.php?id=" + x , "Popup", "width=510,height=300");
                                                                             popup.focus();
                                                                             return false
                                                                      }
                                                               </script>   
