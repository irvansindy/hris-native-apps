                                                                                                                                                                 ...
                                                                                                                                                                 <td colspan="2"
                                                                                                                                                                        ...
                                                                                                                                                                        <table id="datatable"
                                                                                                                                                                               ...
                                                                                                                                                                               <thead>
                                                                                                                                                                                      <tr>
                                                                                                                                                                                             <th class="fontCustom"
                                                                                                                                                                                                    style="z-index: 1;vertical-align: ce;vertical-align: middle;background-color:grey;color:white;"
                                                                                                                                                                                                    nowrap="nowrap">
                                                                                                                                                                                                    Item.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                                                                                                             </th>
                                                                                                                                                                                      </tr>
        ...
        ?>
                                                                                                                                                                               ...
                                                                                                                                                                               <tr>
                                                                                                                                                                                      <td style="cursor: pointer;"
                                                                                                                                                                                             onclick="SetName<?php echo $row['word'] ?>();">
                                                                                                                                                                                             <input type="hidden"
                                                                                                                                                                                                    name="ddlNames"
                ...
                function SetName$row[word]() {
                        if (window.opener != null && !window.opener.closed) {
                                var sel_formula = window.opener.document.getElementById('sel_formula');
                                sel_formula.value = '$datax' + ' {'+document.getElementById('ddlNames$row[word]').value+'} ' ;
                        }
                        window.close();
                }
                </script>";
