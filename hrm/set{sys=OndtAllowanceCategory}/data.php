<?php  
       $src_category_code                   = '';
       $src_category_name_en                = '';
       if (!empty($_POST['src_category_code']) && !empty($_POST['src_category_name_en'])) {
              $src_category_code            = $_POST['src_category_code'];
              $src_category_name_en         = $_POST['src_category_name_en'];
              $frameworks                   = "?src_category_code="."".$src_category_code."&src_category_name_en="."".$src_category_name_en."";
       } else if (empty($_POST['src_category_code']) && !empty($_POST['src_category_name_en'])) {
              $src_category_code            = $_POST['src_category_code'];
              $src_category_name_en         = $_POST['src_category_name_en'];
              $frameworks                   = "?src_category_name_en="."".$src_category_name_en."";
       } else if (!empty($_POST['src_category_code']) && empty($_POST['src_category_name_en'])) {
              $src_category_code            = $_POST['src_category_code'];
              $src_category_name_en         = $_POST['src_category_name_en'];
              $frameworks                   = "?src_category_code="."".$src_category_code."";
       }
?>
<!-- Modal -->
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Category code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="src_category_code"
                                                                             name="src_category_code" id="src_category_code" type="Text" value="<?php echo $src_category_code; ?>"
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Category name </div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="src_category_name_en" id="src_category_name_en" type="Text" value="<?php echo $src_category_name_en; ?>"
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">On Duty Allowance Category Setting </h4>
                            ...
                            <table>
                                   ...
                                   <td>
                                          <form action="../rfid=repository/cli_Template_Download/st/StFunctionDownload.php" method="GET">
                                                 <input type="hidden" name="filedata" value="StDownloadGTTGROndtAllowanceCategoryData.php">
                                                 <input type="hidden" name="filename" value="OndtAllowanceCategory">
                                                 <input type="hidden" name="src_category_code" value="<?php echo $src_category_code; ?>">
                                                 <input type="hidden" name="src_category_name_en" value="<?php echo $src_category_name_en; ?>">
       ...
       <div class="modal-dialog modal-belakang modal-bs" role="document">
              <div class="modal-content">
                     <div class="modal-header">
                            <h4 class="modal-title">Add Allowance Category</h4>
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   <span aria-hidden="true"><img src="../../asset/dist/img/icons/icon_del.png"></span>
                            </a>
                     </div>
                            ...
                            <fieldset id="fset_1">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_category_code" name="inp_category_code"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_category_name_en" name="inp_category_name_en"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_category_name_id" name="inp_category_name_id"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                     ...
                     <tr><td align="center"><img src="../../asset/dist/img/sf-mola-mola.png" style="max-width: 90%;margin-top: 20px;"></td></tr>
                            ...
                            <div class="form-group">
                                   <div class="col-sm-12">	
                                                 ...
                                                 <input type="hidden" class="form-control input-report" id="sel_category_codeS" name="sel_category_codeS" placeholder="">
                                   </div>
                            </div>
...
$(document).ready(function() {
       $("#CreateButton").on('click', function() {
              ...
              $("#FormDisplayCreate").unbind('submit').bind('submit', function() {
                     ...
                     var inp_category_code = $("#inp_category_code").val();
                     var inp_category_name_en = $("#inp_category_name_en").val();
                     var inp_category_name_id = $("#inp_category_name_id").val();
                  
                     var regex=/^[a-zA-Z]+$/;
                  
                     if (inp_category_code == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Category code cannot empty";

                     } else if (inp_category_name_en == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Category desc en cannot empty";

                     } else if (inp_category_name_id == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Category desc id cannot empty";
                     ...
                     if (inp_category_code && inp_category_name_en && inp_category_name_id) {
...
function editMember(id = null) {
       if (id) {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            document.getElementById("sel_identity").innerHTML = response.category_code;
                            
                            $("#sel_category_code").val(response.category_code);
                            $("#sel_category_name_en").val(response.category_name_en);
                            $("#sel_category_name_id").val(response.category_name_id);     
                            var sel_category_code       = response.category_code;
                            ...
                            $("#FormDisplayUpdate").unbind('submit').bind('submit', function() {
                                   ...
                                   var sel_category_code        = $("#sel_category_code").val();
                                   var sel_category_name_en     = $("#sel_category_name_en").val();
                                   var sel_category_name_id     = $("#sel_category_name_id").val();

                                   if (sel_category_code == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Category code cannot empty";

                                   } else if (sel_category_name_en == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Category name en desc en cannot empty";

                                   } else if (sel_category_name_id == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Category name id desc en cannot empty";
                                   ...
                                   if (sel_category_code && sel_category_name_en && sel_category_name_id) {
