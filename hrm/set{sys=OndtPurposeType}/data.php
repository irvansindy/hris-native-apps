                                                        ...
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="src_purpose_code"
                                                                             name="src_purpose_code" id="src_purpose_code" type="Text" value="<?php echo $src_purpose_code; ?>"
                                                        ...
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             ...
                                                                             name="src_purpose_name_en" id="src_purpose_name_en" type="Text" value="<?php echo $src_purpose_name_en; ?>"
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
                            ...
                            <thead>
                                   <tr>
                                          <th class="fontCustom"
                                                 ...
                                                 nowrap="nowrap">No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;" nowrap="nowrap">
                            ...
                            <fieldset id="fset_1">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_purpose_code" name="inp_purpose_code"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_purpose_name_en" name="inp_purpose_name_en"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_purpose_name_id" name="inp_purpose_name_id"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          <div class="col-sm-12">
                                                 ...
                                                 ?>
                                                 <select id="test-select-4" multiple="multiple" class="framework" id="inp_allowance_item" name="inp_allowance_item[]" >
                                                        <?php if (mysqli_num_rows($modal) > 0) { ?>
                                                               <?php while ($row = mysqli_fetch_array($modal)) { ?>
                                                                      <option value="<?php echo $row['item_code'] ?>"
                                                                      data-section="allowance item"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                               <select id="inp_attendcode" class="input--style-6"
                                                                      name="inp_attendcode" onfocus="hlentry(this)"
                                                                      ...
                                                                      ?>
                                                                             ...
                                                                             <?php while ($row = mysqli_fetch_array($req)) { ?>
                                                                                    <option value="<?php echo $row['attend_code'] ?>"><?php echo $row['attend_name_en'] ?>
                                                                             <?php } ?>
                                                                      <?php } ?>
                                                               </select>
                                                 </div>
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="form-row" style="display:none">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_purpose_code" name="sel_purpose_code"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_purpose_name_en" name="sel_purpose_name_en"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_purpose_name_id" name="sel_purpose_name_id"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
										...
										$req=mysqli_query($connect, "SELECT * FROM `HRMTTAMATTSTATUS`");
										?>
										<select name="sel_attend_code" id="sel_attend_code" class="input--style-6" style="width:undefined;height: 33px;width: 80%;">
											<option value="">--Select One--</option>
												<?php if (mysqli_num_rows($req) > 0) { ?>
												<?php while ($row = mysqli_fetch_array($req)) { ?>
		  ...
		  <table width="100%">
                     ...
                     <div class="form-group">
                            <div class="col-sm-12">	
                                          ...
                                          <input type="hidden" class="form-control input-report" id="sel_purpose_codeS" name="sel_purpose_codeS" placeholder="">
                            </div>
                     </div>
                     ...
                     success: function(response) {
                            ...
                            $("#FormDisplayUpdate").unbind('submit').bind('submit', function() {
                                   ...
                                   if (sel_purpose_code == "") {
                                          ...
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Purpose name en desc en cannot empty";

                                   } else if (sel_purpose_name_id == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Purpose name id desc en cannot empty";
                                   ...
                                   if (sel_purpose_code && sel_purpose_name_en && sel_purpose_name_id && sel_attend_code) {
