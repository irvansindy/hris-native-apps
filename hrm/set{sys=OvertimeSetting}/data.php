							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="src_overtimecode" name="src_overtimecode" id="src_overtimecode" type="Text"
										value="<?php echo $src_overtimecode; ?>" onfocus="hlentry(this)" size="30"
						...
						<div class="form-row" style="display:none">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										name="src_minimumtime" id="src_minimumtime" type="Text"
										value="<?php echo $src_minimumtime; ?>" onfocus="hlentry(this)" size="30"
										maxlength="50" validate="NotNull:Invalid Form Entry"
										onchange="formodified(this);" title="">
								</div>
							</div>
			...
			<table id="datatable" width="100%" border="1" align="left"
				...
				<thead>
					<tr>
						...
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">
							Overtime Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">Minimum
							Time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</th>
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">Overtime
							Calculation
						</th>
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">Overtime
							Rounding (Minutes)</th>
						...
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">Factor
							Setting
						</th>
						<th class="fontCustom" style="z-index: 1;vertical-align: ce;vertical-align: middle;">Factor
							Action
	...
	<div class="modal-dialog modal-belakang modal-bg" role="document">
		<div class="modal-content">
				...
				<form class="form-horizontal" action="php_action/FuncDataCreate.php" method="POST"
					...
					<fieldset id="fset_1">
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="inp_overtime_code" name="inp_overtime_code" type="Text" value=""
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="inp_overtime_minimum" name="inp_overtime_minimum" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<select id="inp_ovtcalctype" class="input--style-6" name="inp_ovtcalctype"
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_otrounding"
										name="inp_otrounding" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
							</div>
						</div>
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="inp_otroundlimit" name="inp_otroundlimit" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on" id="inp_otachieved"
										name="inp_otachieved" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="lbl_inp_otdeucted" name="lbl_inp_otdeucted" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<div class="card-body table-responsive p-0"
										style="width: 88%; margin: 1px;overflow: scroll;">
										...
										<table class="table table-bordered table-striped table-hover table-head-fixed"
											...
											<thead>
												<tr>
													...
													<th>Per Hour</th>
													<th>Value</th>
													<th><a class=" add-record" style="margin-right: 7px;"
															data-added="0"><img
							...
							<table class="table table-bordered table-striped table-hover table-head-fixed"
								...
								<thead>
									<tr>
										...
										<th>Meal</th>
										<th>Transport</th>
										<th><a class="add-record_second" style="margin-right: 7px;" data-added="0"><img
													src="../../asset/img/icons/acssadd.png"></a></th>
									</tr>
								</thead>
								<tbody id="tbl_posts_body_second">
									<tr id="recs-1">
										<td><span class="sn">1</span>.</td>
										<td><select id="OTtypeother" class="" name="OTtypeother[]"
												onfocus="hlentry(this)" onchange="formodified(this);"
										...
										<td><a class="delete-record_second" data-added="0"><img
													src="../../asset/img/icons/minus.png"></a></td>
									</tr>
								</tbody>
							</table>
			...
			<div class="modal-footer">
				...
				<button class="btn btn-warning" type="button" name="submit_add2" id="submit_add2" style='display:none;'
					disabled>
					...
					<fieldset id="fset_1">
						...
						<div class="form-row" style="display:none">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="sel_overtime_code" name="sel_overtime_code" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 60%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="sel_overtime_minimum" name="sel_overtime_minimum" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<select id="sel_ovtcalctype" class="input--style-6" name="sel_ovtcalctype"
										onfocus="hlentry(this)" onchange="formodified(this);"
										style="width:undefined;height: 33px;width: 45%;">
										<option value="">--Select One--</option>
										<option value="SEPARATED">Separated Calculation</option>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="sel_otrounding"
										name="sel_otrounding" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="sel_otroundlimit" name="sel_otroundlimit" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on" id="sel_otachieved"
										name="sel_otachieved" type="Text" value="" onfocus="hlentry(this)" size="30"
										maxlength="50" style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
							</div>
						...
						<div class="form-row">
							...
							<div class="col-sm-8">
								<div class="input-group">
									...
									<input class="input--style-6" autocomplete="off" autofocus="on"
										id="lbl_sel_otdeucted" name="lbl_sel_otdeucted" type="Text" value=""
										onfocus="hlentry(this)" size="30" maxlength="50"
										style="text-transform:uppercase;width: 30%;"
										validate="NotNull:Invalid Form Entry" onchange="formodified(this);" title="">
								</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<input type="hidden" class="form-control input-report" id="sel_overtime_codes"
								name="sel_overtime_codes" placeholder="Nip">
						</div>
					</div>
	...
	$(document).ready(function () {
		$("#CreateButton").on('click', function () {
			...
			$("#FormDisplayCreate").unbind('submit').bind('submit', function () {
				...
				if (inp_overtime_code && inp_overtime_minimum && inp_ovtcalctype &&
					inp_otrounding && inp_otroundlimit) {
					...
					$.ajax({
						...
						success: function (response) {
							...
							if (response.code == 'success_message') {
								...
								$("#tbl_posts_second > tbody > .reset-delete-record")
									.html("");
								$("#tbl_posts > tbody > .reset-delete-record").html(
								"");
			...
			$.ajax({
				...
				success: function (response) {
					...
					$("#FormDisplayUpdate").unbind('submit').bind('submit', function () {
						...
						if (sel_overtime_code && sel_overtime_minimum && sel_ovtcalctype &&
							sel_otrounding && sel_otroundlimit) {
