<?php
	...
	$rfid = $_GET['rfid'];
	//$modal_id = '1';
	$modal=mysqli_query($connect, "SELECT * FROM hrmovertime a WHERE a.overtime_code='$rfid'");
	...
	<table class="table table-bordered table-striped table-hover table-head-fixed" id="tbl_posts_four">
		<thead>
			<tr>
				...
				<th>Transport</th>
				<th>
					<a class="add-record_four" style="margin-right: 7px;" data-added="0"><img src="../../asset/img/icons/acssadd.png">
					</a>
				</th>
			</tr>
		</thead>
		<tbody id="tbl_posts_body_four">
			...
			<tr id="recfour-1">
				...
				<td>
					<select id="OTtypeother" class="" name="SelOTtypeother[]" onfocus="hlentry(this)"
				...
				<td><input type="text" value="<?php echo $rs['step'];?>" name="SelOTminutes[]"></td>
				<td><input type="text" value="<?php echo $rs['total_OTMEAL'];?>" name="SelOTmeal[]"></td>
				<td><input type="text" value="<?php echo $rs['total_OTTRANSPORT'];?>" name="SelOTtransport[]"></td>
	...
	<div style="display:none;">
		<table id="sample_table_four" class="table table-bordered table-striped table-hover table-head-fixed">
			<tr id="" class="reset-delete-record">
				...
				<td><select id="OTtypeother" class="" name="SelOTtypeother[]" onfocus="hlentry(this)"
						onchange="formodified(this);"
						style="width:undefined;width: 160px;border: 1px solid #cac2c2;text-align: center;color: #484545;">
				...
				<td><input type="text" value="" name="SelOTminutes[]"></td>
				<td><input type="text" value="<?php echo $rs['value'];?>" name="SelOTmeal[]"></td>
				<td><input type="text" value="<?php echo $rs['value'];?>" name="SelOTtransport[]"></td>
				<td><a class="delete-record_four" data-added="0"><img src="../../asset/img/icons/minus.png"></a></td>
			</tr>
		</table>
	</div>
