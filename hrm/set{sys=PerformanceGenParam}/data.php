...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">Performance Parameter Setting </h4>
                            ...
                            <thead>
                                   <tr>
                                          <th class="fontCustom"
                                                 ...
                                                 nowrap="nowrap">No.</th>
                                          <th class="fontCustom"
                                                 style="z-index: 1;vertical-align: ce;vertical-align: middle;">Request type</th>
                                          <th class="fontCustom"
       ...
       <div class="modal-dialog modal-belakang modal-bs" role="document">
              <div class="modal-content">
                     <div class="modal-header">
                            <h4 class="modal-title">Add Performance Parameter</h4>
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   <span aria-hidden="true"><img src="../../asset/dist/img/icons/icon_del.png"></span>
                            </a>
                     </div>
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_reason_code" name="inp_reason_code"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_reason_name_en" name="inp_reason_name_en"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_reason_name_id" name="inp_reason_name_id"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
              ...
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataUpdate.php" method="POST" id="FormDisplayUpdate">
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="form-row">
                                          <div class="col-4 name">Parameter Code <span class="required">*</span></div>
                                          <div class="col-sm-8">
                                                 <div class="input-group" id="sel_identity"></div>
                                                 <input id="sel_parameter_code" name="sel_parameter_code" type="hidden" value="">
                                          </div>
                                   </div>
...
function editMember(id = null) {
       if (id) {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            document.getElementById("sel_identity").innerHTML = response.request_type;
                            
                            $("#sel_parameter_code").val(response.request_type);

                            var sel_param       = response.request_type;

                             $("#box").load("pages_relation/_pages_setting.php?rfid=" + sel_param, 
                            ...
                            $("#FormDisplayUpdate").unbind('submit').bind('submit', function() {
                                   ...
                                   var sel_parameter_code         = $("#sel_parameter_code").val();
         
                                   var regex=/^[a-zA-Z]+$/;

                                   if (sel_parameter_code == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Parameter code cannot empty";
