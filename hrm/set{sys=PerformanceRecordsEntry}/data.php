...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">IPP Records Entry </h4>
                     <div class="card-actions ml-auto">
                            <table>
                                   <td>
                                          <a href='#'>
...
<div class="modal fade fade-custom" tabindex="-1" role="dialog" id="FormDisplayAddEffidentSPVUP">
              ...
              <div class="modal-content">
                     <div class="modal-header">
                            <h4 class="modal-title" id="entry_spvup">Entry Form</h4>
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   <span aria-hidden="true"><img src="../../asset/dist/img/icons/icon_del.png"></span>
                            </a>
                     </div>
	...
	if(id) {
		$.ajax({
			...
			success:function(response) {
                            ...
                            $("#box_spvup_effident").load("pages_relation/_pages_approval_effident_spvup.php?rfid=" + response.ipp_reqno + "&kpi_pers_spv_up=" + response.kpi_pers_spv_up + "&kpi_id_spv_up=" + response.kpi_id_spv_up, 
                                   function(responseTxt, statusTxt, jqXHR){
                                          if(statusTxt == "success"){
