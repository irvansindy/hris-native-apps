...
<?php 
$page   = '46'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '21'
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    ...
                    <ol class="breadcrumb mb-0 p-0 bg-transparent">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Performance Records Entry&nbsp;&nbsp;</a></li>
                        <li ><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;IPP Records Entry</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
