...
<div class="input-group">
                                                 ...
                                                 ?>
                                                 <select id="test-select-4s" multiple="multiple" class="framework" id="sel_allowance_item" name="sel_allowance_item[]" >
                                                        <?php if (mysqli_num_rows($modal) > 0) { ?>
                                                               <?php while ($row = mysqli_fetch_array($modal)) { ?>
                                                                      ...
                                                                      data-index="1" <?php echo $row['selected'] ?>><?php echo $row['item_name_en'] ?></option>
                                                               <?php } ?>
                                                        <?php } ?>
                                                 </select>
                                                 </div>
