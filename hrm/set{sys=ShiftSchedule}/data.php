<?php  
       $src_schedulegroup_code            = '';
       $src_schedulegroup_desc            = '';
       if (!empty($_POST['src_schedulegroup_code']) && !empty($_POST['src_schedulegroup_desc'])) {
              $src_schedulegroup_code     = $_POST['src_schedulegroup_code'];
              $src_schedulegroup_desc     = $_POST['src_schedulegroup_desc'];
              $frameworks                 = "?src_schedulegroup_code="."".$src_schedulegroup_code." &&src_schedulegroup_desc="."".$src_schedulegroup_desc."";
       } else if (empty($_POST['src_schedulegroup_code']) && !empty($_POST['src_schedulegroup_desc'])) {
              $src_schedulegroup_code     = $_POST['src_schedulegroup_code'];
              $src_schedulegroup_desc     = $_POST['src_schedulegroup_desc'];
              $frameworks                 = "?src_schedulegroup_desc="."".$src_schedulegroup_desc."";
       } else if (!empty($_POST['src_schedulegroup_code']) && empty($_POST['src_schedulegroup_desc'])) {
              $src_schedulegroup_code     = $_POST['src_schedulegroup_code'];
              $src_schedulegroup_desc     = $_POST['src_schedulegroup_desc'];
              $frameworks                 = "?src_schedulegroup_code="."".$src_schedulegroup_code."";
       }
?>
<!-- Modal -->
                            ...
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   ...
                                   <form method="post" id="myform">
                                          <fieldset id="fset_1" style="margin-top: 25px;border-radius: 5px;border: 1px solid #e4e8ea;">
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Schedulegroup code</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="src_schedulegroup_code"
                                                                             name="src_schedulegroup_code" id="src_schedulegroup_code" type="Text" value="<?php echo $src_schedulegroup_code; ?>"
                                                 ...
                                                 <div class="form-row">
                                                        <div class="col-4 name">Schedule group desc</div>
                                                        <div class="col-sm-8">
                                                               <div class="input-group">

                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on"
                                                                             name="src_schedulegroup_desc" id="src_schedulegroup_desc" type="Text" value="<?php echo $src_schedulegroup_desc; ?>"
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="col-md-12">
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     <h4 class="card-title mb-0">Scheduling Group Setting </h4>
                            ...
                            <table>
                                   ...
                                   <td>
                                          <form action="../rfid=repository/cli_Template_Download/st/StFunctionDownload.php" method="GET">
                                                 <input type="hidden" name="filedata" value="StDownloadGTTGRShiftScheduleData.php">
                                                 <input type="hidden" name="filename" value="ShiftSchedule">
                                                 <input type="hidden" name="src_schedulegroup_code" value="<?php echo $src_schedulegroup_code; ?>">
                                                 <input type="hidden" name="src_schedulegroup_desc" value="<?php echo $src_schedulegroup_desc; ?>">
              ...
              <div class="card-body table-responsive p-0"
                     ...
                     <table id="datatable" width="59%" border="1" align="left"
       ...
       <div class="modal-dialog modal-belakang modal-bs" role="document">
              <div class="modal-content">
                     <div class="modal-header">
                            <h4 class="modal-title">Add Scheduling Group Setting</h4>
                            <a type="button" class="close" onclick='return stopload()' data-dismiss="modal" aria-label="Close" style="margin-top: -15px;">
                                   <span aria-hidden="true"><img src="../../asset/dist/img/icons/icon_del.png"></span>
                            </a>
                     </div>
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataCreate.php" method="POST"
                            ...
                            <fieldset id="fset_1">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_schedulegroup_code" name="inp_schedulegroup_code"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="inp_schedulegroup_desc" name="inp_schedulegroup_desc"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          <div class="col-4 name">Order No <span class="required">*</span></div>
                                          <div class="col-sm-8">
                                                 <div class="input-group">

                                                        <select id="inp_order_id" class="input--style-6" name="inp_order_id" onfocus="hlentry(this)" onchange="formodified(this);" style="width:undefined;height: 33px;width: 45%;">
                                   ...
                                   <div class="form-row" style="display:none">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_schedulegroup_code" name="sel_schedulegroup_code"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_schedulegroup_desc" name="sel_schedulegroup_desc"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <select id="sel_order_id" class="input--style-6" name="sel_order_id" onfocus="hlentry(this)" onchange="formodified(this);" style="width:undefined;height: 33px;width: 45%;">
                                                               <option value="1">1</option>
                                                               <option value="2">2</option>
                                                               <option value="3">3</option>
                                                        </select>
		  ...
		  <table width="100%">
                     ...
                     <div class="form-group">
                            <div class="col-sm-12">	
                                          ...
                                          <input type="hidden" class="form-control input-report" id="sel_schedulegroup_codeS" name="sel_schedulegroup_code" placeholder="">
                            </div>
                     </div>
...
$(document).ready(function() {
       $("#CreateButton").on('click', function() {
              ...
              $("#FormDisplayCreate").unbind('submit').bind('submit', function() {
                     ...
                     var inp_schedulegroup_code = $("#inp_schedulegroup_code").val();
                     var inp_schedulegroup_desc = $("#inp_schedulegroup_desc").val();
                     var inp_order_id = $("#inp_order_id").val();
                  

                     var regex=/^[a-zA-Z]+$/;
                  
                     if (inp_schedulegroup_code == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Schedulegroup code cannot empty";

                     } else if (inp_schedulegroup_desc == "") {
                            modals.style.display ="block";
                            document.getElementById("msg").innerHTML = "Schedulegroup desc cannot empty";

                     } else if (inp_order_id.match(regex)) {
                            modals.style.display ="block";
                     ...
                     if (inp_schedulegroup_code && inp_schedulegroup_desc && inp_order_id) {
...
function editMember(id = null) {
       if (id) {
              ...
              $.ajax({
                     ...
                     success: function(response) {
                            document.getElementById("sel_identity").innerHTML = response.schedulegroup_code;
                            
                        
                            $("#sel_schedulegroup_code").val(response.schedulegroup_code);
                            $("#sel_schedulegroup_desc").val(response.schedulegroup_desc);
                            $("#sel_order_id") .val(response.order_id);     
                            ...
                            $("#FormDisplayUpdate").unbind('submit').bind('submit', function() {
                                   ...
                                   var sel_schedulegroup_code  = $("#sel_schedulegroup_code").val();
                                   var sel_schedulegroup_desc  = $("#sel_schedulegroup_desc").val();
                                   var sel_order_id            = $("#sel_order_id").val();
         
                                   var regex=/^[a-zA-Z]+$/;

                                   if (sel_schedulegroup_code == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Schedulegroup code cannot empty";

                                   } else if (sel_schedulegroup_desc == "") {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Schedulegroup desc cannot empty";

                                   } else if (sel_order_id.match(regex)) {
                                          modals.style.display ="block";
                                          document.getElementById("msg").innerHTML = "Please enter valid number";
                                   ...
                                   if (sel_schedulegroup_code && sel_schedulegroup_desc && sel_order_id) {
	...
	if(id) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#sel_schedulegroup_codeS").val(response.schedulegroup_code);
				...
				$("#updatedelMemberForm").unbind('submit').bind('submit', function() {
					...
					var sel_schedulegroup_code = $("#sel_schedulegroup_codeS").val();
