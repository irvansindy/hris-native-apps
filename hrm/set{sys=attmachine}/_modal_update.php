       ...
       <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <input class="hidden"
                                   type="hidden"
                                   id="var_machine_code"
                                   name="var_machine_code"
                                   value="<?php echo $row['machine_code']; ?>">
                            <!-- ============================================================== -->
                            <!-- ============================================================== -->
                            <!-- blind  -->
                            <!-- ============================================================== -->
                            ...
                            <script>
                            $(function () {
                            $('#Upload0').<?php echo $Upload1; ?>();
                            $('#Upload1').<?php echo $Upload1; ?>();

                            $('#Query0').<?php echo $Query1; ?>();
                            $('#Query1').<?php echo $Query1; ?>();
                                   ...
                                   <div class="col-sm-5">
                                          <div class="input-group">
                                                 <select class="input--style-6" 
                                                        ...
                                                        id="inp_fileext"
                                                        style="width: 50%;height: 30px;" >
                                                        <option value="<?php echo $row['fileext']; ?>"><?php echo $row['fileext']; ?></option>
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                        <div class="form-check form-check-inline" style="margin-top: 15px;">
                                                               <input class="form-check-input" type="checkbox" <?php echo $checked; ?> id="inp_inoutflag" name="inp_inoutflag" value="Y">
                            ...
                            <div class="form-row" id="dvPassport" style="<?php echo $display; ?>">
                                   ...
                                   <div class="col-sm-5">
                                          <div class="input-group">
                                                 <select class="input--style-6" 
                                                        ...
                                                        id="inp_datasource"
                                                        style="width: 50%;height: 30px;" >
                                                        <option value="<?php echo $row['datasource']; ?>"><?php echo $row['datasource']; ?></option>
                                   ...
                                   <div class="col-sm-8">
                                          <div class="input-group">
                                                 <select class="input--style-6" 
                                                        ...
                                                        id="inp_attend_code"
                                                        style="width: 50%;height: 30px;" >
                                                               <option value="<?php echo $row['attend_code']; ?>"><?php echo $row['attend_code']; ?></option>
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                 <select class="input--style-6" 
                                                        ...
                                                        id="inp_datemask"
                                                        style="width: 50%;height: 30px;" >
                                                        <option value="<?php echo $row['datemask']; ?>"><?php echo $row['datemask']; ?></option>
                            ...
                            <div class="card-body table-responsive p-0"
                                                 style="width: 100vw; width: 100.0%; margin: 5px;overflow: scroll;">
                                                        ...
                                                        <?php 
                                                               $row_from	=mysqli_query($connect, "SELECT a.* FROM `HRDATTMACHINE` a WHERE a.machine_code = '$get_var'");
                                                               while($rf=mysqli_fetch_array($row_from)){                                                               
                                                        ?>

                                                        <tr>
                                                               <td>
                                                               <select class="form-control" name="data_mac1[]">
                                                                      <option value="<?php echo $rf['field_type']; ?>"><?php echo $rf['field_type']; ?></option>
                                                               ...
                                                               <td><input type="text" value="<?php echo $rf['column_name']; ?>" name="data_mac2[]" class="form-control"></td>
                                                               <td><input type="text" value="<?php echo $rf['column_desc']; ?>" name="data_mac3[]" class="form-control"></td>
                                                               <td><input type="text" value="<?php echo $rf['length']; ?>" name="data_mac4[]" class="form-control"></td>
                                   ...
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button class="btn btn-danger"
                                                        ...
                                                        name="submit_delete_setting_attendancemachine" 
                                                        id="submit_delete_setting_attendancemachine">
                                                        Delete
                                                 </button>

                                                 <button class="btn btn-warning"
                                                        type="submit" 
                                                        name="submit_update_setting_attendancemachine" 
                                                        id="submit_update_setting_attendancemachine">
                                                        Submit
                                                 </button>

                                                 <button class="btn btn-warning" 
                                                        type="button" 
                                                        name="submit_update_setting_attendancemachine2"
                                                        id="submit_update_setting_attendancemachine2" 
                                                        style='display:none;' 
                                                        disabled>
...
<?php } ?>
              ...
              function myFunctionCancel() {
                     var txt;
                     var r = confirm("Are You Sure You Delete this Machine?");
                     if (r == true) {
...
<script>
              function HrmsValidationForm() {
                     var var_machine_code = document.getElementById("var_machine_code").value;
