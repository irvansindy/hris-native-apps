...
<?php 
$page   = '30'; //menu id SELECT * FROM hrmmenu WHERE menu_id = '2'
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    ...
                    <ol class="breadcrumb mb-0 p-0 bg-transparent">
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;Attendance Machine</li>
                    </ol>
                </div>
...
<?php 
include "../../controller/setting/con_setting_attendancemachine.php";
