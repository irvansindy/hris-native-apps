              ...
              <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <input class="hidden"
                                   type="hidden"
                                   id="var_attend_code"
                                   name="var_attend_code"
                                   value="<?php echo $row['attend_code']; ?>">
                            <!-- ============================================================== -->
                            <!-- ============================================================== -->
                            <!-- blind  -->
                            <!-- ============================================================== -->
                            ...
                            <div class="form-row">
                                   ...
                                   <div class="col-sm-8 name"> <?php echo $row['attend_code']; ?></div>
                            </div>
                                   ...
                                   <div class="col-sm-7">
                                          <div class="input-group">
                                                 <textarea class="input--style-6"
                                                        ...
                                                        title="attend_name_en"><?php echo $row['attend_name_en']; ?></textarea>
                                          </div>
                                   </div>
                                   ...
                                   <div class="col-sm-7">
                                          <div class="input-group">
                                                 <textarea class="input--style-6"
                                                        ...
                                                        title="attend_name_id"><?php echo $row['attend_name_id']; ?></textarea>
                                          </div>
                                   </div>
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                        <div class="form-check form-check-inline" style="margin-top: 15px;">
                                                               <?php
                                                               $condition = $row['present_flag'];
                                                               if($condition == 'N'){
                                                                      $declare_con = '';
                                                               } else  if($condition == 'Y'){
                                                                      $declare_con = 'checked=checked';
                                                               }
                                                               ?>
                                                               <input class="form-check-input" type="checkbox" id="inp_present_flag" name="inp_present_flag" value="Y" <?php echo $declare_con;?>>
                                   ...
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button class="btn btn-danger"
                                                        ...
                                                        name="submit_delete_setting_attendancestatus" 
                                                        id="submit_delete_setting_attendancestatus">
                                                        Delete
                                                 </button>

                                                 <button class="btn btn-warning"
                                                        type="submit" 
                                                        name="submit_update_setting_attendancestatus" 
                                                        id="submit_update_setting_attendancestatus">
                                                        Submit
                                                 </button>
...
<?php } ?>
              ...
              function myFunctionCancel() {
                     var txt;
                     var r = confirm("Are You Sure You Delete this Status?");
                     if (r == true) {
              ...
              function HrmsValidationForm() {
                     var var_attend_code = document.getElementById("var_attend_code").value;
                     ...
                     if (!inp_attend_name_id.trim().length) {
