...
$src_attend_name_id              = '';
       ...
       if (!empty($_POST['src_attend_code']) && !empty($_POST['src_attend_name_id'])) {
              ...
              $frameworks        = ",
                                          src_attend_code :"."'".$src_attend_code."',
                                          src_attend_name_id :"."'".$src_attend_name_id."'
                                   ";
       //JIKA TERISI HANYA SHIFT
       } else if (!empty($_POST['src_attend_code']) && empty($_POST['src_attend_name_id'])) {
              $src_attend_code     = $_POST['src_attend_code'];
              $src_attend_name_id       = $_POST['src_attend_name_id'];
              $frameworks        = ",
                                          src_attend_code :"."'".$src_attend_code."',
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Attendance Status</h4>
                                        ...
                                        <td>
                                          <form action="../rfid=repository/cli_Template_Download/st/StFunctionDownload.php?filedata=StDownloadGTTGRAttStatusData.php&filename=Attendance Status" method="POST">
                                                 <input type="hidden" name="src_attend_code" value="<?php echo $src_attend_code; ?>">
                                                 <input type="hidden" name="src_attend_name_id" value="<?php echo $src_attend_name_id; ?>">
                                        ...
                                        <table id="example3LOAD" width="99%" border="1"
                                                ...
                                                <thead>
                                                        <tr>
                                                                ...
                                                                <th class="fontCustom" style="z-index: 1;width: 30%;"></th>
                                                        </tr>
...
$(document).ready(function() {
       $(".open_modal_add").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "_modal_create.php?modal_header=Add Attendance Status&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
