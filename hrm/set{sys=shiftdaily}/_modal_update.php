...
<?php
       $get_var = $_POST['id']; //Mengambil data req no dari tabel

       $datareq = mysqli_query($connect,"SELECT a.*,b.*,
                                                 a.shiftdailycode as use_shiftdailycode,
                                                 TIME_FORMAT(a.starttime, '%H:%i') as re_starttime,
                                                 TIME_FORMAT(a.endtime, '%H:%i') as re_endtime,
                                                 TIME_FORMAT(b.break_starttime, '%H:%i') as re_break_starttime,
                                                 TIME_FORMAT(b.break_endtime, '%H:%i') as re_break_endtime,
                                                 TIME_FORMAT(a.automaticovt_start, '%H:%i') as re_automaticovt_start,
                                                 TIME_FORMAT(a.automaticovt_end, '%H:%i') as re_automaticovt_end,
                                                 TIME_FORMAT(a.ovt_beforeend, '%H:%i') as re_ovt_beforeend,
                                                 TIME_FORMAT(a.ovt_afterstart, '%H:%i') as re_ovt_afterstart,
                                                 TIME_FORMAT(b.ovt_breakstart, '%H:%i') as re_ovt_breakstart,
                                                 TIME_FORMAT(a.btsovt_1, '%H:%i') as re_btsovt_1,
                                                 TIME_FORMAT(a.bteovt_1, '%H:%i') as re_bteovt_1
                                          ...
                                          WHERE a.shiftdailycode = '$get_var'
                                          LIMIT 1"); // Query untuk mengambil dari leave request
       
       while($row=mysqli_fetch_array($datareq)){
?>

<div class="modal-dialog modal-med">
       <div class="modal-content">
              <div class="modal-header">
                     <h4 class="modal-title"><?php echo $_GET['modal_header']. " [" . $get_var . "] "; ?></h4>
       ...
       <div class="card-body table-responsive p-0" style="width: 100vw;height: 60vh; width: 98.8%; margin: 5px;overflow: scroll;">
              ...
              <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <input class="hidden"
                                   type="hidden"
                                   id="var_shiftdailycode"
                                   name="var_shiftdailycode"
                                   value="<?php echo $row['use_shiftdailycode']; ?>">
                            <!-- ============================================================== -->
                            <!-- ============================================================== -->
                            <!-- blind  -->
                            <!-- ============================================================== -->
                            ...
                            <div class="form-row">
                                   ...
                                   <div class="col-sm-8 name"> <?php echo $row['use_shiftdailycode']; ?>
                                         
                                   </div>
                            </div>

                            <?php
                            $var_checkbox0 = $row['daytype'];
                            $var_checkbox1 = $row['flexibleshift'];
                            if($var_checkbox0 == 'WD'){
                                   if($var_checkbox1 == 'Y'){
                                          $var_display00 = 'hide';
                                          $var_display01 = 'hide';
                                          $var_display02 = 'hide';
                                          $var_checkbox00 = 'document.getElementById("inp_flexibleshift").checked = true;';
                                          $var_checkbox_dis00 = 'document.getElementById("inp_flexibleshift").disabled = false;';
                                   } else {
                                          $var_display00 = 'show';
                                          $var_display01 = 'show';
                                          $var_display02 = 'show';
                                          $var_checkbox00 = 'document.getElementById("inp_flexibleshift").checked = false;';
                                          $var_checkbox_dis00 = 'document.getElementById("inp_flexibleshift").disabled = false;';
                                   }
                            } else {
                                   $var_display00 = 'hide';
                                   ...
                                   $var_display02 = 'hide';
                                   $var_checkbox00 = 'document.getElementById("inp_flexibleshift").checked = true;';
                                   $var_checkbox_dis00 = 'document.getElementById("inp_flexibleshift").disabled = true;';
                            }
                            ?>

                            <script>
                            $(function () {
                            $('#WD0').<?php echo $var_display00; ?>();
                            $('#WD1').<?php echo $var_display01; ?>();
                            $('#WD2').<?php echo $var_display02; ?>();
                            <?php echo $var_checkbox00; ?>
                            <?php echo $var_checkbox_dis00; ?>
                                   ...
                                   <div class="col-sm-8">
                                          <div class="input-group">
                                                 <select class="input--style-6" 
                                                        ...
                                                        <?php 
                                                        $dataPrint = $row['daytype'];
                                                        ?>
                                                        <option value="<?php echo $row['daytype']; ?>"><?php echo $row['daytype']; ?></option>
                                                        <?php
                                                               $sql = mysqli_query($connect,"SELECT daytype FROM hrmttamshiftdaily where daytype <> '$dataPrint' GROUP BY daytype");
                                                               while($rows=mysqli_fetch_array($sql))
                                                               {
                                                               echo '<option value="'.$rows['daytype'].'">'.$rows['daytype'].'</option>';
                                                               } 
                                                               ?>
                                                 </select>
                                          </div>
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        id="inp_starttime"
                                                        name="inp_starttime"
                                                        value="<?php echo $row['re_starttime']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['graceforlate']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['productivehours']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-8">
                                          <div class="input-group">
                                                 <textarea class="input--style-6"
                                                        ...
                                                        placeholder="remark"
                                                        title="remark"><?php echo $row['remark']; ?></textarea>
                                          </div>
                                   </div>
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_break_starttime']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_break_endtime']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                     ...
                     <fieldset id="fset_1">
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                 <select class="input--style-6 " name="inp_overtimecode"
                                                        ...
                                                        <option value="<?php echo $row['overtimecode']; ?>"><?php echo $row['overtimecode']; ?></option>
                                                        <?php
                                                               $sql = mysqli_query($connect,"SELECT * FROM HRMTTAMOVERTIME");
                                                               while($rows=mysqli_fetch_array($sql))
                                                               {
                                                               echo '<option value="'.$rows['overtime_code'].'">'.$rows['overtime_code'].'</option>';
                                                               } 
                                                               ?>
                                                 </select>
                                          </div>
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                 <select class="input--style-6 " name="inp_overtimecode_ph"
                                                        ...
                                                        <option value="<?php echo $row['overtimecode_ph']; ?>"><?php echo $row['overtimecode_ph']; ?></option>
                                                        <?php
                                                               $sql = mysqli_query($connect,"SELECT * FROM HRMTTAMOVERTIME");
                                                               while($rows=mysqli_fetch_array($sql))
                                                               {
                            ...
                            <?php
                            $var_checkbox0 = $row['automaticovt_type'];
                            if($var_checkbox0 == 'SH'){
                                   $var_checkbox00SH = 'checked="checked"';
                                   $var_checkbox00RM = '';
                                   $var_display00SH = '';
                                   $var_display00RM = 'display:none';
                            } else {
                                   $var_checkbox00SH = '';
                                   $var_checkbox00RM = 'checked="checked"';
                                   $var_display00SH = 'display:none';
                                   $var_display00RM = '';
                            }
                            ?>
                            ...
                            <div class="form-row">
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group" style="margin-left: -15px;">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                               <div class="custom-control custom-radio">
                                                                      <input type="radio" name="inp_automaticovt_type" value="SH" <?php echo $var_checkbox00SH; ?> class="custom-control-input" id="customControlValidation2" name="radio-stacked">
                                                                      <label class="custom-control-label" for="customControlValidation2">Static Hour</label>
                                                               </div>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                               <div class="custom-control custom-radio">
                                                                      <input type="radio" name="inp_automaticovt_type" value="RM" <?php echo $var_checkbox00RM; ?> class="custom-control-input" id="customControlValidation3" name="radio-stacked">
                                          ...
                                          <div class="input-group" id="SH" style="<?php echo $var_display00SH; ?>">
                                                 <input class="input--style-6"
                                                        type="Text"
                                                        id="inp_automaticovt_start"
                                                        name="inp_automaticovt_start"
                                                        value="<?php echo $row['re_automaticovt_start']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="10" 
                                                        maxlength="5" 
                                                 ...
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_automaticovt_end']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="10" 
                                                        maxlength="5" 
                                          ...
                                          <div class="input-group" id="RM" style="<?php echo $var_display00RM; ?>">
                                                 <input class="input--style-6"
                                                        type="Text"
                                                        id="inp_autoovtminutes"
                                                        name="inp_autoovtminutes"
                                                        value="<?php echo $row['autoovtminutes']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="10" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_ovt_beforeend']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on" 
                                                        size="30" 
                                                        maxlength="5" 
                            ...
                            <?php
                            $var_checkbox0 = $row['breakovt_calculation'];
                            if($var_checkbox0 == 'Y'){
                                   $var_checkbox00 = 'checked="checked"';
                                   $var_display00 = 'checked="checked"';
                            } else {
                                   $var_checkbox00 = '';
                                   $var_display00 = 'display:none';
                            }
                            ?>
                            ...
                            <div class="form-row">
                                   ...
                                   <div class="col-sm-6">
                                          <div class="input-group">
                                                        <div class="form-check form-check-inline" style="margin-top: 15px;">
                                                               <input class="form-check-input" <?php echo $var_checkbox00; ?> type="checkbox" id="inp_breakovt_calculation" name="inp_breakovt_calculation" value="Y">
                            ...
                            <div class="form-row" id="dvPassport" style="<?php echo $var_display00; ?>">
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_ovt_breakstart']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on"
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="col-sm-2">
                                          <div class="input-group">
                                                 <input class="input--style-6"
                                                        ...
                                                        value="<?php echo $row['re_ovt_afterstart']; ?>"
                                                        autocomplete="off"
                                                        autofocus="on"
                                                        size="30" 
                                                        maxlength="5" 
                                   ...
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button class="btn btn-danger"
                                                        type="submit"
                                                        onclick="return myFunctionCancel()"
                                                        name="submit_delete_setting_shift_daily" 
                                                        id="submit_delete_setting_shift_daily">
                                                        Delete
                                                 </button>

                                                 <form method="post" id="myform" onsubmit="return myFunctionCancel()">
                                                                                           
                                                                                           <button type="submit" style="border: 0; background: transparent" name="submit_reject" value="submit"></button>
                                                                                    </form>


                                                 <button class="btn btn-warning"
                                                        type="submit" 
                                                        name="submit_update_setting_shift_daily" 
                                                        id="submit_update_setting_shift_daily">
                                                        Submit
                                                 </button>

                                                 <button class="btn btn-warning" 
                                                        type="button" 
                                                        name="submit_update_setting_shift_daily2"
                                                        id="submit_update_setting_shift_daily2" 
                                                        style='display:none;' 
                                                        disabled>
...
<?php } ?>
              ...
              function HrmsValidationForm() {
                     var var_shiftdailycode = document.getElementById("var_shiftdailycode").value;
                     ...
                     var inp_overtimecode_ph = document.getElementById("inp_overtimecode_ph").value;
                      ...
                      if (var_shiftdailycode == "") {
                            ...
                            if (inp_starttime == "") {
                                   ...
                                   $('#submit_update_setting_shift_daily').hide();
                                   $('#submit_update_setting_shift_daily2').show();
                            }
