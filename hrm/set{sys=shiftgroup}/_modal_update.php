...
<?php
       ...
       $datareq = mysqli_query($connect,"SELECT a.*
                                          FROM HRMTTAMSHIFTGROUP a
                                          WHERE a.shiftgroupcode = '$get_var'
              ...
              <div class="card-body table-responsive p-0"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8 name">
                                                 <div class="input-group"> <?php echo $row['shiftgroupcode']; ?>
                                                        <input class="hidden" type="hidden" id="inp_groupcode"
                                                               name="inp_groupcode" autocomplete="off"
                                                               autofocus="on" size="30" maxlength="50"
                                                               value="<?php echo $row['shiftgroupcode']; ?>"
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <input class="input--style-6" type="Text" id="inp_groupname"
                                                               name="inp_groupname" autocomplete="off"
                                                               autofocus="on" size="30" maxlength="50"
                                                               value="<?php echo $row['shiftgroupname']; ?>"
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <select id="inp_overtime_calculation"
                                                               ...
                                                               <option value="<?php echo $row['overtime_calculation']; ?>"><?php echo $row['overtime_calculation']; ?></option>
                                   ...
                                   <table class="table table-bordered" id="tbl_posts">
                                          ...
                                          <?php
                                                 $datareq_2 = mysqli_query($connect,"SELECT a.*,
                                                                                           CASE 
                                                                                                  WHEN a.premicheck = '1' THEN 'Yes'
                                                                                                  WHEN a.premicheck = '0' THEN 'No'
                                                                                           END AS pc
                                                                                    FROM HRMTTARSHIFTGROUPDAILY a
                                                                                    WHERE a.shiftgroupcode = '$get_var'"); // Query untuk mengambil dari leave request
                                                 while($row_2=mysqli_fetch_array($datareq_2)){
                                          ?>

                                          <tr id="rec-<?php echo $row_2['day_no']; ?>">
                                                        <td><span class="sn"><?php echo $row_2['day_no']; ?></span>.</td>
                                                        <td style="width: 100%;">
                                                               <SELECT name="sg0[]" autocomplete="off"
                                                                      id="sg0" class="form-control">
                                                                      <option value="<?php echo $row_2['shiftdailycode']; ?>"><?php echo $row_2['shiftdailycode']; ?></option>
                                                                      <?php $get_relation = mysqli_query($connect, "SELECT
                                                                             a.shiftdailycode,
                                                        ...
                                                        <td style="text-align: center;">
                                                               <SELECT name="sg1[]" autocomplete="off"
                                                                             ...
                                                                             <option value="<?php echo $row_2['premicheck']; ?>"><?php echo $row_2['pc']; ?></option>
                                                                             <option value="0">No</option>
                                                                             <option value="1">Yes</option>
                                                               </SELECT>
                                                        </td>
                                                        <td colspan="2" style="text-align: center;"><a
                                                                      class="btn btn-xs delete-record" data-id="<?php echo $row_2['day_no']; ?>">
                            ...
                            ?>
                                                        ...
                                                        <SELECT name="sg1[]" autocomplete="off"
                                                                      id="sg1" class="form-control">
                                                                      <option value="<?php echo $row_2['premicheck']; ?>"><?php echo $row_2['premicheck']; ?></option>
                                                                      <option value="0">No</option>
                                                                      <option value="1">Yes</option>
                                                        </SELECT>
                                                        </td>
                                   ...
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button class="btn btn-danger" onclick="return myFunctionCancel()" name="submit_delete_setting_shift_group" id="submit_delete_setting_shift_daily">
                                                        Delete
                                                 </button>
                                                 ...
                                                 <button class="btn btn-warning" type="submit"
                                                        name="submit_update_setting_shift_group"
                                                        id="submit_update_setting_shift_group">
                                                        Submit
                                                 </button></form>
                     ...
                     function HrmsValidationForm() {
                            ...
                            if (inp_groupcode == "") {
                                   ...
                                   $('#submit_update_setting_shift_group').hide();
                                   $('#submit_add2').show();
                            }
                     }
                     </script>
