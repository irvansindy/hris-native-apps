...
$src_shiftgroupname            = '';
       ...
       if (!empty($_POST['src_shiftgroupcode']) && !empty($_POST['src_shiftgroupname'])) {
              ...
              $frameworks          = ",
                                          src_shiftgroupcode :"."'".$src_shiftgroupcode."',
                                          src_shiftgroupname :"."'".$src_shiftgroupname."'
                                   ";
       //JIKA TERISI HANYA GROUP
       } else if (!empty($_POST['src_shiftgroupcode']) && empty($_POST['src_shiftgroupname'])) {
              $src_shiftgroupcode  = $_POST['src_shiftgroupcode'];
              $src_shiftgroupname  = $_POST['src_shiftgroupname'];
              $frameworks          = ",
                                          src_shiftgroupcode :"."'".$src_shiftgroupcode."',
...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h4 class="card-title mb-0">Shift Group Setting</h4>
                                        ...
                                        <td>
                                        <form action="../rfid=repository/cli_Template_Download/st/StFunctionDownload.php?filedata=StDownloadGTTGRShiftGroupData.php&filename=Group Data" method="POST">
                                                 <input type="hidden" name="src_shiftgroupcode" value="<?php echo $src_shiftgroupcode; ?>">
                                                 <input type="hidden" name="src_shiftgroupname" value="<?php echo $src_shiftgroupname; ?>">
...
<?php 
include "../../controller/setting/con_setting_shiftgroup.php";
?>
...
$(document).ready(function() {
       $(".open_modal_add").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "_modal_create.php?modal_header=Add Shift Group&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
