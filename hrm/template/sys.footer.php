...
<div id="mymodals_withhref_passed" class="modals" style="display: none;z-index: 9999;">
	<div class="modals-content">
		<p>
			<table width="100%">
				<tr>
					<td align="center"><img src="../../asset/dist/img/passed.png"
				...
				<tr>
					<td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
						...
						<button type='submit' style="padding: 1px;" type='button'
							class="btn digital btn-warning button_bot closeds_withhref_passed">
							Close
						</button>
					</td>
				</tr>
...
<div id="mymodals_withhref_failed" class="modals" style="display: none;z-index: 9999;">
	<div class="modals-content">
		<p>
			<table width="100%">
				<tr>
					<td align="center"><img src="../../asset/dist/img/failed.png"
							style="max-width: 90%;margin-top: 20px;"></td>
				</tr>
				<tr>
					<td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
						...
						<button type='submit' style="padding: 1px;" type='button'
							class="btn digital btn-warning button_bot closeds_withhref_failed">
							Close
						</button>
					</td>
				</tr>
			...
			<table width="100%">
				...
				<tr>
					<td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
						...
						<button type='submit' style="padding: 1px;" type='button'
							class="btn digital btn-warning button_bot closeds_withhref">
							Close
						</button>
					</td>
				</tr>
			...
			<table width="100%">
				...
				<tr>
					<td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
						...
						<button type='submit' style="padding: 1px;" type='button'
							class="btn digital btn-warning button_bot closeds">
							Close
						</button>
					</td>
				</tr>
			...
			<table width="100%">
				...
				<tr>
					<td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
						...
						<button class="btn digital btn-warning" style="width: 50%;" onclick="myFunctionForClose()"
