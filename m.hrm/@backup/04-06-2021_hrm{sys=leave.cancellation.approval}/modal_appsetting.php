                            ...
                            <tr>
                                   ...
                                   <td colspan="4" align="right" width="100%">
                                          <div class="modal-footer">
                                                 ...
                                                 // JIKA WORKFLOW LEVEL HANYA DI SEQUENCE
                                                 } else if($var_check_sequence > 0 && $var_check_required < 1) {
                                                        ...
                                                        } else if($var_check_sequence < 1 && $var_check_required > 0) {
                                                               ...
                                                               // HANYA TERDAPAT REQUEST REQUIRED
                                                                      $check_approve3=mysqli_query($connect, "SELECT
                                                                      c.emp_no
                                                                      FROM hrmrequestapproval a
                                                                      LEFT JOIN hrmorgstruc b on a.approval_list=b.pos_code
