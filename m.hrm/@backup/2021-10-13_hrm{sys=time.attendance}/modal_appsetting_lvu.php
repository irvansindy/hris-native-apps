       ...
       <div class="modal-content">
              ...
              <div class="modal-body">
                     ...
                     <table cellpadding="1" cellspacing="1" style="width:100%">
                            ...
                            ?>
                            <?php
                            $remark_approve1     =      mysqli_query($connect, "SELECT 
                                                                      c.emp_no,
                                                                      a.revised_remark
                                                                      FROM hrmrequestapproval a
                                                                      LEFT JOIN hrmorgstruc b on a.approval_list=b.pos_code
                                                                      ...
                                                                      a.request_no='$id' and
                                                                      a.req = 'Notification' and
                                                                      (a.revised_remark IS NOT NULL or a.revised_remark <> '')
                                                                      GROUP BY a.position_id
                                                                      ");
                            $var_remark_approve1 = mysqli_fetch_array($remark_approve1);
                           
                                   echo '<tr>
                                                 <td>     
                                                 </td>
                                                 <td colspan="3" style="font-weight: bold; color:#e30909;font-size: x-small; vertical-align: top;font-size: smaller;font-family: verdana;font-style: oblique;">
                                                        '.$var_remark_approve1['revised_remark'].'
                                                 </td>
                                          </tr>';
                            ...
                            <?php
                            $remark_approve2     =      mysqli_query($connect, "SELECT 
                                                                      c.emp_no,
                                                                      a.revised_remark
                                                                      FROM hrmrequestapproval a
                                                                      LEFT JOIN hrmorgstruc b on a.approval_list=b.pos_code
                                                                      ...
                                                                      GROUP BY a.position_id
                                                                      ");
                            $var_remark_approve2 = mysqli_fetch_array($remark_approve2);
                           
                                   echo '<tr>
                                                 <td>     
                                                 </td>
                                                 <td colspan="3" style="font-weight: bold; color:#e30909;font-size: x-small; vertical-align: top;font-size: smaller;font-family: verdana;font-style: oblique;">
                                                        '.$var_remark_approve2['revised_remark'].'
                                                 </td>
                                          </tr>';
                            ...
                            <?php
                            $remark_approve3     =      mysqli_query($connect, "SELECT 
                                                                      c.emp_no,
                                                                      a.revised_remark
                                                                      FROM hrmrequestapproval a
                                                                      LEFT JOIN hrmorgstruc b on a.approval_list=b.pos_code
                                                                      ...
                                                                      GROUP BY a.position_id
                                                                      ");
                            $var_remark_approve3 = mysqli_fetch_array($remark_approve3);
                           
                                   echo '<tr>
                                                 <td>     
                                                 </td>
                                                 <td colspan="3" style="font-weight: bold; color:#e30909;font-size: x-small; vertical-align: top;font-size: smaller;font-family: verdana;font-style: oblique;">
                                                        '.$var_remark_approve3['revised_remark'].'
                                                 </td>
                                          </tr>';
