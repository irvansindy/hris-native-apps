...
<?php
	...
	while($r=mysqli_fetch_array($modal)){
       ...
       $isurgent_req = mysqli_fetch_array(mysqli_query($connect, "SELECT urgent_request FROM hrmleaverequest WHERE request_no = '$id'"));
       $isurgent_req_print = $isurgent_req['urgent_request'];

       $isany_attachment = mysqli_fetch_array(mysqli_query($connect, "SELECT count(*) as total FROM hrmattachment WHERE request_no = '$id'"));
       $isany_attachment_print = $isany_attachment['total'];
?>
                                          ...
                                          <div class="modal-footer">
                                                 ...
                                                 if($var_check_notification > 0 && $var_check_sequence > 0 && $var_check_required > 0) {
                                                               ...
                                                               if($check_approver1 < 1) {
                                                                      ...
                                                                      if($check_var_approver_not > 0){
                                                                             //CEK APAKAH URGENT DAN SUDAH ADA ATTACHMENT
                                                                             if($isurgent_req_print == 'Y' && $isany_attachment_print == '0') {
                                                                                    echo '<div class="badge badge-Rejected" style="width: 100%;font-size: 12px;">File attachment doesn`t exist, Urgent request need file attachment</div>';
                                                                             } else {
                                                                                    echo '
                                                 ...
                                                 // 2.SEQUENCE,
                                                        ...
                                                        if($check_approver1 < 1) {
                                                               ...
                                                               if($check_var_approver_not > 0){
                                                                      //CEK APAKAH URGENT DAN SUDAH ADA ATTACHMEN
                                                                      if($isurgent_req_print == 'Y' && $isany_attachment_print == '0') {
                                                                             echo '<div class="badge badge-Rejected" style="width: 100%;font-size: 12px;">File attachment doesn`t exist, Urgent request need file attachment</div>';
                                                                      } else {
                                                                             echo '
                                                 ...
                                                 // 3.REQUIRED,
                                                        ...
                                                        } else if($var_check_notification < 1 && $var_check_sequence > 0 && $var_check_required > 0) {
  ...
  document.getElementById("demo").innerHTML = txt;
                     ...
                     <form name='form1' id="form1" method="post" onsubmit='return validasi()'>
                            ...
                            <td colspan="3" class="" id="tdb_1"><textarea class="form-control"
                                          ...
                                          type="Text" value="" onfocus="hlentry(this)" size="20" maxlength="500" 
