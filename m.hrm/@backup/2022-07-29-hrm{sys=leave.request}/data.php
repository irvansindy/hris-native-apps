                                                        ...
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             autocomplete="off" autofocus="on" id="src_leave_request"
                                                                             name="src_leave_request" id="src_leave_request" type="Text" value="<?php echo $src_leave_request; ?>"
                                                        ...
                                                        <div class="col-sm-8">
                                                               <div class="input-group">
                                                                      ...
                                                                      <input class="input--style-6"
                                                                             ...
                                                                             name="src_leave_request_cancel" id="src_leave_request_cancel" type="Text" value="<?php echo $src_leave_request_cancel; ?>"
                                                                             onfocus="hlentry(this)" size="30" maxlength="50" 
                                                                             validate="NotNull:Invalid Form Entry"
                                                                             onchange="formodified(this);" title="">
                                                               </div>
...
<div class="modal  fade fade-custom" tabindex="-1" role="dialog" id="CreateForm">
       <div class="modal-dialog modal-belakang modal-bg" role="document">
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataCreate.php?emp_id=<?php echo $username; ?>" method="POST"
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="col-sm-2 name">Employee No.  <font color="red">*</font></div>
                                   <div class="col-sm-8">
                                          <div class="input-group">
                                                 ...
                                                 <input class="input--style-6 search-input"
                                                        ...
                                                        name="modal_emp" type="Text" value=" <?php echo $username; ?> [ <?php echo $emp['full_name']; ?> ] <?php echo $emp['pos_name_en']; ?>"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-3">
                                                 <div class="input-group">
                                                        ...
                                                        <select class="input--style-6"
                                                               style='display:none;height: 30px;width:150px'
                                                               id="inp_hdtype_starttime_formmodified" name="inp_hdtype_starttime_formmodified"
                                                               onfocus="hlentry(this)" onchange="formodified(this);">
                                                               <option value="3" style="display: none;">Full Day</option>
                                                               <option value="3">Full Day</option>
                                                               <option value="2">Second Half</option>
                                                        ...
                                                        <input class="input--style-6"
                                                               ...
                                                               id="inp_pdtype_starttime" name="inp_pdtype_starttime" placeholder="HH:ii"
                                                               value="00:00"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-3">
                                                 <div class="input-group">
                                                        ...
                                                        <input id="inp_hdtype_endtime_formmodified" name="inp_hdtype_endtime_formmodified" type="hidden" value="noselect"><!--FROM SESSION -->

                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <input class="input--style-6"
                                                               style="display:none; margin-bottom: 2px; width: 90px;"
                                                               id="inp_pdtype_endtime" name="inp_pdtype_endtime" placeholder="HH:ii"
                                                               value="00:00"
                                                               pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        ...
                                                        <div class="vc-toggle-container">
                                                               <label class="vc-switch">
                                                                      <input type="checkbox" checked="checked"
                                                                             name="inp_urgent" id="inp_urgent_off" value='1'
                                                                             class="vc-switch-input"
                                                                             onchange="isi_otomatis_leave()"/>
                            ...
                            <!-- ==================================================================================================== -->
                                   ...
                                   <input id="inp_requestfor" name="inp_requestfor" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_leaverequestv" name="inp_leaverequestv" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_daytype" name="inp_daytype" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_summaryleavebalance" name="inp_summaryleavebalance" type="hidden"><!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
...
<div class="modal  fade fade-custom" tabindex="-1" role="dialog" id="RevisedForm">
       <div class="modal-dialog modal-belakang modal-bg" role="document">
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataRevised.php?emp_id=<?php echo $username; ?>" method="POST"
                            id="FormDisplayRevised">
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="col-sm-8">
                                          <div class="input-group">
                                                 ...
                                                 <select class="input--style-6 modal_leave_revised" name="modal_leave_revised"
                                                        style="width: 50%;height: 30px;" id="modal_leave_revised"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-4" style="padding-bottom:5px">
                                                 <div class="input-group">
                                                        ...
                                                        <input type="text" id="modal_revised_leave_start" class="input--style-6"
                                                               onchange="isi_otomatis_leave_revised()"
                                                               name="modal_revised_leave_start" style="
                                                                             background-image:url(../../asset/dist/img/icons/calendar_icon.gif);  
                                                                             background-size: 17px;
                                                                             background-position:right;   
                                                                             background-repeat:no-repeat; 
                                          ...
                                          <div class="col-sm-3">
                                                 <div class="input-group">
                                                        ...
                                                        <select class="input--style-6"
                                                               style='display:none;height: 30px;width:150px'
                                                               id="inp_revised_hdtype_starttime_formmodified" name="inp_revised_hdtype_starttime_formmodified"
                                                               onfocus="hlentry(this)" onchange="formodified(this);">
                                                               <option value="3" style="display: none;">Full Day</option>
                                                               <option value="3">Full Day</option>
                                                               <option value="2">Second Half</option>
                                                        ...
                                                        <input class="input--style-6"
                                                               style="display:none; margin-bottom: 2px; width: 90px;"
                                                               id="inp_revised_pdtype_starttime" name="inp_revised_pdtype_starttime" placeholder="HH:ii"
                                                               value="00:00"
                                                               pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                   ...
                                   <div class="form-row">
                                                 ...
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" maxlength="10" type="text" 
                                                                      ...
                                                                      style="
                                                                             ...
                                                                             background-repeat:no-repeat; 
                                                                             padding-right:10px;  
                                                                             " id="modal_revised_leave_end" name="modal_revised_leave_end"
                                                                             autocomplete="off"/>
                                                 </div>
                                          </div>
                                          ...
                                          <div class="col-sm-3">
                                                 <div class="input-group">
                                                        ...
                                                        <input id="inp_revised_hdtype_endtime_formmodified" name="inp_revised_hdtype_endtime_formmodified" type="hidden" value="noselect"><!--FROM SESSION -->

                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <input class="input--style-6"
                                                               style="display:none; margin-bottom: 2px; width: 90px;"
                                                               id="inp_revised_pdtype_endtime" name="inp_revised_pdtype_endtime" placeholder="HH:ii"
                                                               value="00:00"
                                                               pattern="([0-1]{1}[0-9]{1}|20|21|22|23):[0-5]{1}[0-9]{1}">
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                                        <!-- UNTUK TIPE PART OF DAY / JAM JAMAN -->
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        <textarea class="textarea--style-6" id="inp_revised_remark" name="inp_revised_remark"
                                                               placeholder="Remark of Leave"></textarea>
                                                 </div>
                                          </div>
                                   </div>
                                          ...
                                          <div class="col-sm-8">
                                                        ...
                                                        <div class="vc-toggle-container">
                                                               <label class="vc-switch">
                                                                      <input type="checkbox" name="inp_revised_urgents"
                                                                             id="inp_revised_urgent_on" value='1'
                                                                             class="vc-switch-input"
                                                                             onchange="isi_otomatis_leave_revised()"/>
                                                                      <input type="hidden" checked="checked"
                                                 ...
                                                 <div class="input-group" id="tr_inp_revised_urgent_off" style='display:none;'>
                                                        <div class="vc-toggle-container">
                                                               <label class="vc-switch">
                                                                      <input type="checkbox" checked="checked"
                                                                             name="inp_revised_urgent" id="inp_revised_urgent_off" value='1'
                                                                             class="vc-switch-input"
                                                                             onchange="isi_otomatis_leave_revised()"/>
                            ...
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
                                   <input id="inp_revised_emp_no" name="inp_revised_emp_no" type="hidden" value="<?php echo $username; ?>"><!--FROM SESSION -->
                                   <input id="inp_revised_request_no" name="inp_revised_request_no" type="hidden"><!--FROM SESSION -->
                                   <input id="inp_revised_token" name="inp_revised_token" type="hidden" value="<?php echo $get_token; ?>"><!--FROM CONFIGURATION -->
                                   <input id="inp_revised_requestfor" name="inp_revised_requestfor" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_revised_leaverequestv" name="inp_revised_leaverequestv" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_revised_daytype" name="inp_revised_daytype" type="hidden"><!--FROM CONFIGURATION -->
                                   <input id="inp_revised_summaryleavebalance" name="inp_revised_summaryleavebalance" type="hidden"><!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
              ...
              <div class="modal-content">
                     ...
                     <form id="form-data">
                            ...
                            <fieldset id="fset_1">
                                   ...
                                   <div class="form-row">
                                   <div class="col-sm-2 name">File Attachment  <font color="red">*</font></div>
                            ...
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
                                   <input id="inp_Attachment_request_no" name="inp_Attachment_request_no" type="hidden"><!--FROM SESSION -->
                                   <input id="inp_Attachment_token" name="inp_Attachment_token" type="hidden" value="<?php echo $get_token; ?>"><!--FROM CONFIGURATION -->
                                   <input id="inp_Attachment_emp_no" name="inp_Attachment_emp_no" type="hidden" value="<?php echo $username; ?>"><!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
...
<div class="modal fade fade-custom" tabindex="-1" role="dialog" id="FormDisplayLeaveApproval">
              ...
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataUpdate.php?emp_id=<?php echo $username; ?>" method="POST" id="updatedelMemberForm">
       ...
       if(id) {
              $.ajax({
                     ...
                     success:function(response) {
                            ...
                            alert(response.hd_start);
                            
                            $("#box_approval_request_detail").load("pages_relation/_pages_approval.php?emp_id=<?php echo $username; ?>&rfid=" + response.request_no, 
                            ...
                            $("#box_leavebalances_revised").load("pages_relation/_pages_leavebalances.php?emp_id=<?php echo $username; ?>&rfid=" + response.emp_no + "&sfid=" + response.leave_code, 
              ...
              $.ajax({
                     ...
                     success:function(response) {
                            ...
                            if (nama_file!="" && fileupload!="") {
                                   ...
                                   $.ajax({
                                   type: 'POST',
                                   url: "php_action/FuncDataUpload.php?emp_id=<?php echo $username; ?>",
                                   data: formData,
                                   cache: false,
                                   processData: false,
                                   contentType: false,
                                   ...
                                   success: function (msg) {
                                          ...
                                          $("#box_attachment").load("pages_relation/_pages_attachment.php?emp_id=<?php echo $username; ?>&rfid=" + response.request_no, 
                                                 function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up){
                                                        if(statusTxt_spv_up == "success"){
                                                               $("#inp_attachment_files").show();
                                                               $("#box_attachment").show();
...
if(id) {
       ...
       // AJAX Request
       $.ajax({
              url: 'php_action/FuncDataDelete?emp_id=<?php echo $username; ?>&id=' + deleteid,
              type: 'GET',
              processData: false,
              contentType: false,
              dataType: 'json',
...
<script type="text/javascript">
              function isi_otomatis_leave(){
                     ...
                     $.ajax({
                            url: 'php_action/getLeaveBalance.php?emp_id=<?php echo $username; ?>',
                            type: 'get',
                            ...
                            success:function(response) {
                                   ...
                                   $("#box_leavebalances").load("pages_relation/_pages_leavebalances.php?emp_id=<?php echo $username; ?>&rfid=" + modal_emps + "&sfid=" + modal_leave, 
                                          function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up){
                                                 if(statusTxt_spv_up == "success"){
              ...
              function isi_otomatis_leave_revised(){
                     ...
                     $.ajax({
                            ...
                            success:function(response) {
                                   ...
                                   $("#box_leavebalances_revised").load("pages_relation/_pages_leavebalances.php?emp_id=<?php echo $username; ?>&rfid=" + modal_emps + "&sfid=" + modal_leave, 
                                          function(responseTxt_spv_up, statusTxt_spv_up, jqXHR_spv_up){
                                                 if(statusTxt_spv_up == "success"){
                                                        $("#inp_revised_leavebalances_amount").show();
                                                        $("#box_leavebalances_revised").show();
