...
<?php
	...
	$output.="<tr>
			...
			<td class='fontCustom'>
			<a href='#' onclick='return startload()' class='open_modal_appsetting_lca' id={$row["request_no"]}><img src='../../asset/dist/img/icons/icon-addinfo.png' data-toggle='tooltip' title='approval'></a>
			</td>
	     </tr>";
	}
...
<script type="text/javascript">
$(document).ready(function() {
       $(".open_modal_appsetting_lca").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_appsetting_lca.php?emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
