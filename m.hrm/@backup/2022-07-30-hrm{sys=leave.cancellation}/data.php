                            ...
                            <table>
                                   ...
                                   <!-- <td>
                                          <form action="../rfid=repository/cli_Template_Download/st/StFunctionDownload.php" method="GET">
                                                 ...
                                                 <input type="hidden" name="src_leave_request" value="<php echo $src_leave_request; ?>">
                                                 <input type="hidden" name="src_leave_request_cancel" value="<php echo $src_leave_request_cancel; ?>">
                     ...
                     <table id="datatable" width="98%" border="1" align="left"
                            ...
                            <thead>
                                                        <tr>
                                                               ...
                                                               <th class="fontCustom" style="z-index: 1;">Request <br>Number</th>
                                                               <th class="fontCustom" style="z-index: 1;">Request <br>For</th>
                                                               <th class="fontCustom" style="z-index: 1;">Leave <br>Request No.</th>
                                                               <th class="fontCustom" style="z-index: 1;">Type of <br>Leave</th>
                                                               <th class="fontCustom" style="z-index: 1;">Request <br>Date</th>
                                                               <th class="fontCustom" style="z-index: 1;">Proposed <br>Day</th>
                                                               <th class="fontCustom" style="z-index: 1;">Remark</th>
                                                               <th class="fontCustom" style="z-index: 1;">Request <br>Status</th>
                                                               <th class="fontCustom" style="z-index: 1;">Approval <br>Status</th>
                                                        </tr>
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="form-row">
                                                 ...
                                                 <div class="col-sm-4"></div>
                                                         <div class="col-sm-8 name"> <a href='#' id="show_preview_leave_request" class='btn btn-default'>
                                                                             Show
                                                                      </a>
                                          ...
                                          $(document).ready(function(){
                                                        $("#show_preview_leave_request").click(function(){
                                                               ...
                                                               $("#box").load("pages_relation/_pages_preview_request.php?rfid=" + modal_emp + "&xfid=" + inp_leavereq + "&sfid=" + inp_startdate + "&efid=" + inp_enddate, function(responseTxt, statusTxt, jqXHR){
                                   ...
                                   <div class="form-row" style="display:none">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_reason_code" name="sel_reason_code"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_reason_name_en" name="sel_reason_name_en"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-8">
                                                 <div class="input-group">
                                                        ...
                                                        <input class="input--style-6" autocomplete="off" autofocus="on"
                                                               id="sel_reason_name_id" name="sel_reason_name_id"
                                                               type="Text" value="" onfocus="hlentry(this)" size="30"
                                                               maxlength="50"
                                                               style="text-transform:uppercase;width: 60%;"
                                                               validate="NotNull:Invalid Form Entry"
		  ...
		  <table width="100%">
                     ...
                     <div class="form-group">
                            <div class="col-sm-12">	
                                          ...
                                          <input type="hidden" class="form-control input-report" id="sel_reason_codeS" name="sel_reason_code" placeholder="">
                            </div>
                     </div>
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#sel_approval_request_no").val(response.request_no);
                            ...
                            $("#box_approval_request_detail").load("pages_relation/_pages_approval.php?rfid=" + response.request_no, 
                            ...
                            $.ajax({
                                   ...
                                   success:function(response) {
                                                 ...
                                                 if(fill_is_approved_spvdown == '0'){ //jika sudah approve request
                                                        ...
                                                        document.getElementById("submit_revision_spvdown").style.display = "none";
                                                        document.getElementById("submit_approval_spvdown").style.display = "none";
                                                 } else if(fill_is_urgent_request == 'Y' && fill_is_file_name == '0'){ //jika tipe request urgent dan attachment belum ada maka hide tombol
                                                        document.getElementById("submit_reject_spvdown").style.display = "none";
                                                        document.getElementById("submit_revision_spvdown").style.display = "none";
                                                        document.getElementById("submit_approval_spvdown").style.display = "none";
                                                 } else {
