...
<div class="col-md-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        ...
                                        <td>
                                        <a href='#' onclick='return stopload()'>
                                                        <div class="toolbar sprite-toolbar-excel" id="EXCEL"
                                                               title="Excel"
                                                               onclick="popPrint('?prid=hrm.employee.listemp&amp;format=Excel');">
                                                        </div>
                                                        </a>
                                        </td>
                                        <td>
                                        <a href='#' onclick="window.location.href='../hrm{sys=leave.cancellation}'">
                                    ...
                                    <div class="card-body table-responsive p-0"
                                        style="width: 100vw;height: 78vh; width: 98.8%; margin: 5px;">
