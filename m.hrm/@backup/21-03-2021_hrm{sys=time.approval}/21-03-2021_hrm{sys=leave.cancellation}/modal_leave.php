							...
							<tbody>
								...
								<?php 
									...
									and a.cancelsts = 'N'
                                                                and a.leave_date <> 
                                                               (CASE
									    WHEN (SELECT xx.leave_date FROM hrdleavecancelrequest xx WHERE xx.request_no=b.request_no) = '' THEN '0000-00-00 00:00:00'
									    WHEN (SELECT xx.leave_date FROM hrdleavecancelrequest xx WHERE xx.request_no=b.request_no) IS NULL THEN '0000-00-00 00:00:00'
									    ELSE (SELECT xx.leave_date FROM hrdleavecancelrequest xx WHERE xx.request_no=b.request_no)
									END)");
									$no = 1;
								...
								<tr class="list-con odd">
									<td><?php echo $no++; ?></td>
									<td><input type="checkbox" class="tanggal" name="pilih[]" value="<?php echo $d['leave_date']; ?>"></td>	
                            ...
                            <td colspan="2" align="right" width="100%">
                                   <div class="modal-footer">
                                          <div class="form-group">
                                                 ...
                                                 <button type="submit" name="submit_add_window" class="btn btn-warning">Submit</button>
                                          </div>
                                   </div>
                            </td>
                     </tr>
