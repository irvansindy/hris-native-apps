       ...
       <div class="modal-content">
              ...
              <div class="modal-body">
                     ...
                     <table cellpadding="1" cellspacing="1" style="width:100%">
                            ...
                            <?php
                            $has_status=mysqli_query($connect, "SELECT request_status FROM hrmrequestapproval WHERE request_no = '$id' and request_status IN ('0','1','4') ORDER BY `request_status` DESC limit 1
                                                                      ");
