       ...
       <div class="card">
              <div class="card-header d-flex align-items-center">
                     ...
                     <section class="form-box">
                            ...
                            <form action="summarized.php?emp_id=<?php echo $username; ?>" name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                                   onsubmit='return HrmsValidationForm()' class="form-user">

                                   <?php
                                   $is_hidden_v09 = ''; // SET AS '' if you want running code
                                   ?>
                                   <input type="hidden<?php echo $is_hidden_v09; ?>" name="rfid" value="<?php echo $rfid; ?>">
                                                        ...
                                                        <label>Kelurahan <span>*</span> : </label>
                                                               <div class="input-group">
                                                                      <select name="inp_domisili_subdistrict" id="domisili_subdistrict" class="form-control select2bs4">
                                                                             ...
                                                                             <?php
                                                                             $get_subdistrict = mysqli_query($connect, "SELECT subdistrict_id,subdistrict_name FROM tgemsubdistrict $where_district_id");
                  ...
                  <div id="unique-visit">
                     <div id="apexchartsrmi92407" class="apexcharts-canvas apexchartsrmi92407 apexcharts-theme-light">
                            <div class="apexcharts-tooltip apexcharts-theme-dark"><div class="apexcharts-tooltip-series-group"><span class="apexcharts-tooltip-marker" style="background-color: rgb(38, 198, 218);"></span><div class="apexcharts-tooltip-text" style="font-family: Poppins, sans-serif; font-size: 12px;"><div class="apexcharts-tooltip-y-group"><span class="apexcharts-tooltip-text-label"></span><span class="apexcharts-tooltip-text-value"></span></div><div class="apexcharts-tooltip-z-group"><span class="apexcharts-tooltip-text-z-label"></span><span class="apexcharts-tooltip-text-z-value"></span></div></div></div></div><div class="apexcharts-yaxistooltip apexcharts-yaxistooltip-0 apexcharts-yaxistooltip-left apexcharts-theme-dark"><div class="apexcharts-yaxistooltip-text"></div></div></div></div>
                                   ...
                                   <?php
                                          if($img != ''){
                                                 echo '<div class="imgbox1" id="imgbox1"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">Kartu tanda penduduk</code></p>
                                                        <img src="'.$img.'" alt="mac_mouse" width="80">
                                   ...
                                   <?php
                                          if($img2 != ''){
                                                 echo '<div class="datax imgbox2" id="imgbox2"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">Kartu keluarga</code></p>
                                                                      <img src="'.$img2.'" alt="mac_mouse" width="80">
                                                                      <p>
                                                                             '.$openFile2.'
...
//   }
  ...
  else
  {
   ...
   $.ajax({
       url:"uploader_dokumen.php?&code=1&token=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
       method:"POST",
       data: form_data,
       contentType: false,
       cache: false,
...
//   }
  ...
  else
  {
   ...
   $.ajax({
       url:"uploader_dokumen.php?&code=2&token=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
       method:"POST",
       data: form_data,
       contentType: false,
       cache: false,
...
//   }
  ...
  else
  {
   ...
   $.ajax({
       url:"uploader_dokumen.php?&code=3&token=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
       method:"POST",
       data: form_data,
       contentType: false,
       cache: false,
...
//   }
  ...
  else
  {
   ...
   $.ajax({
       url:"uploader_dokumen.php?&code=4&token=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
       method:"POST",
       data: form_data,
       contentType: false,
       cache: false,
...
//   }
  ...
  else
  {
   ...
   $.ajax({
       url:"uploader_dokumen.php?&code=5&token=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
       method:"POST",
       data: form_data,
       contentType: false,
       cache: false,
...
$(document).ready(function() {
       $(".open_modal_search").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_search.php?id=1&username=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
...
$(document).ready(function() {
       $(".open_modal_search2").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_search.php?id=2&username=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
...
$(document).ready(function() {
       $(".open_modal_search3").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_search.php?id=3&username=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
...
$(document).ready(function() {
       $(".open_modal_search4").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_search.php?id=4&username=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
...
$(document).ready(function() {
       $(".open_modal_search5").click(function(e) {
              var m = $(this).attr("id");
              $.ajax({
                     url: "modal_search.php?id=5&username=<?php echo $username; ?>&emp_id=<?php echo $username; ?>",
                     type: "POST",
                     data: {
                            id: m,
                     },
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=1&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan2").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=2&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan3").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=3&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan4").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=4&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan5").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=5&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
