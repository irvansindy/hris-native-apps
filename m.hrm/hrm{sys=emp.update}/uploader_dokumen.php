...
if($_GET['code'] == '5' && $_FILES["file5"]["name"] != '')
{
 ...
 $location = '../../asset/list_document/' . $name; 
    ...
    if(move_uploaded_file($_FILES["file5"]["tmp_name"], $location)){ 
        ...
        {
            if($ext == 'pdf'){
                echo '<div class="datax" style="margin-right: 10px;padding: 10px;" id="imgbox5a"><p style="word-wrap: break-word;"><code class="w3-codespan" style="wrap">BUKU NIKAH</code></p>
                        <img src="uploaded_files/pngs.png" style="max-height: 300px;" alt="gthris">
                        <p>
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan1a").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=1a&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan2a").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=2a&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan3a").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=3a&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan4a").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=4a&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
...
<script type="text/javascript">
	$(document).ready(function(){
		$(".tombol-simpan5a").click(function(){
			...
			$.ajax({
				type: 'POST',
				url: "aksi.php?proc=5a&emp_id=<?php echo $username; ?>",
				data: data,
				success: function() {
					modals.style.display = "block";
                                   document.getElementById("msg").innerHTML = "Dokumen berhasil dihapus";
