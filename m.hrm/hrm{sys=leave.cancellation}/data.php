                                   ...
                                   <div class="form-row">
                                          ...
                                          $(document).ready(function(){
                                                        $("#show_preview_leave_request").click(function(){
                                                               ...
                                                               $("#box").load("pages_relation/_pages_preview_request.php<?php echo $getPackage; ?>rfid=" + modal_emp + "&xfid=" + inp_leavereq + "&sfid=" + inp_startdate + "&efid=" + inp_enddate, function(responseTxt, statusTxt, jqXHR){
                                          ...
                                          $(document).ready(function(){
                                                        $("#show_preview_leave_request_detail").click(function(){
                                                               ...
                                                               $("#box").load("modal_leave.php<?php echo $getPackage; ?>rfid=" + m + "&xfid=" + m2, function(responseTxt, statusTxt, jqXHR){
                                                               if(statusTxt == "success"){
                                                                      // alert("New content loaded successfully!");
...
<!-- /edit modal -->
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="FormDisplayDelete">
	  <div class="modal-dialog" style="width: 25%;">
	    <div class="modal-content">
		<form class="form-horizontal" action="php_action/FuncDataDelete.php<?php echo $getPackage; ?>" method="POST" id="updatedelMemberForm">	      
