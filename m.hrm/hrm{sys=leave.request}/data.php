              ...
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataCreate.php<?php echo $getPackage; ?>" method="POST"
                            ...
                            <!-- ==================================================================================================== -->
                                   ...
                                   <input id="inp_deductedleave" name="inp_deductedleave" type="hidden"><!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
...
<div class="modal  fade fade-custom" tabindex="-1" role="dialog" id="RevisedForm">
       <div class="modal-dialog modal-belakang modal-bg" role="document">
              <div class="modal-content">
                     ...
                     <form class="form-horizontal" action="php_action/FuncDataRevised.php<?php echo $getPackage; ?>" method="POST"
...
<mark style="margin-left: 6px;"><code id="revised_remark">Revised Remark : </code></mark>
                                   ...
                                   <div class="form-row">
                                          ...
                                          <div class="col-sm-3">
                                                 <div class="input-group">
                                                        ...
                                                        <input id="inp_revised_hdtype_endtime_formmodified" name="inp_revised_hdtype_endtime_formmodified" type="hiddena" value="noselect"><!--FROM SESSION -->
                            ...
                            <!-- ==================================================================================================== -->
                                   ...
                                   <input id="inp_revised_deductedleave" name="inp_revised_deductedleave" type="hidden"><!--FROM CONFIGURATION -->
                            <!-- ==================================================================================================== -->
                            <!-- ==================================================================================================== -->
