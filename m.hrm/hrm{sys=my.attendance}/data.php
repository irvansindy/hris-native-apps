...
<?php
                            ...
                            $(document).ready(function() {
                                   ...
                                   if (action == 'inactive') {
                                          action = 'active';
                                          // window.document.getElementById("msg").innerHTML = "<div id='mymodals' class='modals'><div class='modals-content'><p><table width='100%'><tr><td align='center'><img src='../../asset/dist/img/sf-mola-mola.png' style='max-width: 90%;margin-top: 20px;'></td></tr><tr><td style='width: 85%; font-weight:bold;color: #777b7b;' align='center'><p id='msg'></p><br><button type='submit' name='submit_add' id='submit_add' style='padding: 1px;' type='button' class='btn btn-warning button_bot closeds'>Keluar</button></td></tr></table> </p></div></div>";
                                        ...
                                        <table id="tableOTSetting" width="100%"
                                                ...
                                                <td rowspan="3" class="header-data" nowrap="nowrap" align="center">Employee Name</td>
                                                 ...
                                                 <tr id="loader-datatable" name="loader-datatable" class="loader-datatable" style="border: 1px solid white;border-bottom: 1px solid #ececec;">
                                                               <td style="border: 1px solid #ececec;background: #fbfbfb;text-align: left;" colspan="14"><p id="msg" name="msg" class="loader-datatable"></p></td>
                                                 </tr>
                                                </thead>
                                        </table>
                                </div>
