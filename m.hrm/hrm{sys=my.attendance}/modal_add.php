                            ...
                            <table style="width: 95%;">
                                   <tbody>
                                          <tr>
                                                 ...
                                                 <td colspan="3" class="" id="tdb_1">
                                                        ...
                                                        <input class="form-control" style="margin-bottom: 2px;"
                                                               ...
                                                               value="<?php echo $username; ?>" onfocus="hlentry(this)"
                                          ...
                                          <tr id="tr_inp_nickname" class="clTR1">
                                                 <td><label id="lbl_inp_nickname" for="inp_nickname" title="">Employee
                                                 ...
                                                 <td colspan="3" class="" id="tdb_1"><input class="form-control"
                                                               ...
                                                               value="<?php echo $nama; ?>" onfocus="hlentry(this)"
                                          ...
                                          <tr id="tr_inp_user_status" class="clTR1">
                                                 <td><label id="lbl_inp_user_status" for="inp_user_status" title="">Type
                                                               of Leave <span class="required">*</span></label></td>
                                                 <td colspan="3" class="" id="tdb_1"><select class="form-control"
                                                               style="margin-bottom: 2px; width: 50%;" id="modal_leave"
                                                               name="modal_leave" onchange="isi_otomatis_leave()"
                                          ...
                                          <tr id="tr_inp_nickname" class="clTR1">
                                                 <td><label id="lbl_inp_nickname" for="inp_nickname" title="">Leave
                                          ...
                                          <tr id="tr_inp_nickname" class="clTR1">
                                                 ...
                                                 <td id="tdb_1"><input class="form-control"
                                                               style="margin-bottom: 2px; width: 100%;"
                                                               id="modal_leave_end" name="modal_leave_end" type="date"
                                                               value="" onfocus="hlentry(this)" size="20" maxlength="50"
                                                                validate="NotNull:Invalid Form Entry"
                                                               onchange="formodified(this);" title=""></td>
                                          ...
                                          <tr id="tr_inp_nickname" class="clTR1">
                                                 <td><label id="lbl_inp_nickname" for="inp_nickname" title="">Remark
                                                               <span class="required">*</span></label>
                                                 </td>
                                                 <td colspan="3" class="" id="tdb_1"><textarea class="form-control"
                                                               style="margin-bottom: 2px; width: 100%;" id="inp_remark"
                                                               name="inp_remark" type="Text" value=""
                                          ...
                                          <tr id="tr_inp_refdoc" class="selected">
                                                 ...
                                                 <td colspan="3" class="" id="tdb_1"><span
                                                               ...
                                                               id="inp_refdoc" name="inp_refdoc" type="File" value=""
                                          ...
                                          <tr id="tr_inp_file_ext" class="clTR1">
                                                 <td><label id="lbl_inp_file_ext" for="inp_file_ext" title="">File
                                                               Extension</label>
                                                 </td>
