       ...
       <div class="modal-content">
              ...
              <div class="modal-body">
                     ...
                     <table cellpadding="1" cellspacing="1" style="width:100%">
                            ...
                            <?php
                            $has_status=mysqli_query($connect, "SELECT request_status FROM hrmrequestapproval WHERE request_no = '$id' ORDER BY `request_status` DESC limit 1
                                                                      ");
                            $var_status = mysqli_num_rows($has_status);
                            $var_has_status = mysqli_fetch_array($has_status);

                     
                            if($var_has_status['request_status'] == 1) {
                           
                                   echo '<form method="post" id="myform" onsubmit="return myFunctionCancel()">
                                                 <input type="hidden" name="request_no" value="<?php echo $id; ?>">
                                                 <button type="submit" style="border: 0; background: transparent" name="submit_cancel" value="submit"><img src="../../asset/img/icons/acticon-no.png" alt="Submit"></button>
                                          </form>';
                            } else {
                                   echo '';
                            }
