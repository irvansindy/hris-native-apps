       ...
       <div class="modal-content">
              ...
              <form name='form1' method="post" id="multiple_upload_form" enctype="multipart/form-data"
                     ...
                     <fieldset id="fset_1">
                            ...
                            <div class="form-row"  style="display:none" id="inp_leavebalanceR">
                            ...
                            <table style="width: 95%;">
                                   ...
                                   <input type="hidden" id="inp_leavecompany" name="inp_leavecompany" value="">
              ...
              function isi_otomatis_leave() {
                     ...
                     var inp_hdtype_starttime_full_day = document.getElementById("inp_hdtype_starttime_full_day").value;
                     ...
                     $.ajax({
                            ...
                            var json = data,
                                   obj = JSON.parse(json);
                                          ...
                                          $('#inp_leavecompany').val(obj.lvc);
                                          $('#inp_leaveisurgent').val(obj.lur);
                                   //IF CONDITION SUCCESSFULLY LOAD LEAVE BALANCE
                                   if(obj.lvc == "N"){
                                          $("#inp_leavebalanceR").show();
                                   } else {
                                          $("#inp_leavebalanceR").hide();
                                   }
                                   if (obj.lur == '1') {
              ...
              function HrmsValidationForm() {
                     ...
                     var inp_leavedaytype = document.getElementById("inp_leavedaytype").value;
                     var inp_leavecompany = document.getElementById("inp_leavecompany").value;
                     ...
                     if (from > to) {
                            ...
                            return false;
                     } else if (inp_leavecompany == 'N') {
                            if (inp_leavedaytype == "PD" && from < to) {
                                   alert("Partial Day Permit just allowing max 5 Hours");
                                   return false; 
                            } else if (inp_leavedaytype == "PD" && inp_starttime > inp_endtime) {
                                   alert("Wrong time format : Enter time in proper range the `start time more than end time`");
                                   return false;
                            } else if (inp_leavedaytype == "PD" && inp_starttime == '00:00') {
                                   alert("Please fill start time");
                                   return false;
                            } else if (inp_leavedaytype == "PD" && inp_endtime == '00:00') {
