...
$(document).ready(function(){
  $("#box_update").load("pages_relation/_pages_photo.php?emp_id=<?php echo $username; ?>&rfid=<?php echo $new_key; ?>&username=<?php echo $username; ?>", 
                            ...
                            <div class="d-flex me-3 ms-2">
                                   <div class="chart-text me-2">
                                          ...
                                          <h4 class="mt-0 text-info"><a href='#' class='open_modal_search' class="btn btn-demo" data-toggle="modal" data-target="#myModal2">
                                                 <i
                                                                      style="color:grey" class="fa fa-file-text-o"
                            ...
                            <div class="mesgs">
                                   ...
                                   <footer class='footer_chat'>
                                          ...
                                          <div class="input_msg_write">
                                                        ...
                                                        <textarea placeholder="Message" id="write_msg" class="write_msg"></textarea>
...
$(document).ready(function() {
       ...
       $.ajax(
       {
       url: "get_row_data.php?emp_id=<?php echo $username; ?>", // path to your PHP file
       type: 'POST',
       dataType: 'json',
       ...
       success: function(response)
              ...
              $.ajax(
                     {
                     url: "new_data_load.php?emp_id=<?php echo $username; ?>", // path to your PHP file
                     type: 'POST',
                     dataType:"html",
                     data: { 
                            'id_chat': '<?php echo $new_key; ?>' // <-- the $ sign in the parameter name seems unusual, I would avoid it
...
$("#msg_send_btn").click(function(){
  var msges = document.getElementById("write_msg").value;
    ...
    $.ajax(
    {
    url: "new_data.php?emp_id=<?php echo $username; ?>", // path to your PHP file
    type: 'POST',
    dataType:"html",
    data: {
...
document.getElementById("file").onchange = function() {
        ...
        if(files.length > 0 ){
           ...
           $.ajax({
              url: 'new_data.php?emp_id=<?php echo $username; ?>&identity=' + identity,
              type: 'post',
              data: fd,
              contentType: false,
              processData: false,
                            ...
                            if(row_msg != response.messages){
                                   ...
                                   $.ajax(
                                          ...
                                          success: function(data)
                                          {
                                                ...
                                                $("#load-into-div-first").load("new_data_load.php?emp_id=<?php echo $username; ?>&id_chat=<?php echo $new_key; ?>", function(responseTxt, statusTxt, xhr){
