              ...
              <table width="100%">
                     ...
                     <tr>
                            <td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
                                   <p id="msg_href"></p><br>
                                   <button type='submit' style="padding: 1px;" type='button' class="btn btn-warning button_bot closeds_withhref">
                                          Close
                                   </button>
                            </td>
                     </tr>
...
<div id="mymodals" class="modals" style="display: none;z-index: 9999;">
       <div class="modals-content" style="background: whitesmoke;border-radius: 4px;">
              <p>
              <table width="100%">
                     <tr>
                            <td align="center"><img src="../../asset/dist/img/sf-mola-mola.png" style="max-width: 90%;margin-top: 20px;"></td>
                     ...
                     <tr>
                            <td style="width: 85%; font-weight:bold;color: #777b7b;" align="center">
                                   <p id="msg"></p><br>
                                   <button type='submit' style="padding: 1px;" type='button' class="btn btn-warning button_bot closeds">
                                          Close
                                   </button>
                            </td>
                     </tr>
