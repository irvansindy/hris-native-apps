        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar ps-container ps-theme-default ps-active-y" data-ps-id="e68914b7-815e-2188-9980-e5b2f4acf489">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php
					$menu = mysqli_query($connect, "SELECT * FROM hrmmenu where menu_id IN ($forumla_used) and submenu_id ='0' ORDER BY menu_id ASC");
					while($dataMenu = mysqli_fetch_assoc($menu)){
                        ...
                        <span class="hide-menu">&nbsp;&nbsp;<?php echo $dataMenu['menu']; ?> </span></a>
                            ...
                            <li class="sidebar-item"><a href="<?php echo $dataSubmenu['hyperlink']; ?>" class="sidebar-link"><?php echo $dataMenu['svg_icon']; ?> &nbsp; <span class="hide-menu"> <?php echo $dataSubmenu['menu']; ?> </span></a></li>
                            <?php } ?>
