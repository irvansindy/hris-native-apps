...
if (!empty($_GET['src_leave_request']) && !empty($_GET['src_leave_request_cancel'])) {
       ...
       $where_srv 			= "WHERE ((b.emp_no='$username') or (a.created_by='$username')) AND (a.request_no LIKE '%$src_leave_request%') AND (a.request_no = '$src_leave_request_cancel')";

} elseif (!empty($_GET['src_leave_request']) && empty($_GET['src_leave_request_cancel'])) {
       $src_leave_request 	       = $_GET['src_leave_request'];
       $src_leave_request_cancel   = $_GET['src_leave_request_cancel'];
       $where_srv 			= "WHERE ((b.emp_no='$username') or (a.created_by='$username')) AND (a.request_no LIKE '%$src_leave_request%')";
